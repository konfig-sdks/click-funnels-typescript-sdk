 ...
 * 
 * @export
 * @interface ProductsPriceListForVariant404Response
 */
export interface ProductsPriceListForVariant404Response {
    /**
     ...
     * @type {string}
     * @memberof ProductsPriceListForVariant404Response
     */
    'error'?: string;
}
