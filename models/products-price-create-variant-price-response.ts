 ...
 * 
 * @export
 * @interface ProductsPriceCreateVariantPriceResponse
 */
export interface ProductsPriceCreateVariantPriceResponse {
    /**
     * 
     * @type {string}
     * @memberof ProductsPriceCreateVariantPriceResponse
     */
    'error'?: string;
}
