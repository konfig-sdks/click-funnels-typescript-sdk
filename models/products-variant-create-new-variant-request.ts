...
import { ProductsVariantParameters } from './products-variant-parameters';

/**
 * 
 * @export
 * @interface ProductsVariantCreateNewVariantRequest
 */
export interface ProductsVariantCreateNewVariantRequest {
    /**
     * 
     * @type {ProductsVariantParameters}
     * @memberof ProductsVariantCreateNewVariantRequest
     */
    'products_variant'?: ProductsVariantParameters;
}
