 ...
 * 
 * @export
 * @interface CoursesSectionUpdateSectionByIdResponse
 */
export interface CoursesSectionUpdateSectionByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof CoursesSectionUpdateSectionByIdResponse
     */
    'error'?: string;
}
