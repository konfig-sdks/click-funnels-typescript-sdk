 ...
 * 
 * @export
 * @interface FormsSubmissionsAnswerAddNewAnswerResponse
 */
export interface FormsSubmissionsAnswerAddNewAnswerResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsSubmissionsAnswerAddNewAnswerResponse
     */
    'error'?: string;
}
