 ...
 * 
 * @export
 * @interface FormsFieldsOptionUpdateFieldOption401Response
 */
export interface FormsFieldsOptionUpdateFieldOption401Response {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionUpdateFieldOption401Response
     */
    'error'?: string;
}
