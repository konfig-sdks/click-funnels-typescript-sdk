...
import { ProductsPriceParameters } from './products-price-parameters';

/**
 * 
 * @export
 * @interface ProductsPriceCreateVariantPriceRequest
 */
export interface ProductsPriceCreateVariantPriceRequest {
    /**
     * 
     * @type {ProductsPriceParameters}
     * @memberof ProductsPriceCreateVariantPriceRequest
     */
    'products_price'?: ProductsPriceParameters;
}
