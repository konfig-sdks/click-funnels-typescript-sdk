 ...
 * 
 * @export
 * @interface ShippingRateCreateRateForZone401Response
 */
export interface ShippingRateCreateRateForZone401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingRateCreateRateForZone401Response
     */
    'error'?: string;
}
