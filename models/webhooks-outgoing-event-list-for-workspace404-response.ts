 ...
 * 
 * @export
 * @interface WebhooksOutgoingEventListForWorkspace404Response
 */
export interface WebhooksOutgoingEventListForWorkspace404Response {
    /**
     * Not found - This usually happens when you try to access a record that does not exist in your account. It can also happen when the provided parent record is missing, e.g. you have put in a non-existent Workspaces parent ID.
     * @type {string}
     * @memberof WebhooksOutgoingEventListForWorkspace404Response
     */
    'error'?: string;
}
