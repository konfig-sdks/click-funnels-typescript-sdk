...
import { FormsSubmissionParameters } from './forms-submission-parameters';

/**
 * 
 * @export
 * @interface FormsSubmissionCreateNewSubmissionRequest
 */
export interface FormsSubmissionCreateNewSubmissionRequest {
    /**
     * 
     * @type {FormsSubmissionParameters}
     * @memberof FormsSubmissionCreateNewSubmissionRequest
     */
    'forms_submission'?: FormsSubmissionParameters;
}
