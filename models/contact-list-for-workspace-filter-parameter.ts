 ...
 * 
 * @export
 * @interface ContactListForWorkspaceFilterParameter
 */
export interface ContactListForWorkspaceFilterParameter {
    /**
     * 
     * @type {Array<string>}
     * @memberof ContactListForWorkspaceFilterParameter
     */
