 ...
 * Properties Values
 * @export
 * @interface TranslationMissingEnProductsPropertiesValuesTitle
 */
export interface TranslationMissingEnProductsPropertiesValuesTitle {
    /**
     * Property ID
     * @type {any}
     * @memberof TranslationMissingEnProductsPropertiesValuesTitle
     */
    'property_id'?: any;
    /**
     * Value
