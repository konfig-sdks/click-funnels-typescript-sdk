 ...
 * 
 * @export
 * @interface ShippingProfileGetWorkspaceProfileResponse
 */
export interface ShippingProfileGetWorkspaceProfileResponse {
    /**
     * 
     * @type {string}
     * @memberof ShippingProfileGetWorkspaceProfileResponse
     */
    'error'?: string;
}
