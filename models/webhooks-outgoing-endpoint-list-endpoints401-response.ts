 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointListEndpoints401Response
 */
export interface WebhooksOutgoingEndpointListEndpoints401Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEndpointListEndpoints401Response
     */
    'error'?: string;
}
