 ...
 * 
 * @export
 * @interface ShippingPackageListForWorkspace404Response
 */
export interface ShippingPackageListForWorkspace404Response {
    /**
     ...
     * @type {string}
     * @memberof ShippingPackageListForWorkspace404Response
     */
    'error'?: string;
}
