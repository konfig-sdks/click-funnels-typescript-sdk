 ...
 * 
 * @export
 * @interface FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner
 */
export interface FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner {
    /**
     * The orders invoice line item to fulfill
     * @type {string}
     * @memberof FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner
     */
    'invoices_line_item_id'?: string;
    /**
