 ...
 * 
 * @export
 * @interface ContactsTagUpdateSpecificTag401Response
 */
export interface ContactsTagUpdateSpecificTag401Response {
    /**
     * 
     * @type {string}
     * @memberof ContactsTagUpdateSpecificTag401Response
     */
    'error'?: string;
}
