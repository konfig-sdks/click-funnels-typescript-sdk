 ...
 * 
 * @export
 * @interface FormsSubmissionsAnswerRemoveByIdResponse
 */
export interface FormsSubmissionsAnswerRemoveByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsSubmissionsAnswerRemoveByIdResponse
     */
    'error'?: string;
}
