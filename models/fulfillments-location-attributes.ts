...
import { LocationsProperty } from './locations-property';

/**
 * Locations
 * @export
 * @interface FulfillmentsLocationAttributes
 */
export interface FulfillmentsLocationAttributes {
    /**
     * Location ID
     * @type {number}
     * @memberof FulfillmentsLocationAttributes
     */
    'id': number;
    /**
     * Public ID
    ...
    /**
     * 
     * @type {LocationsProperty}
     * @memberof FulfillmentsLocationAttributes
     */
    'address': LocationsProperty;
}
