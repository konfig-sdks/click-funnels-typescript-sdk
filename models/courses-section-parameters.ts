 ...
 * Modules
 * @export
 * @interface CoursesSectionParameters
 */
export interface CoursesSectionParameters {
    /**
     * Title
     * @type {string}
     * @memberof CoursesSectionParameters
     */
    'title': string;
    /**
     * Description
     ...
     * @memberof CoursesSectionParameters
     */
    'days_till_drip_access'?: any;
    /**
     * Blocker section
     * @type {any}
     * @memberof CoursesSectionParameters
     */
    'blocker_section_id'?: any;
    /**
     * Blocker lesson
     * @type {string}
     * @memberof CoursesSectionParameters
     */
    'blocker_lesson_id': string;
    /**
     * Current Path
     * @type {any}
     * @memberof CoursesSectionParameters
     */
    'is_hidden_from_non_members'?: any;
}
