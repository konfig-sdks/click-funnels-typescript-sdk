...
import { ProductsTagParameters } from './products-tag-parameters';

/**
 * 
 * @export
 * @interface ProductsTagUpdateTagByIdRequest
 */
export interface ProductsTagUpdateTagByIdRequest {
    /**
     * 
     * @type {ProductsTagParameters}
     * @memberof ProductsTagUpdateTagByIdRequest
     */
    'products_tag'?: ProductsTagParameters;
}
