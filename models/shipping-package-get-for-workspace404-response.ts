 ...
 * 
 * @export
 * @interface ShippingPackageGetForWorkspace404Response
 */
export interface ShippingPackageGetForWorkspace404Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingPackageGetForWorkspace404Response
     */
    'error'?: string;
}
