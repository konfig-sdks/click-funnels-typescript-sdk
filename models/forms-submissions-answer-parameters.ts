 ...
 * Answers
 * @export
 * @interface FormsSubmissionsAnswerParameters
 */
export interface FormsSubmissionsAnswerParameters {
    /**
     * Field
     * @type {number}
     * @memberof FormsSubmissionsAnswerParameters
     */
    'field_id': number;
    /**
     * Fields Option
