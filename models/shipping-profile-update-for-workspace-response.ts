 ...
 * 
 * @export
 * @interface ShippingProfileUpdateForWorkspaceResponse
 */
export interface ShippingProfileUpdateForWorkspaceResponse {
    /**
     * 
     * @type {string}
     * @memberof ShippingProfileUpdateForWorkspaceResponse
     */
    'error'?: string;
}
