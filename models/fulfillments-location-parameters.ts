...
import { FulfillmentsLocationParametersAddress } from './fulfillments-location-parameters-address';

/**
 * Locations
 * @export
 * @interface FulfillmentsLocationParameters
 */
export interface FulfillmentsLocationParameters {
    /**
     * Location name
     * @type {string}
     * @memberof FulfillmentsLocationParameters
     */
    'name': string;
    /**
     * Address name
    ...
    'phone_number'?: any;
    /**
     * Indicates external application request. Only to be used for requests made with Oauth 2.0 access tokens. When acting on behalf of others, you might have special requirements or exemptions, like not needing to provide an address for the fulfillment location.
     * @type {boolean}
     * @memberof FulfillmentsLocationParameters
     */
    'external_app'?: boolean;
    /**
     * 
     * @type {FulfillmentsLocationParametersAddress}
     * @memberof FulfillmentsLocationParameters
     */
    'address'?: FulfillmentsLocationParametersAddress;
}
