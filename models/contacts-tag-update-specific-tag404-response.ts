 ...
 * 
 * @export
 * @interface ContactsTagUpdateSpecificTag404Response
 */
export interface ContactsTagUpdateSpecificTag404Response {
    /**
     * 
     * @type {string}
     * @memberof ContactsTagUpdateSpecificTag404Response
     */
    'error'?: string;
}
