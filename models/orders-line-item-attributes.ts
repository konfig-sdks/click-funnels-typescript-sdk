...
import { ProductPriceProperty } from './product-price-property';
import { ProductProperty } from './product-property';
import { ProductVariantProperty } from './product-variant-property';

/**
 * Line items
 * @export
 * @interface OrdersLineItemAttributes
 */
export interface OrdersLineItemAttributes {
    /**
     * Line item ID
     * @type {number}
     * @memberof OrdersLineItemAttributes
     */
    'id': number;
    /**
     * Line item public ID
     ...
     * @memberof OrdersLineItemAttributes
     */
    'original_product': ProductProperty;
    /**
     * 
     * @type {ProductPriceProperty}
     * @memberof OrdersLineItemAttributes
     */
    'products_price': ProductPriceProperty;
    /**
     * 
     * @type {ProductVariantProperty}
     * @memberof OrdersLineItemAttributes
     */
    'products_variant'?: ProductVariantProperty;
}
