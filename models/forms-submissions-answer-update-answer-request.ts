 ...
 * 
 * @export
 * @interface FormsSubmissionsAnswerUpdateAnswerRequest
 */
export interface FormsSubmissionsAnswerUpdateAnswerRequest {
    /**
     * 
     * @type {FormsSubmissionsAnswerParameters}
     * @memberof FormsSubmissionsAnswerUpdateAnswerRequest
     */
