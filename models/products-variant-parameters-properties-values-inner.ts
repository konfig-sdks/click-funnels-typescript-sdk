 ...
 * 
 * @export
 * @interface ProductsVariantParametersPropertiesValuesInner
 */
export interface ProductsVariantParametersPropertiesValuesInner {
    /**
     * The ID of the property
     * @type {number}
     * @memberof ProductsVariantParametersPropertiesValuesInner
     */
    'property_id'?: number;
    /**
     * The value
