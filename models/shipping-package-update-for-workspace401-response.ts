 ...
 * 
 * @export
 * @interface ShippingPackageUpdateForWorkspace401Response
 */
export interface ShippingPackageUpdateForWorkspace401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingPackageUpdateForWorkspace401Response
     */
    'error'?: string;
}
