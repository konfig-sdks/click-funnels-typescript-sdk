...
import { ContactsAppliedTagParameters } from './contacts-applied-tag-parameters';

/**
 * 
 * @export
 * @interface ContactsAppliedTagCreateAppliedTagRequest
 */
export interface ContactsAppliedTagCreateAppliedTagRequest {
    /**
     * 
     * @type {ContactsAppliedTagParameters}
     * @memberof ContactsAppliedTagCreateAppliedTagRequest
     */
    'contacts_applied_tag'?: ContactsAppliedTagParameters;
}
