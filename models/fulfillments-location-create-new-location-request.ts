...
import { FulfillmentsLocationParameters } from './fulfillments-location-parameters';

/**
 * 
 * @export
 * @interface FulfillmentsLocationCreateNewLocationRequest
 */
export interface FulfillmentsLocationCreateNewLocationRequest {
    /**
     * 
     * @type {FulfillmentsLocationParameters}
     * @memberof FulfillmentsLocationCreateNewLocationRequest
     */
    'fulfillments_location'?: FulfillmentsLocationParameters;
}
