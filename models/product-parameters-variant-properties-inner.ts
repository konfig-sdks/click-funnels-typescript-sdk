 ...
 * 
 * @export
 * @interface ProductParametersVariantPropertiesInner
 */
export interface ProductParametersVariantPropertiesInner {
    /**
     * The ID of the property, if updating the property
     * @type {number}
     * @memberof ProductParametersVariantPropertiesInner
     */
    'id'?: number;
    /**
