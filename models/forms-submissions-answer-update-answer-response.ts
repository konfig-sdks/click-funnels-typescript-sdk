 ...
 * 
 * @export
 * @interface FormsSubmissionsAnswerUpdateAnswerResponse
 */
export interface FormsSubmissionsAnswerUpdateAnswerResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsSubmissionsAnswerUpdateAnswerResponse
     */
    'error'?: string;
}
