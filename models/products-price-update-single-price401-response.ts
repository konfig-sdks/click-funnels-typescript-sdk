 ...
 * 
 * @export
 * @interface ProductsPriceUpdateSinglePrice401Response
 */
export interface ProductsPriceUpdateSinglePrice401Response {
    /**
     * 
     * @type {string}
     * @memberof ProductsPriceUpdateSinglePrice401Response
     */
    'error'?: string;
}
