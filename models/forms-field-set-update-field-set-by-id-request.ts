...
import { FormsFieldSetParameters } from './forms-field-set-parameters';

/**
 * 
 * @export
 * @interface FormsFieldSetUpdateFieldSetByIdRequest
 */
export interface FormsFieldSetUpdateFieldSetByIdRequest {
    /**
     * 
     * @type {FormsFieldSetParameters}
     * @memberof FormsFieldSetUpdateFieldSetByIdRequest
     */
    'forms_field_set'?: FormsFieldSetParameters;
}
