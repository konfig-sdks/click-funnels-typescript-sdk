...
import { IncludedOrdersLineItems } from './included-orders-line-items';
...
export interface FulfillmentAttributes {
     ...
     * Fulfillment
     * @type {number}
     * @memberof FulfillmentAttributes
     */
    'id': number;
    /**
     * Public Fulfillment ID
     * @type {any}
     * @memberof FulfillmentAttributes
     */
    'public_id'?: any;
     ...
     * @memberof FulfillmentAttributes
     */
    'status': FulfillmentAttributesStatusEnum;
    /**
     * Tracking URL
     * @type {any}
     * @memberof FulfillmentAttributes
     ...
     * @type {Array<IncludedOrdersLineItems>}
     * @memberof FulfillmentAttributes
     */
    'included_invoices_line_items'?: Array<IncludedOrdersLineItems>;
}

type FulfillmentAttributesStatusEnum = 'cancelled' | 'fulfilled' | 'restocked'
