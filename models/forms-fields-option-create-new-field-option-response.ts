 ...
 * 
 * @export
 * @interface FormsFieldsOptionCreateNewFieldOptionResponse
 */
export interface FormsFieldsOptionCreateNewFieldOptionResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionCreateNewFieldOptionResponse
     */
    'error'?: string;
}
