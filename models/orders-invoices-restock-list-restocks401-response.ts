 ...
 * 
 * @export
 * @interface OrdersInvoicesRestockListRestocks401Response
 */
export interface OrdersInvoicesRestockListRestocks401Response {
    /**
     * 
     * @type {string}
     * @memberof OrdersInvoicesRestockListRestocks401Response
     */
    'error'?: string;
}
