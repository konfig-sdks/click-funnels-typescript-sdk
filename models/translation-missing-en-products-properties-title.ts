 ...
 * Properties
 * @export
 * @interface TranslationMissingEnProductsPropertiesTitle
 */
export interface TranslationMissingEnProductsPropertiesTitle {
    /**
     * ID
     * @type {number}
     * @memberof TranslationMissingEnProductsPropertiesTitle
     */
    'id': number;
    /**
     * Name
