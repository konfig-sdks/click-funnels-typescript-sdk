...
import { WebhooksOutgoingEndpointParameters } from './webhooks-outgoing-endpoint-parameters';

/**
 * 
 * @export
 * @interface WebhooksOutgoingEndpointUpdateEndpointRequest
 */
export interface WebhooksOutgoingEndpointUpdateEndpointRequest {
    /**
     * 
     * @type {WebhooksOutgoingEndpointParameters}
     * @memberof WebhooksOutgoingEndpointUpdateEndpointRequest
     */
    'webhooks_outgoing_endpoint'?: WebhooksOutgoingEndpointParameters;
}
