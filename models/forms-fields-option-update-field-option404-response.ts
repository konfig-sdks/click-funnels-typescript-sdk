 ...
 * 
 * @export
 * @interface FormsFieldsOptionUpdateFieldOption404Response
 */
export interface FormsFieldsOptionUpdateFieldOption404Response {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionUpdateFieldOption404Response
     */
    'error'?: string;
}
