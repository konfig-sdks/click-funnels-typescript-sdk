 ...
 * Packages
 * @export
 * @interface ShippingPackageAttributes
 */
export interface ShippingPackageAttributes {
    /**
     * Package ID
     * @type {number}
     * @memberof ShippingPackageAttributes
     */
    'id': number;
    /**
     * Package public ID
     ...
     * @memberof ShippingPackageAttributes
     */
    'package_type': ShippingPackageAttributesPackageTypeEnum;
    /**
     * Height
     * @type {number}
     * @memberof ShippingPackageAttributes
     ...
     * @memberof ShippingPackageAttributes
     */
    'distance_unit': ShippingPackageAttributesDistanceUnitEnum;
    /**
     * Empty Weight
     * @type {any}
     * @memberof ShippingPackageAttributes
     ...
     * @memberof ShippingPackageAttributes
     */
    'weight_unit'?: ShippingPackageAttributesWeightUnitEnum;
    /**
     * Default Package
     * @type {any}
     * @memberof ShippingPackageAttributes
     ...
     * @memberof ShippingPackageAttributes
     */
    'carrier'?: ShippingPackageAttributesCarrierEnum;
    /**
     * Added
     * @type {any}
     * @memberof ShippingPackageAttributes
...
type ShippingPackageAttributesPackageTypeEnum = 'box' | 'envelope' | 'soft_package'
type ShippingPackageAttributesDistanceUnitEnum = 'in' | 'cm' | 'ft' | 'm' | 'mm'
type ShippingPackageAttributesWeightUnitEnum = 'lb' | 'kg' | 'g' | 'oz'
type ShippingPackageAttributesCarrierEnum = 'fedex' | 'ups' | 'usps'
