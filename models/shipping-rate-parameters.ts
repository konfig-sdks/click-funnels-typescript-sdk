 ...
 * Rates
 * @export
 * @interface ShippingRateParameters
 */
export interface ShippingRateParameters {
    /**
     * Provider Name
     * @type {any}
     * @memberof ShippingRateParameters
     */
    'provider_name'?: any;
    /**
     * Price
     ...
     * @memberof ShippingRateParameters
     */
    'rates_name_id': number;
    /**
     * Live Rates Provider
     * @type {string}
     * @memberof ShippingRateParameters
     */
    'live_rates_provider'?: ShippingRateParametersLiveRatesProviderEnum;
}

type ShippingRateParametersLiveRatesProviderEnum = 'Shippo'
