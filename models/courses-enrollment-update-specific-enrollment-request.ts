...
import { CoursesEnrollmentParameters } from './courses-enrollment-parameters';

/**
 * 
 * @export
 * @interface CoursesEnrollmentUpdateSpecificEnrollmentRequest
 */
export interface CoursesEnrollmentUpdateSpecificEnrollmentRequest {
    /**
     * 
     * @type {CoursesEnrollmentParameters}
     * @memberof CoursesEnrollmentUpdateSpecificEnrollmentRequest
     */
    'courses_enrollment'?: CoursesEnrollmentParameters;
}
