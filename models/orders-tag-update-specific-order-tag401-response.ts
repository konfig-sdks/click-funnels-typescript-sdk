 ...
 * 
 * @export
 * @interface OrdersTagUpdateSpecificOrderTag401Response
 */
export interface OrdersTagUpdateSpecificOrderTag401Response {
    /**
     * 
     * @type {string}
     * @memberof OrdersTagUpdateSpecificOrderTag401Response
     */
    'error'?: string;
}
