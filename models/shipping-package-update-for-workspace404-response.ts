 ...
 * 
 * @export
 * @interface ShippingPackageUpdateForWorkspace404Response
 */
export interface ShippingPackageUpdateForWorkspace404Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingPackageUpdateForWorkspace404Response
     */
    'error'?: string;
}
