 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointCreateNewRequest
 */
export interface WebhooksOutgoingEndpointCreateNewRequest {
    /**
     * 
     * @type {WebhooksOutgoingEndpointParameters}
     * @memberof WebhooksOutgoingEndpointCreateNewRequest
     */
