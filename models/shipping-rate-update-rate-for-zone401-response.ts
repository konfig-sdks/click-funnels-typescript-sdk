 ...
 * 
 * @export
 * @interface ShippingRateUpdateRateForZone401Response
 */
export interface ShippingRateUpdateRateForZone401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingRateUpdateRateForZone401Response
     */
    'error'?: string;
}
