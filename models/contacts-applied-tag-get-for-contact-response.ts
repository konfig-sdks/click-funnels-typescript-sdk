 ...
 * 
 * @export
 * @interface ContactsAppliedTagGetForContactResponse
 */
export interface ContactsAppliedTagGetForContactResponse {
    /**
     * 
     * @type {string}
     * @memberof ContactsAppliedTagGetForContactResponse
     */
    'error'?: string;
}
