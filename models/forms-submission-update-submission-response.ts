 ...
 * 
 * @export
 * @interface FormsSubmissionUpdateSubmissionResponse
 */
export interface FormsSubmissionUpdateSubmissionResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsSubmissionUpdateSubmissionResponse
     */
    'error'?: string;
}
