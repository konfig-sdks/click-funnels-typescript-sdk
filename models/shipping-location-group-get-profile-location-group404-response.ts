 ...
 * 
 * @export
 * @interface ShippingLocationGroupGetProfileLocationGroup404Response
 */
export interface ShippingLocationGroupGetProfileLocationGroup404Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingLocationGroupGetProfileLocationGroup404Response
     */
    'error'?: string;
}
