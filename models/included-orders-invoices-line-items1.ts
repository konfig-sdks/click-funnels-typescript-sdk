 ...
 * @export
 * @interface IncludedOrdersInvoicesLineItems1
 */
export interface IncludedOrdersInvoicesLineItems1 {
    /**
     * Included Orders Line Item ID
     * @type {number}
     * @memberof IncludedOrdersInvoicesLineItems1
     */
    'id': number;
    /**
     * Public ID
