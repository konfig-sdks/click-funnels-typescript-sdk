 ...
 * 
 * @export
 * @interface ShippingRatesNameCreateNewRateNameResponse
 */
export interface ShippingRatesNameCreateNewRateNameResponse {
    /**
     * 
     * @type {string}
     * @memberof ShippingRatesNameCreateNewRateNameResponse
     */
    'error'?: string;
}
