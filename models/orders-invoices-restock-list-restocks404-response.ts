 ...
 * 
 * @export
 * @interface OrdersInvoicesRestockListRestocks404Response
 */
export interface OrdersInvoicesRestockListRestocks404Response {
    /**
     ...
     * @type {string}
     * @memberof OrdersInvoicesRestockListRestocks404Response
     */
    'error'?: string;
}
