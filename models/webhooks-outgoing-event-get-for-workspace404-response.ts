 ...
 * 
 * @export
 * @interface WebhooksOutgoingEventGetForWorkspace404Response
 */
export interface WebhooksOutgoingEventGetForWorkspace404Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEventGetForWorkspace404Response
     */
    'error'?: string;
}
