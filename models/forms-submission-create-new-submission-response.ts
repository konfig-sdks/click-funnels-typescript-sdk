 ...
 * 
 * @export
 * @interface FormsSubmissionCreateNewSubmissionResponse
 */
export interface FormsSubmissionCreateNewSubmissionResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsSubmissionCreateNewSubmissionResponse
     */
    'error'?: string;
}
