...
import { CoursesLessonParameters } from './courses-lesson-parameters';

/**
 * 
 * @export
 * @interface CoursesLessonUpdateLessonByIdRequest
 */
export interface CoursesLessonUpdateLessonByIdRequest {
    /**
     * 
     * @type {CoursesLessonParameters}
     * @memberof CoursesLessonUpdateLessonByIdRequest
     */
    'courses_lesson'?: CoursesLessonParameters;
}
