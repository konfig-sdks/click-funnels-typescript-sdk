 ...
 * 
 * @export
 * @interface ShippingProfileUpdateForWorkspace401Response
 */
export interface ShippingProfileUpdateForWorkspace401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingProfileUpdateForWorkspace401Response
     */
    'error'?: string;
}
