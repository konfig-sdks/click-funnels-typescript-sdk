 ...
 * 
 * @export
 * @interface ProductsVariantCreateNewVariantResponse
 */
export interface ProductsVariantCreateNewVariantResponse {
    /**
     * 
     * @type {string}
     * @memberof ProductsVariantCreateNewVariantResponse
     */
    'error'?: string;
}
