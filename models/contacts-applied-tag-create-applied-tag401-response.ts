 ...
 * 
 * @export
 * @interface ContactsAppliedTagCreateAppliedTag401Response
 */
export interface ContactsAppliedTagCreateAppliedTag401Response {
    /**
     * 
     * @type {string}
     * @memberof ContactsAppliedTagCreateAppliedTag401Response
     */
    'error'?: string;
}
