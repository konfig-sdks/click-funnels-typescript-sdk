 ...
 * 
 * @export
 * @interface FormsFieldsOptionUpdateFieldOptionResponse
 */
export interface FormsFieldsOptionUpdateFieldOptionResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionUpdateFieldOptionResponse
     */
    'error'?: string;
}
