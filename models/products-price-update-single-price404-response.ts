 ...
 * 
 * @export
 * @interface ProductsPriceUpdateSinglePrice404Response
 */
export interface ProductsPriceUpdateSinglePrice404Response {
    /**
     * 
     * @type {string}
     * @memberof ProductsPriceUpdateSinglePrice404Response
     */
    'error'?: string;
}
