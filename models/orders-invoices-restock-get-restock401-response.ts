 ...
 * 
 * @export
 * @interface OrdersInvoicesRestockGetRestock401Response
 */
export interface OrdersInvoicesRestockGetRestock401Response {
    /**
     * 
     * @type {string}
     * @memberof OrdersInvoicesRestockGetRestock401Response
     */
    'error'?: string;
}
