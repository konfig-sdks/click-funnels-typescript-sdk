 ...
 * 
 * @export
 * @interface OrdersInvoicesRestockGetRestock404Response
 */
export interface OrdersInvoicesRestockGetRestock404Response {
    /**
     ...
     * @type {string}
     * @memberof OrdersInvoicesRestockGetRestock404Response
     */
    'error'?: string;
}
