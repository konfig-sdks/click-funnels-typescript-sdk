 ...
 * 
 * @export
 * @interface ShippingProfileUpdateForWorkspace404Response
 */
export interface ShippingProfileUpdateForWorkspace404Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingProfileUpdateForWorkspace404Response
     */
    'error'?: string;
}
