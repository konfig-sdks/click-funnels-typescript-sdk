 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointCreateNew401Response
 */
export interface WebhooksOutgoingEndpointCreateNew401Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEndpointCreateNew401Response
     */
    'error'?: string;
}
