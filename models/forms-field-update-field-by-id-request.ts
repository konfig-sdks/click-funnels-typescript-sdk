...
import { FormsFieldParameters } from './forms-field-parameters';

/**
 * 
 * @export
 * @interface FormsFieldUpdateFieldByIdRequest
 */
export interface FormsFieldUpdateFieldByIdRequest {
    /**
     * 
     * @type {FormsFieldParameters}
     * @memberof FormsFieldUpdateFieldByIdRequest
     */
    'forms_field'?: FormsFieldParameters;
}
