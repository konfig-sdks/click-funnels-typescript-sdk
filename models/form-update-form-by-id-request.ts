...
import { FormParameters } from './form-parameters';

/**
 * 
 * @export
 * @interface FormUpdateFormByIdRequest
 */
export interface FormUpdateFormByIdRequest {
    /**
     * 
     * @type {FormParameters}
     * @memberof FormUpdateFormByIdRequest
     */
    'form'?: FormParameters;
}
