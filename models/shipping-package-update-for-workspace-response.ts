 ...
 * 
 * @export
 * @interface ShippingPackageUpdateForWorkspaceResponse
 */
export interface ShippingPackageUpdateForWorkspaceResponse {
    /**
     * 
     * @type {string}
     * @memberof ShippingPackageUpdateForWorkspaceResponse
     */
    'error'?: string;
}
