 ...
 * 
 * @export
 * @interface FulfillmentsLocationRemoveByIdResponse
 */
export interface FulfillmentsLocationRemoveByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof FulfillmentsLocationRemoveByIdResponse
     */
    'error'?: string;
}
