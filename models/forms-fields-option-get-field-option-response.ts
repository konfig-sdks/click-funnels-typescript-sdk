 ...
 * 
 * @export
 * @interface FormsFieldsOptionGetFieldOptionResponse
 */
export interface FormsFieldsOptionGetFieldOptionResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionGetFieldOptionResponse
     */
    'error'?: string;
}
