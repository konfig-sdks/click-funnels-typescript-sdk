 ...
 * 
 * @export
 * @interface CoursesEnrollmentCreateNewEnrollmentResponse
 */
export interface CoursesEnrollmentCreateNewEnrollmentResponse {
    /**
     * 
     * @type {string}
     * @memberof CoursesEnrollmentCreateNewEnrollmentResponse
     */
    'error'?: string;
}
