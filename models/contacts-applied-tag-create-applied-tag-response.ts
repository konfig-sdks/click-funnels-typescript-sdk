 ...
 * 
 * @export
 * @interface ContactsAppliedTagCreateAppliedTagResponse
 */
export interface ContactsAppliedTagCreateAppliedTagResponse {
    /**
     * 
     * @type {string}
     * @memberof ContactsAppliedTagCreateAppliedTagResponse
     */
    'error'?: string;
}
