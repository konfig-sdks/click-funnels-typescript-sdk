...
import { WebhooksOutgoingEventAttributesData } from './webhooks-outgoing-event-attributes-data';

/**
 * Webhooks Events
 * @export
 * @interface WebhooksOutgoingEventAttributes
 */
export interface WebhooksOutgoingEventAttributes {
    /**
     * Event ID
     * @type {string}
     * @memberof WebhooksOutgoingEventAttributes
     */
    'id': string;
    /**
     * Event public ID
    ...
    /**
     * 
     * @type {WebhooksOutgoingEventAttributesData}
     * @memberof WebhooksOutgoingEventAttributes
     */
    'data'?: WebhooksOutgoingEventAttributesData;
    /**
     * Happened At
     * @type {any}
     * @memberof WebhooksOutgoingEventAttributes
