 ...
 * 
 * @export
 * @interface CoursesEnrollmentUpdateSpecificEnrollment404Response
 */
export interface CoursesEnrollmentUpdateSpecificEnrollment404Response {
    /**
     * 
     * @type {string}
     * @memberof CoursesEnrollmentUpdateSpecificEnrollment404Response
     */
    'error'?: string;
}
