 ...
 * 
 * @export
 * @interface ShippingRateUpdateRateForZone404Response
 */
export interface ShippingRateUpdateRateForZone404Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingRateUpdateRateForZone404Response
     */
    'error'?: string;
}
