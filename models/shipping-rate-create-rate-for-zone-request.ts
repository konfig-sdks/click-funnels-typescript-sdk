...
import { ShippingRateParameters } from './shipping-rate-parameters';

/**
 * 
 * @export
 * @interface ShippingRateCreateRateForZoneRequest
 */
export interface ShippingRateCreateRateForZoneRequest {
    /**
     * 
     * @type {ShippingRateParameters}
     * @memberof ShippingRateCreateRateForZoneRequest
     */
    'shipping_rate'?: ShippingRateParameters;
}
