...
import { OrdersTagParameters } from './orders-tag-parameters';

/**
 * 
 * @export
 * @interface OrdersTagUpdateSpecificOrderTagRequest
 */
export interface OrdersTagUpdateSpecificOrderTagRequest {
    /**
     * 
     * @type {OrdersTagParameters}
     * @memberof OrdersTagUpdateSpecificOrderTagRequest
     */
    'orders_tag'?: OrdersTagParameters;
}
