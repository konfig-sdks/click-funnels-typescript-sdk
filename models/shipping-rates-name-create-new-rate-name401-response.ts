 ...
 * 
 * @export
 * @interface ShippingRatesNameCreateNewRateName401Response
 */
export interface ShippingRatesNameCreateNewRateName401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingRatesNameCreateNewRateName401Response
     */
    'error'?: string;
}
