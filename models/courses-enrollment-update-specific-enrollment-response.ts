 ...
 * 
 * @export
 * @interface CoursesEnrollmentUpdateSpecificEnrollmentResponse
 */
export interface CoursesEnrollmentUpdateSpecificEnrollmentResponse {
    /**
     * 
     * @type {string}
     * @memberof CoursesEnrollmentUpdateSpecificEnrollmentResponse
     */
    'error'?: string;
}
