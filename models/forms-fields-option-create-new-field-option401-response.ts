 ...
 * 
 * @export
 * @interface FormsFieldsOptionCreateNewFieldOption401Response
 */
export interface FormsFieldsOptionCreateNewFieldOption401Response {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionCreateNewFieldOption401Response
     */
    'error'?: string;
}
