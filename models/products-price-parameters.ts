 ...
 * Prices
 * @export
 * @interface ProductsPriceParameters
 */
export interface ProductsPriceParameters {
    /**
     * Name
     * @type {any}
     * @memberof ProductsPriceParameters
     */
    'name'?: any;
    /**
     * Amount
     ...
     * @memberof ProductsPriceParameters
     */
    'payment_type'?: ProductsPriceParametersPaymentTypeEnum;
    /**
     * Visible
     * @type {any}
     * @memberof ProductsPriceParameters
...
type ProductsPriceParametersPaymentTypeEnum = 'one_time' | 'subscription' | 'payment_plan'
