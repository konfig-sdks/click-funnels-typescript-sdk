...
import { OrdersInvoicesLineItemAttributes } from './orders-invoices-line-item-attributes';

/**
 * Invoices
 * @export
 * @interface OrdersInvoiceAttributes
 */
export interface OrdersInvoiceAttributes {
    /**
     * Invoice ID
     * @type {number}
     * @memberof OrdersInvoiceAttributes
     */
    'id': number;
    /**
     * Invoice public ID
     ...
     * @memberof OrdersInvoiceAttributes
     */
    'invoice_type'?: OrdersInvoiceAttributesInvoiceTypeEnum;
    /**
     * Added
     * @type {any}
     * @memberof OrdersInvoiceAttributes
    ...
    /**
     * Invoice Line Items
     * @type {Array<OrdersInvoicesLineItemAttributes>}
     * @memberof OrdersInvoiceAttributes
     */
    'line_items'?: Array<OrdersInvoicesLineItemAttributes>;
}

type OrdersInvoiceAttributesInvoiceTypeEnum = 'initial' | 'renewal' | 'interim' | 'cancellation' | 'one_time' | 'refund' | 'charge' | 'one_time_sale'
