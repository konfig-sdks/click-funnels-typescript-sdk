 ...
 * 
 * @export
 * @interface FormsFieldSetCreateNewFieldSetResponse
 */
export interface FormsFieldSetCreateNewFieldSetResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldSetCreateNewFieldSetResponse
     */
    'error'?: string;
}
