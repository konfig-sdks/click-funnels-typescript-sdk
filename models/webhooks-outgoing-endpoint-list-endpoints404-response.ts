 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointListEndpoints404Response
 */
export interface WebhooksOutgoingEndpointListEndpoints404Response {
    /**
     ...
     * @type {string}
     * @memberof WebhooksOutgoingEndpointListEndpoints404Response
     */
    'error'?: string;
}
