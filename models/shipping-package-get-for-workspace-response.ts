 ...
 * 
 * @export
 * @interface ShippingPackageGetForWorkspaceResponse
 */
export interface ShippingPackageGetForWorkspaceResponse {
    /**
     * 
     * @type {string}
     * @memberof ShippingPackageGetForWorkspaceResponse
     */
    'error'?: string;
}
