 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointUpdateEndpointResponse
 */
export interface WebhooksOutgoingEndpointUpdateEndpointResponse {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEndpointUpdateEndpointResponse
     */
    'error'?: string;
}
