...
import { OrdersAppliedTagParameters } from './orders-applied-tag-parameters';

/**
 * 
 * @export
 * @interface OrdersAppliedTagCreateAppliedTagRequest
 */
export interface OrdersAppliedTagCreateAppliedTagRequest {
    /**
     * 
     * @type {OrdersAppliedTagParameters}
     * @memberof OrdersAppliedTagCreateAppliedTagRequest
     */
    'orders_applied_tag'?: OrdersAppliedTagParameters;
}
