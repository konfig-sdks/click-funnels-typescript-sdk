...
import { ShippingPackageParameters } from './shipping-package-parameters';

/**
 * 
 * @export
 * @interface ShippingPackageUpdateForWorkspaceRequest
 */
export interface ShippingPackageUpdateForWorkspaceRequest {
    /**
     * 
     * @type {ShippingPackageParameters}
     * @memberof ShippingPackageUpdateForWorkspaceRequest
     */
    'shipping_package'?: ShippingPackageParameters;
}
