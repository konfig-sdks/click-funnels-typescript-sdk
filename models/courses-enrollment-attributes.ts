 ...
 * Enrollments
 * @export
 * @interface CoursesEnrollmentAttributes
 */
export interface CoursesEnrollmentAttributes {
    /**
     * Enrollment ID
     * @type {number}
     * @memberof CoursesEnrollmentAttributes
     */
    'id': number;
    /**
