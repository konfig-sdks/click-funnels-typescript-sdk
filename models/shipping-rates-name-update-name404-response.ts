 ...
 * 
 * @export
 * @interface ShippingRatesNameUpdateName404Response
 */
export interface ShippingRatesNameUpdateName404Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingRatesNameUpdateName404Response
     */
    'error'?: string;
}
