 ...
 * 
 * @export
 * @interface FormsFieldsOptionUpdateFieldOptionRequest
 */
export interface FormsFieldsOptionUpdateFieldOptionRequest {
    /**
     * 
     * @type {FormsFieldsOptionParameters}
     * @memberof FormsFieldsOptionUpdateFieldOptionRequest
     */
