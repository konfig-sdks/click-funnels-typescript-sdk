 ...
 * 
 * @export
 * @interface ShippingLocationGroupGetProfileLocationGroupResponse
 */
export interface ShippingLocationGroupGetProfileLocationGroupResponse {
    /**
     * 
     * @type {string}
     * @memberof ShippingLocationGroupGetProfileLocationGroupResponse
     */
    'error'?: string;
}
