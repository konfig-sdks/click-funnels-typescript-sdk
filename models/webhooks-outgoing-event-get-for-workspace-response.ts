 ...
 * 
 * @export
 * @interface WebhooksOutgoingEventGetForWorkspaceResponse
 */
export interface WebhooksOutgoingEventGetForWorkspaceResponse {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEventGetForWorkspaceResponse
     */
    'error'?: string;
}
