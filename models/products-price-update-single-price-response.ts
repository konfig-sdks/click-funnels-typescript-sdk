 ...
 * 
 * @export
 * @interface ProductsPriceUpdateSinglePriceResponse
 */
export interface ProductsPriceUpdateSinglePriceResponse {
    /**
     * 
     * @type {string}
     * @memberof ProductsPriceUpdateSinglePriceResponse
     */
    'error'?: string;
}
