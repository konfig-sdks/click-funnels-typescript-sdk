 ...
 * Prices
 * @export
 * @interface ProductsPriceAttributes
 */
export interface ProductsPriceAttributes {
    /**
     * ID
     * @type {number}
     * @memberof ProductsPriceAttributes
     */
    'id': number;
    /**
     * Price public ID
     ...
     * @memberof ProductsPriceAttributes
     */
    'payment_type'?: ProductsPriceAttributesPaymentTypeEnum;
    /**
     * Visible
     * @type {any}
     * @memberof ProductsPriceAttributes
...
type ProductsPriceAttributesPaymentTypeEnum = 'one_time' | 'subscription' | 'payment_plan'
