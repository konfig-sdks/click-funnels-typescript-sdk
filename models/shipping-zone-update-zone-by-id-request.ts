...
import { ShippingZoneParameters } from './shipping-zone-parameters';

/**
 * 
 * @export
 * @interface ShippingZoneUpdateZoneByIdRequest
 */
export interface ShippingZoneUpdateZoneByIdRequest {
    /**
     * 
     * @type {ShippingZoneParameters}
     * @memberof ShippingZoneUpdateZoneByIdRequest
     */
    'shipping_zone'?: ShippingZoneParameters;
}
