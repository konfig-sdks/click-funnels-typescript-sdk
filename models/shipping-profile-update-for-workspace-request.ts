...
import { ShippingProfileParameters } from './shipping-profile-parameters';

/**
 * 
 * @export
 * @interface ShippingProfileUpdateForWorkspaceRequest
 */
export interface ShippingProfileUpdateForWorkspaceRequest {
    /**
     * 
     * @type {ShippingProfileParameters}
     * @memberof ShippingProfileUpdateForWorkspaceRequest
     */
    'shipping_profile'?: ShippingProfileParameters;
}
