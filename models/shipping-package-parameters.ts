 ...
 * Packages
 * @export
 * @interface ShippingPackageParameters
 */
export interface ShippingPackageParameters {
    /**
     * Package Type
     * @type {string}
     * @memberof ShippingPackageParameters
     */
    'package_type': ShippingPackageParametersPackageTypeEnum;
    /**
     * Height
     * @type {number}
     * @memberof ShippingPackageParameters
     ...
     * @memberof ShippingPackageParameters
     */
    'distance_unit': ShippingPackageParametersDistanceUnitEnum;
    /**
     * Empty Weight
     * @type {any}
     * @memberof ShippingPackageParameters
     ...
     * @memberof ShippingPackageParameters
     */
    'weight_unit'?: ShippingPackageParametersWeightUnitEnum;
    /**
     * Default Package
     * @type {any}
     * @memberof ShippingPackageParameters
     ...
     * @memberof ShippingPackageParameters
     */
    'carrier'?: ShippingPackageParametersCarrierEnum;
}

type ShippingPackageParametersPackageTypeEnum = 'box' | 'envelope' | 'soft_package'
type ShippingPackageParametersDistanceUnitEnum = 'in' | 'cm' | 'ft' | 'm' | 'mm'
type ShippingPackageParametersWeightUnitEnum = 'lb' | 'kg' | 'g' | 'oz'
type ShippingPackageParametersCarrierEnum = 'fedex' | 'ups' | 'usps'
