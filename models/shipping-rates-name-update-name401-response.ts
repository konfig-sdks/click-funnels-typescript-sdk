 ...
 * 
 * @export
 * @interface ShippingRatesNameUpdateName401Response
 */
export interface ShippingRatesNameUpdateName401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingRatesNameUpdateName401Response
     */
    'error'?: string;
}
