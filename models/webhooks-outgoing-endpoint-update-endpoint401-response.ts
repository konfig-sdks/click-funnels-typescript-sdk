 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointUpdateEndpoint401Response
 */
export interface WebhooksOutgoingEndpointUpdateEndpoint401Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEndpointUpdateEndpoint401Response
     */
    'error'?: string;
}
