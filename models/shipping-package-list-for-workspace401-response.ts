 ...
 * 
 * @export
 * @interface ShippingPackageListForWorkspace401Response
 */
export interface ShippingPackageListForWorkspace401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingPackageListForWorkspace401Response
     */
    'error'?: string;
}
