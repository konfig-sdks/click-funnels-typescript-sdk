 ...
 * 
 * @export
 * @interface FormsFieldSetUpdateFieldSetByIdResponse
 */
export interface FormsFieldSetUpdateFieldSetByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldSetUpdateFieldSetByIdResponse
     */
    'error'?: string;
}
