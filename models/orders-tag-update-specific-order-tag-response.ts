 ...
 * 
 * @export
 * @interface OrdersTagUpdateSpecificOrderTagResponse
 */
export interface OrdersTagUpdateSpecificOrderTagResponse {
    /**
     * 
     * @type {string}
     * @memberof OrdersTagUpdateSpecificOrderTagResponse
     */
    'error'?: string;
}
