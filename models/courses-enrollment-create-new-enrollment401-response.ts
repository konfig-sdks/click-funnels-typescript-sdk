 ...
 * 
 * @export
 * @interface CoursesEnrollmentCreateNewEnrollment401Response
 */
export interface CoursesEnrollmentCreateNewEnrollment401Response {
    /**
     * 
     * @type {string}
     * @memberof CoursesEnrollmentCreateNewEnrollment401Response
     */
    'error'?: string;
}
