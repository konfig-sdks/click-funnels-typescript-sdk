 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointGet404Response
 */
export interface WebhooksOutgoingEndpointGet404Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEndpointGet404Response
     */
    'error'?: string;
}
