...
import { ContactsTagParameters } from './contacts-tag-parameters';

/**
 * 
 * @export
 * @interface ContactsTagUpdateSpecificTagRequest
 */
export interface ContactsTagUpdateSpecificTagRequest {
    /**
     * 
     * @type {ContactsTagParameters}
     * @memberof ContactsTagUpdateSpecificTagRequest
     */
    'contacts_tag'?: ContactsTagParameters;
}
