...
import { FormsFieldsOptionParameters } from './forms-fields-option-parameters';

/**
 * 
 * @export
 * @interface FormsFieldsOptionCreateNewFieldOptionRequest
 */
export interface FormsFieldsOptionCreateNewFieldOptionRequest {
    /**
     * 
     * @type {FormsFieldsOptionParameters}
     * @memberof FormsFieldsOptionCreateNewFieldOptionRequest
     */
    'forms_fields_option'?: FormsFieldsOptionParameters;
}
