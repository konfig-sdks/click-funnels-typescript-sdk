 ...
 * 
 * @export
 * @interface FormsFieldsOptionDeleteOptionForField404Response
 */
export interface FormsFieldsOptionDeleteOptionForField404Response {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionDeleteOptionForField404Response
     */
    'error'?: string;
}
