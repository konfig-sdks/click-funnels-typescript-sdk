...
import { ContactsPropertyTagIdsInner } from './contacts-property-tag-ids-inner';

/**
 * Contacts
 * @export
 * @interface ContactsProperty
 */
export interface ContactsProperty {
    /**
     * Email address
     * @type {any}
     * @memberof ContactsProperty
     */
    'email_address': any;
    /**
     * First name
     ...
     * @type {Array<ContactsPropertyTagIdsInner>}
     * @memberof ContactsProperty
     */
    'tag_ids'?: Array<ContactsPropertyTagIdsInner>;
}
