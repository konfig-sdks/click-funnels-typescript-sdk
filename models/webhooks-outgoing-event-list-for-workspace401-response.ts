 ...
 * 
 * @export
 * @interface WebhooksOutgoingEventListForWorkspace401Response
 */
export interface WebhooksOutgoingEventListForWorkspace401Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEventListForWorkspace401Response
     */
    'error'?: string;
}
