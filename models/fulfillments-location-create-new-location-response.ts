 ...
 * 
 * @export
 * @interface FulfillmentsLocationCreateNewLocationResponse
 */
export interface FulfillmentsLocationCreateNewLocationResponse {
    /**
     * 
     * @type {string}
     * @memberof FulfillmentsLocationCreateNewLocationResponse
     */
    'error'?: string;
}
