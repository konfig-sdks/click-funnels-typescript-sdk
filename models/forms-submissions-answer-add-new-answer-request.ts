...
import { FormsSubmissionsAnswerParameters } from './forms-submissions-answer-parameters';

/**
 * 
 * @export
 * @interface FormsSubmissionsAnswerAddNewAnswerRequest
 */
export interface FormsSubmissionsAnswerAddNewAnswerRequest {
    /**
     * 
     * @type {FormsSubmissionsAnswerParameters}
     * @memberof FormsSubmissionsAnswerAddNewAnswerRequest
     */
    'forms_submissions_answer'?: FormsSubmissionsAnswerParameters;
}
