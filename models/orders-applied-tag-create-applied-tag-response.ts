 ...
 * 
 * @export
 * @interface OrdersAppliedTagCreateAppliedTagResponse
 */
export interface OrdersAppliedTagCreateAppliedTagResponse {
    /**
     * 
     * @type {string}
     * @memberof OrdersAppliedTagCreateAppliedTagResponse
     */
    'error'?: string;
}
