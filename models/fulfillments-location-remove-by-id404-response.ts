 ...
 * 
 * @export
 * @interface FulfillmentsLocationRemoveById404Response
 */
export interface FulfillmentsLocationRemoveById404Response {
    /**
     * 
     * @type {string}
     * @memberof FulfillmentsLocationRemoveById404Response
     */
    'error'?: string;
}
