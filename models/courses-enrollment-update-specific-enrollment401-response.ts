 ...
 * 
 * @export
 * @interface CoursesEnrollmentUpdateSpecificEnrollment401Response
 */
export interface CoursesEnrollmentUpdateSpecificEnrollment401Response {
    /**
     * 
     * @type {string}
     * @memberof CoursesEnrollmentUpdateSpecificEnrollment401Response
     */
    'error'?: string;
}
