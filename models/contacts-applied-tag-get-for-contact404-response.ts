 ...
 * 
 * @export
 * @interface ContactsAppliedTagGetForContact404Response
 */
export interface ContactsAppliedTagGetForContact404Response {
    /**
     * 
     * @type {string}
     * @memberof ContactsAppliedTagGetForContact404Response
     */
    'error'?: string;
}
