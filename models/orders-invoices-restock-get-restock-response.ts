...
import { IncludedOrdersInvoicesLineItems1 } from './included-orders-invoices-line-items1';

/**
 * Restock
 * @export
 * @interface OrdersInvoicesRestockGetRestockResponse
 */
export interface OrdersInvoicesRestockGetRestockResponse {
    /**
     * Restock
     * @type {number}
     * @memberof OrdersInvoicesRestockGetRestockResponse
     */
    'id': number;
    /**
     * Public Restock ID
     ...
     * @memberof OrdersInvoicesRestockGetRestockResponse
     */
    'status': OrdersInvoicesRestockGetRestockResponseStatusEnum;
    /**
     * Created At Date
     * @type {any}
     * @memberof OrdersInvoicesRestockGetRestockResponse
    ...
    'updated_at': any;
    /**
     * Included Order Invoices Line Items
     * @type {Array<IncludedOrdersInvoicesLineItems1>}
     * @memberof OrdersInvoicesRestockGetRestockResponse
     */
    'included_invoices_line_items'?: Array<IncludedOrdersInvoicesLineItems1>;
}

type OrdersInvoicesRestockGetRestockResponseStatusEnum = 'cancelled' | 'restocked'
