 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointCreateNewResponse
 */
export interface WebhooksOutgoingEndpointCreateNewResponse {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEndpointCreateNewResponse
     */
    'error'?: string;
}
