 ...
 * 
 * @export
 * @interface FulfillmentsLocationUpdateByIdResponse
 */
export interface FulfillmentsLocationUpdateByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof FulfillmentsLocationUpdateByIdResponse
     */
    'error'?: string;
}
