...
import { ShippingRatesNameParameters } from './shipping-rates-name-parameters';

/**
 * 
 * @export
 * @interface ShippingRatesNameCreateNewRateNameRequest
 */
export interface ShippingRatesNameCreateNewRateNameRequest {
    /**
     * 
     * @type {ShippingRatesNameParameters}
     * @memberof ShippingRatesNameCreateNewRateNameRequest
     */
    'shipping_rates_name'?: ShippingRatesNameParameters;
}
