...
import { FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner } from './fulfillment-parameters-included-orders-invoices-line-items-attributes-inner';

/**
 * Fulfillments
 * @export
 * @interface FulfillmentParameters
 */
export interface FulfillmentParameters {
    /**
     * Contact ID
     * @type {number}
     * @memberof FulfillmentParameters
     */
    'contact_id': number;
    /**
     * Tracking URL
    ...
    'location_id': number;
    /**
     * Create a fulfillment despite the item being out of stock.
     * @type {boolean}
     * @memberof FulfillmentParameters
     */
    'ignore_out_of_stock'?: boolean;
    /**
     * Send an email to the customer when the fulfillment is created.
     * @type {boolean}
     * @memberof FulfillmentParameters
     */
    'notify_customer'?: boolean;
    /**
     * The orders invoices line items to fulfill as part of this fulfillment.
     * @type {Array<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner>}
     * @memberof FulfillmentParameters
     */
    'included_orders_invoices_line_items_attributes': Array<FulfillmentParametersIncludedOrdersInvoicesLineItemsAttributesInner>;
}
