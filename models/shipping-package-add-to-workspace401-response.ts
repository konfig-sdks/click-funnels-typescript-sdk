 ...
 * 
 * @export
 * @interface ShippingPackageAddToWorkspace401Response
 */
export interface ShippingPackageAddToWorkspace401Response {
    /**
     * 
     * @type {string}
     * @memberof ShippingPackageAddToWorkspace401Response
     */
    'error'?: string;
}
