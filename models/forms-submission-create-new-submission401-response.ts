 ...
 * 
 * @export
 * @interface FormsSubmissionCreateNewSubmission401Response
 */
export interface FormsSubmissionCreateNewSubmission401Response {
    /**
     * 
     * @type {string}
     * @memberof FormsSubmissionCreateNewSubmission401Response
     */
    'error'?: string;
}
