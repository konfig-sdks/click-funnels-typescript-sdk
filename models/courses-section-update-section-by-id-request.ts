...
import { CoursesSectionParameters } from './courses-section-parameters';

/**
 * 
 * @export
 * @interface CoursesSectionUpdateSectionByIdRequest
 */
export interface CoursesSectionUpdateSectionByIdRequest {
    /**
     * 
     * @type {CoursesSectionParameters}
     * @memberof CoursesSectionUpdateSectionByIdRequest
     */
    'courses_section'?: CoursesSectionParameters;
}
