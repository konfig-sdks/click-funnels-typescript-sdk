 ...
 * 
 * @export
 * @interface CoursesEnrollmentCreateNewEnrollmentRequest
 */
export interface CoursesEnrollmentCreateNewEnrollmentRequest {
    /**
     * 
     * @type {CoursesEnrollmentParameters}
     * @memberof CoursesEnrollmentCreateNewEnrollmentRequest
     */
