...
import { IncludedOrdersInvoicesLineItems } from './included-orders-invoices-line-items';
...
export interface Restocks {
     ...
     * @type {Array<IncludedOrdersInvoicesLineItems>}
     * @memberof Restocks
     */
    'included_invoices_line_items': Array<IncludedOrdersInvoicesLineItems>;
}

type RestocksStatusEnum = 'cancelled' | 'restocked'
