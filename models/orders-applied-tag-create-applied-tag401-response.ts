 ...
 * 
 * @export
 * @interface OrdersAppliedTagCreateAppliedTag401Response
 */
export interface OrdersAppliedTagCreateAppliedTag401Response {
    /**
     * 
     * @type {string}
     * @memberof OrdersAppliedTagCreateAppliedTag401Response
     */
    'error'?: string;
}
