 ...
 * 
 * @export
 * @interface WebhooksOutgoingEndpointUpdateEndpoint404Response
 */
export interface WebhooksOutgoingEndpointUpdateEndpoint404Response {
    /**
     * 
     * @type {string}
     * @memberof WebhooksOutgoingEndpointUpdateEndpoint404Response
     */
    'error'?: string;
}
