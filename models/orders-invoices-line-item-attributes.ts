...
import { LineItemsProperty } from './line-items-property';
import { LineItemsProperty1 } from './line-items-property1';

/**
 * Line items
 * @export
 * @interface OrdersInvoicesLineItemAttributes
 */
export interface OrdersInvoicesLineItemAttributes {
    /**
     * Description
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'description'?: any;
    /**
     * Line item ID
     ...
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'fulfillment_status'?: OrdersInvoicesLineItemAttributesFulfillmentStatusEnum;
    /**
     * External Product
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     ...
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'state_tax_amount'?: any;
    /**
     * County Tax Amount
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'county_tax_amount'?: any;
    /**
     * City Tax Amount
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     ...
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'district_tax_rate'?: any;
    /**
     * Country Tax Jurisdiction
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'country_tax_jurisdiction'?: any;
    /**
     * State Tax Jurisdiction
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'state_tax_jurisdiction'?: any;
    /**
     * County Tax Jurisdiction
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'county_tax_jurisdiction'?: any;
    /**
     * City Tax Jurisdiction
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'city_tax_jurisdiction'?: any;
    /**
     * Period Start At
     * @type {any}
     * @memberof OrdersInvoicesLineItemAttributes
    ...
    /**
     * 
     * @type {LineItemsProperty}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'products_price'?: LineItemsProperty;
    /**
     * 
     * @type {LineItemsProperty1}
     * @memberof OrdersInvoicesLineItemAttributes
     */
    'products_variant'?: LineItemsProperty1;
}

type OrdersInvoicesLineItemAttributesFulfillmentStatusEnum = 'unfulfilled' | 'partially_fulfilled' | 'complete' | 'ignored'
