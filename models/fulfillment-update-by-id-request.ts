...
import { FulfillmentParameters } from './fulfillment-parameters';

/**
 * 
 * @export
 * @interface FulfillmentUpdateByIdRequest
 */
export interface FulfillmentUpdateByIdRequest {
    /**
     * 
     * @type {FulfillmentParameters}
     * @memberof FulfillmentUpdateByIdRequest
     */
    'fulfillment'?: FulfillmentParameters;
}
