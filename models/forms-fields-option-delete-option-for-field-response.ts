 ...
 * 
 * @export
 * @interface FormsFieldsOptionDeleteOptionForFieldResponse
 */
export interface FormsFieldsOptionDeleteOptionForFieldResponse {
    /**
     * 
     * @type {string}
     * @memberof FormsFieldsOptionDeleteOptionForFieldResponse
     */
    'error'?: string;
}
