 ...
 * 
 * @export
 * @interface OrdersTagUpdateSpecificOrderTag404Response
 */
export interface OrdersTagUpdateSpecificOrderTag404Response {
    /**
     * 
     * @type {string}
     * @memberof OrdersTagUpdateSpecificOrderTag404Response
     */
    'error'?: string;
}
