 ...
 * 
 * @export
 * @interface FormsSubmissionUpdateSubmissionRequest
 */
export interface FormsSubmissionUpdateSubmissionRequest {
    /**
     * 
     * @type {FormsSubmissionParameters}
     * @memberof FormsSubmissionUpdateSubmissionRequest
     */
