...
/**
 * This class provides a wrapper for network errors when making requests to ClickFunnels API
 */
export class ClickFunnelsError extends Error {
  /**
   * The response body
   */
