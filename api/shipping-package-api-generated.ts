...
// @ts-ignore
import { ShippingPackageAddToWorkspace401Response } from '../models';
// @ts-ignore
import { ShippingPackageAddToWorkspaceRequest } from '../models';
// @ts-ignore
import { ShippingPackageAddToWorkspaceResponse } from '../models';
// @ts-ignore
import { ShippingPackageAttributes } from '../models';
// @ts-ignore
import { ShippingPackageGetForWorkspace404Response } from '../models';
// @ts-ignore
import { ShippingPackageGetForWorkspaceResponse } from '../models';
// @ts-ignore
import { ShippingPackageListForWorkspace401Response } from '../models';
// @ts-ignore
import { ShippingPackageListForWorkspace404Response } from '../models';
// @ts-ignore
import { ShippingPackageRemoveById404Response } from '../models';
// @ts-ignore
import { ShippingPackageRemoveByIdResponse } from '../models';
// @ts-ignore
import { ShippingPackageUpdateForWorkspace401Response } from '../models';
// @ts-ignore
import { ShippingPackageUpdateForWorkspace404Response } from '../models';
// @ts-ignore
import { ShippingPackageUpdateForWorkspaceRequest } from '../models';
// @ts-ignore
import { ShippingPackageUpdateForWorkspaceResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ShippingPackageApi - axios parameter creator
 * @export
 */
export const ShippingPackageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new package to a workspace
         * @summary Create Package
         * @param {number} workspaceId 
         * @param {ShippingPackageAddToWorkspaceRequest} shippingPackageAddToWorkspaceRequest Information about a new Package
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addToWorkspace: async (workspaceId: number, shippingPackageAddToWorkspaceRequest: ShippingPackageAddToWorkspaceRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('addToWorkspace', 'workspaceId', workspaceId)
            // verify required parameter 'shippingPackageAddToWorkspaceRequest' is not null or undefined
            assertParamExists('addToWorkspace', 'shippingPackageAddToWorkspaceRequest', shippingPackageAddToWorkspaceRequest)
            const localVarPath = `/workspaces/{workspace_id}/shipping/packages`
            ...
            requestBeforeHook({
                requestBody: shippingPackageAddToWorkspaceRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/shipping/packages',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(shippingPackageAddToWorkspaceRequest, localVarRequestOptions, configuration)
        ...
        getForWorkspace: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/shipping/packages/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/shipping/packages/{id}',
                httpMethod: 'GET'
            });
         ...
         * @param {string} id 
         * @param {ShippingPackageUpdateForWorkspaceRequest} shippingPackageUpdateForWorkspaceRequest Information about updated fields in Package
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateForWorkspace: async (id: string, shippingPackageUpdateForWorkspaceRequest: ShippingPackageUpdateForWorkspaceRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateForWorkspace', 'id', id)
            // verify required parameter 'shippingPackageUpdateForWorkspaceRequest' is not null or undefined
            assertParamExists('updateForWorkspace', 'shippingPackageUpdateForWorkspaceRequest', shippingPackageUpdateForWorkspaceRequest)
            const localVarPath = `/shipping/packages/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: shippingPackageUpdateForWorkspaceRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(shippingPackageUpdateForWorkspaceRequest, localVarRequestOptions, configuration)
...
/**
 * ShippingPackageApi - functional programming interface
 * @export
 */
export const ShippingPackageApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ShippingPackageApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new package to a workspace
         * @summary Create Package
         * @param {ShippingPackageApiAddToWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async addToWorkspace(requestParameters: ShippingPackageApiAddToWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingPackageAttributes>> {
            const shippingPackageAddToWorkspaceRequest: ShippingPackageAddToWorkspaceRequest = {
                shipping_package: requestParameters.shipping_package
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.addToWorkspace(requestParameters.workspaceId, shippingPackageAddToWorkspaceRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a package for a workspace
         * @summary Fetch Package
         * @param {ShippingPackageApiGetForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getForWorkspace(requestParameters: ShippingPackageApiGetForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingPackageAttributes>> {
         ...
         * List packages for a workspace
         * @summary List Packages
         * @param {ShippingPackageApiListForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listForWorkspace(requestParameters: ShippingPackageApiListForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ShippingPackageAttributes>>> {
         ...
         * Delete a package for a workspace
         * @summary Remove Package
         * @param {ShippingPackageApiRemoveByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async removeById(requestParameters: ShippingPackageApiRemoveByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * Update a package for a workspace
         * @summary Update Package
         * @param {ShippingPackageApiUpdateForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateForWorkspace(requestParameters: ShippingPackageApiUpdateForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingPackageAttributes>> {
            const shippingPackageUpdateForWorkspaceRequest: ShippingPackageUpdateForWorkspaceRequest = {
                shipping_package: requestParameters.shipping_package
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateForWorkspace(requestParameters.id, shippingPackageUpdateForWorkspaceRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ShippingPackageApi - factory interface
 * @export
 */
export const ShippingPackageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ShippingPackageApiFp(configuration)
    return {
        /**
         * Add a new package to a workspace
         * @summary Create Package
         ...
         * @throws {RequiredError}
         */
        addToWorkspace(requestParameters: ShippingPackageApiAddToWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingPackageAttributes> {
            return localVarFp.addToWorkspace(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a package for a workspace
         * @summary Fetch Package
         ...
         * @throws {RequiredError}
         */
        getForWorkspace(requestParameters: ShippingPackageApiGetForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingPackageAttributes> {
         ...
         * @throws {RequiredError}
         */
        listForWorkspace(requestParameters: ShippingPackageApiListForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ShippingPackageAttributes>> {
         ...
         * @throws {RequiredError}
         */
        removeById(requestParameters: ShippingPackageApiRemoveByIdRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateForWorkspace(requestParameters: ShippingPackageApiUpdateForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingPackageAttributes> {
...
/**
 * Request parameters for addToWorkspace operation in ShippingPackageApi.
 * @export
 * @interface ShippingPackageApiAddToWorkspaceRequest
 */
export type ShippingPackageApiAddToWorkspaceRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ShippingPackageApiAddToWorkspace
    */
...
/**
 * Request parameters for getForWorkspace operation in ShippingPackageApi.
 * @export
 * @interface ShippingPackageApiGetForWorkspaceRequest
 */
export type ShippingPackageApiGetForWorkspaceRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingPackageApiGetForWorkspace
    */
    readonly id: string
...
/**
 * Request parameters for listForWorkspace operation in ShippingPackageApi.
 * @export
 * @interface ShippingPackageApiListForWorkspaceRequest
 */
export type ShippingPackageApiListForWorkspaceRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ShippingPackageApiListForWorkspace
    */
    readonly workspaceId: number
...
/**
 * Request parameters for removeById operation in ShippingPackageApi.
 * @export
 * @interface ShippingPackageApiRemoveByIdRequest
 */
export type ShippingPackageApiRemoveByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingPackageApiRemoveById
    */
    readonly id: string
...
/**
 * Request parameters for updateForWorkspace operation in ShippingPackageApi.
 * @export
 * @interface ShippingPackageApiUpdateForWorkspaceRequest
 */
export type ShippingPackageApiUpdateForWorkspaceRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingPackageApiUpdateForWorkspace
    */
    readonly id: string
...
/**
 * ShippingPackageApiGenerated - object-oriented interface
 * @export
 * @class ShippingPackageApiGenerated
 * @extends {BaseAPI}
 */
export class ShippingPackageApiGenerated extends BaseAPI {
    /**
     * Add a new package to a workspace
     * @summary Create Package
     * @param {ShippingPackageApiAddToWorkspaceRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ShippingPackageApiGenerated
     */
    public addToWorkspace(requestParameters: ShippingPackageApiAddToWorkspaceRequest, options?: AxiosRequestConfig) {
        return ShippingPackageApiFp(this.configuration).addToWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingPackageApiGenerated
     */
    public getForWorkspace(requestParameters: ShippingPackageApiGetForWorkspaceRequest, options?: AxiosRequestConfig) {
        return ShippingPackageApiFp(this.configuration).getForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingPackageApiGenerated
     */
    public listForWorkspace(requestParameters: ShippingPackageApiListForWorkspaceRequest, options?: AxiosRequestConfig) {
        return ShippingPackageApiFp(this.configuration).listForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingPackageApiGenerated
     */
    public removeById(requestParameters: ShippingPackageApiRemoveByIdRequest, options?: AxiosRequestConfig) {
        return ShippingPackageApiFp(this.configuration).removeById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingPackageApiGenerated
     */
    public updateForWorkspace(requestParameters: ShippingPackageApiUpdateForWorkspaceRequest, options?: AxiosRequestConfig) {
        return ShippingPackageApiFp(this.configuration).updateForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
