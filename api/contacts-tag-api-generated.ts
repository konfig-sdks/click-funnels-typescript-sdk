...
// @ts-ignore
import { ContactsTagAttributes } from '../models';
// @ts-ignore
import { ContactsTagCreateNewTag401Response } from '../models';
// @ts-ignore
import { ContactsTagCreateNewTagRequest } from '../models';
// @ts-ignore
import { ContactsTagCreateNewTagResponse } from '../models';
// @ts-ignore
import { ContactsTagGetSingle404Response } from '../models';
// @ts-ignore
import { ContactsTagGetSingleResponse } from '../models';
// @ts-ignore
import { ContactsTagList401Response } from '../models';
// @ts-ignore
import { ContactsTagList404Response } from '../models';
// @ts-ignore
import { ContactsTagRemove404Response } from '../models';
// @ts-ignore
import { ContactsTagRemoveResponse } from '../models';
// @ts-ignore
import { ContactsTagUpdateSpecificTag401Response } from '../models';
// @ts-ignore
import { ContactsTagUpdateSpecificTag404Response } from '../models';
// @ts-ignore
import { ContactsTagUpdateSpecificTagRequest } from '../models';
// @ts-ignore
import { ContactsTagUpdateSpecificTagResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ContactsTagApi - axios parameter creator
 * @export
 */
export const ContactsTagApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new Contact Tag to your Workspace
         * @summary Create Tag
         * @param {number} workspaceId 
         * @param {ContactsTagCreateNewTagRequest} contactsTagCreateNewTagRequest Information about a new Tag
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewTag: async (workspaceId: number, contactsTagCreateNewTagRequest: ContactsTagCreateNewTagRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('createNewTag', 'workspaceId', workspaceId)
            // verify required parameter 'contactsTagCreateNewTagRequest' is not null or undefined
            assertParamExists('createNewTag', 'contactsTagCreateNewTagRequest', contactsTagCreateNewTagRequest)
            const localVarPath = `/workspaces/{workspace_id}/contacts/tags`
            ...
            requestBeforeHook({
                requestBody: contactsTagCreateNewTagRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/contacts/tags',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(contactsTagCreateNewTagRequest, localVarRequestOptions, configuration)
        ...
        getSingle: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/contacts/tags/{id}`
         ...
         * @summary Update Tag
         * @param {string} id 
         * @param {ContactsTagUpdateSpecificTagRequest} contactsTagUpdateSpecificTagRequest Information about updated fields in Tag
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateSpecificTag: async (id: string, contactsTagUpdateSpecificTagRequest: ContactsTagUpdateSpecificTagRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateSpecificTag', 'id', id)
            // verify required parameter 'contactsTagUpdateSpecificTagRequest' is not null or undefined
            assertParamExists('updateSpecificTag', 'contactsTagUpdateSpecificTagRequest', contactsTagUpdateSpecificTagRequest)
            const localVarPath = `/contacts/tags/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: contactsTagUpdateSpecificTagRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(contactsTagUpdateSpecificTagRequest, localVarRequestOptions, configuration)
...
/**
 * ContactsTagApi - functional programming interface
 * @export
 */
export const ContactsTagApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ContactsTagApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new Contact Tag to your Workspace
         * @summary Create Tag
         * @param {ContactsTagApiCreateNewTagRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewTag(requestParameters: ContactsTagApiCreateNewTagRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsTagAttributes>> {
            const contactsTagCreateNewTagRequest: ContactsTagCreateNewTagRequest = {
                contacts_tag: requestParameters.contacts_tag
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewTag(requestParameters.workspaceId, contactsTagCreateNewTagRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a single Contact Tag
         * @summary Fetch Tag
         * @param {ContactsTagApiGetSingleRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSingle(requestParameters: ContactsTagApiGetSingleRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsTagAttributes>> {
         ...
         * List all Contact Tags for your workspace
         * @summary List Tags
         * @param {ContactsTagApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: ContactsTagApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContactsTagAttributes>>> {
         ...
         * Delete a Contact Tag from your workspace
         * @summary Remove Tag
         * @param {ContactsTagApiRemoveRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async remove(requestParameters: ContactsTagApiRemoveRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * Update a Contact Tag
         * @summary Update Tag
         * @param {ContactsTagApiUpdateSpecificTagRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateSpecificTag(requestParameters: ContactsTagApiUpdateSpecificTagRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsTagAttributes>> {
            const contactsTagUpdateSpecificTagRequest: ContactsTagUpdateSpecificTagRequest = {
                contacts_tag: requestParameters.contacts_tag
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSpecificTag(requestParameters.id, contactsTagUpdateSpecificTagRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ContactsTagApi - factory interface
 * @export
 */
export const ContactsTagApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ContactsTagApiFp(configuration)
    return {
        /**
         * Add a new Contact Tag to your Workspace
         * @summary Create Tag
         ...
         * @throws {RequiredError}
         */
        createNewTag(requestParameters: ContactsTagApiCreateNewTagRequest, options?: AxiosRequestConfig): AxiosPromise<ContactsTagAttributes> {
         ...
         * @throws {RequiredError}
         */
        getSingle(requestParameters: ContactsTagApiGetSingleRequest, options?: AxiosRequestConfig): AxiosPromise<ContactsTagAttributes> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: ContactsTagApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ContactsTagAttributes>> {
         ...
         * @throws {RequiredError}
         */
        remove(requestParameters: ContactsTagApiRemoveRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateSpecificTag(requestParameters: ContactsTagApiUpdateSpecificTagRequest, options?: AxiosRequestConfig): AxiosPromise<ContactsTagAttributes> {
            return localVarFp.updateSpecificTag(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewTag operation in ContactsTagApi.
 * @export
 * @interface ContactsTagApiCreateNewTagRequest
 */
export type ContactsTagApiCreateNewTagRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ContactsTagApiCreateNewTag
    */
...
/**
 * Request parameters for getSingle operation in ContactsTagApi.
 * @export
 * @interface ContactsTagApiGetSingleRequest
 */
export type ContactsTagApiGetSingleRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactsTagApiGetSingle
    */
    readonly id: string
...
/**
 * Request parameters for list operation in ContactsTagApi.
 * @export
 * @interface ContactsTagApiListRequest
 */
export type ContactsTagApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ContactsTagApiList
    */
    readonly workspaceId: number
...
/**
 * Request parameters for remove operation in ContactsTagApi.
 * @export
 * @interface ContactsTagApiRemoveRequest
 */
export type ContactsTagApiRemoveRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactsTagApiRemove
    */
    readonly id: string
...
/**
 * Request parameters for updateSpecificTag operation in ContactsTagApi.
 * @export
 * @interface ContactsTagApiUpdateSpecificTagRequest
 */
export type ContactsTagApiUpdateSpecificTagRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactsTagApiUpdateSpecificTag
    */
    readonly id: string
...
/**
 * ContactsTagApiGenerated - object-oriented interface
 * @export
 * @class ContactsTagApiGenerated
 * @extends {BaseAPI}
 */
export class ContactsTagApiGenerated extends BaseAPI {
    /**
     * Add a new Contact Tag to your Workspace
     * @summary Create Tag
     * @param {ContactsTagApiCreateNewTagRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ContactsTagApiGenerated
     */
    public createNewTag(requestParameters: ContactsTagApiCreateNewTagRequest, options?: AxiosRequestConfig) {
        return ContactsTagApiFp(this.configuration).createNewTag(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactsTagApiGenerated
     */
    public getSingle(requestParameters: ContactsTagApiGetSingleRequest, options?: AxiosRequestConfig) {
        return ContactsTagApiFp(this.configuration).getSingle(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactsTagApiGenerated
     */
    public list(requestParameters: ContactsTagApiListRequest, options?: AxiosRequestConfig) {
        return ContactsTagApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactsTagApiGenerated
     */
    public remove(requestParameters: ContactsTagApiRemoveRequest, options?: AxiosRequestConfig) {
        return ContactsTagApiFp(this.configuration).remove(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactsTagApiGenerated
     */
    public updateSpecificTag(requestParameters: ContactsTagApiUpdateSpecificTagRequest, options?: AxiosRequestConfig) {
        return ContactsTagApiFp(this.configuration).updateSpecificTag(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
