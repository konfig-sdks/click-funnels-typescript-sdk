...
// @ts-ignore
import { OrderAttributes } from '../models';
// @ts-ignore
import { OrderGetSingle404Response } from '../models';
// @ts-ignore
import { OrderGetSingleResponse } from '../models';
// @ts-ignore
import { OrderListOrders401Response } from '../models';
// @ts-ignore
import { OrderListOrders404Response } from '../models';
// @ts-ignore
import { OrderListOrdersFilterParameter } from '../models';
// @ts-ignore
import { OrderUpdateSpecific401Response } from '../models';
// @ts-ignore
import { OrderUpdateSpecific404Response } from '../models';
// @ts-ignore
import { OrderUpdateSpecificRequest } from '../models';
// @ts-ignore
import { OrderUpdateSpecificResponse } from '../models';
    ...
    return {
        ...
        listOrders: async (workspaceId: number, after?: string, sortOrder?: 'asc' | 'desc', filter?: OrderListOrdersFilterParameter, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/orders',
                httpMethod: 'GET'
            });
         ...
         * @param {string} id 
         * @param {OrderUpdateSpecificRequest} orderUpdateSpecificRequest Information about updated fields in Order
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateSpecific: async (id: string, orderUpdateSpecificRequest: OrderUpdateSpecificRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateSpecific', 'id', id)
            // verify required parameter 'orderUpdateSpecificRequest' is not null or undefined
            assertParamExists('updateSpecific', 'orderUpdateSpecificRequest', orderUpdateSpecificRequest)
            const localVarPath = `/orders/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: orderUpdateSpecificRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(orderUpdateSpecificRequest, localVarRequestOptions, configuration)
...
export const OrderApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Retrieve a specific order in the current workspace
         * @summary Fetch Order
         * @param {OrderApiGetSingleRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSingle(requestParameters: OrderApiGetSingleRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderAttributes>> {
         ...
         * List all orders for the current workspace
         * @summary List Orders
         * @param {OrderApiListOrdersRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listOrders(requestParameters: OrderApiListOrdersRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrderAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listOrders(requestParameters.workspaceId, requestParameters.after, requestParameters.sortOrder, requestParameters.filter, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a specific order in the current workspace
         * @summary Update Order
         * @param {OrderApiUpdateSpecificRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateSpecific(requestParameters: OrderApiUpdateSpecificRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrderAttributes>> {
            const orderUpdateSpecificRequest: OrderUpdateSpecificRequest = {
                order: requestParameters.order
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSpecific(requestParameters.id, orderUpdateSpecificRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const OrderApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSingle(requestParameters: OrderApiGetSingleRequest, options?: AxiosRequestConfig): AxiosPromise<OrderAttributes> {
         ...
         * @throws {RequiredError}
         */
        listOrders(requestParameters: OrderApiListOrdersRequest, options?: AxiosRequestConfig): AxiosPromise<Array<OrderAttributes>> {
            return localVarFp.listOrders(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a specific order in the current workspace
         * @summary Update Order
         ...
         * @throws {RequiredError}
         */
        updateSpecific(requestParameters: OrderApiUpdateSpecificRequest, options?: AxiosRequestConfig): AxiosPromise<OrderAttributes> {
            return localVarFp.updateSpecific(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getSingle operation in OrderApi.
 * @export
 * @interface OrderApiGetSingleRequest
 */
export type OrderApiGetSingleRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OrderApiGetSingle
    */
    readonly id: string
...
/**
 * Request parameters for listOrders operation in OrderApi.
 * @export
 * @interface OrderApiListOrdersRequest
 */
export type OrderApiListOrdersRequest = {
    ...
    * @type {OrderListOrdersFilterParameter}
    * @memberof OrderApiListOrders
    */
    readonly filter?: OrderListOrdersFilterParameter
    
}

/**
 * Request parameters for updateSpecific operation in OrderApi.
 * @export
 * @interface OrderApiUpdateSpecificRequest
 */
export type OrderApiUpdateSpecificRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OrderApiUpdateSpecific
    */
    readonly id: string
...
export class OrderApiGenerated extends BaseAPI {
     ...
     */
    public getSingle(requestParameters: OrderApiGetSingleRequest, options?: AxiosRequestConfig) {
        return OrderApiFp(this.configuration).getSingle(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrderApiGenerated
     */
    public listOrders(requestParameters: OrderApiListOrdersRequest, options?: AxiosRequestConfig) {
        return OrderApiFp(this.configuration).listOrders(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrderApiGenerated
     */
    public updateSpecific(requestParameters: OrderApiUpdateSpecificRequest, options?: AxiosRequestConfig) {
        return OrderApiFp(this.configuration).updateSpecific(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
