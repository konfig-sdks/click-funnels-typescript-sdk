...
// @ts-ignore
import { ProductsTagAttributes } from '../models';
// @ts-ignore
import { ProductsTagCreateNewTag401Response } from '../models';
// @ts-ignore
import { ProductsTagCreateNewTagRequest } from '../models';
// @ts-ignore
import { ProductsTagCreateNewTagResponse } from '../models';
// @ts-ignore
import { ProductsTagDeleteTagById404Response } from '../models';
// @ts-ignore
import { ProductsTagDeleteTagByIdResponse } from '../models';
// @ts-ignore
import { ProductsTagGetTagById404Response } from '../models';
// @ts-ignore
import { ProductsTagGetTagByIdResponse } from '../models';
// @ts-ignore
import { ProductsTagList401Response } from '../models';
// @ts-ignore
import { ProductsTagList404Response } from '../models';
// @ts-ignore
import { ProductsTagUpdateTagById401Response } from '../models';
// @ts-ignore
import { ProductsTagUpdateTagById404Response } from '../models';
// @ts-ignore
import { ProductsTagUpdateTagByIdRequest } from '../models';
// @ts-ignore
import { ProductsTagUpdateTagByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ProductsTagApi - axios parameter creator
 * @export
 */
export const ProductsTagApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new tag to a product
         * @summary Create Tag
         * @param {number} workspaceId 
         * @param {ProductsTagCreateNewTagRequest} productsTagCreateNewTagRequest Information about a new Tag
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewTag: async (workspaceId: number, productsTagCreateNewTagRequest: ProductsTagCreateNewTagRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('createNewTag', 'workspaceId', workspaceId)
            // verify required parameter 'productsTagCreateNewTagRequest' is not null or undefined
            assertParamExists('createNewTag', 'productsTagCreateNewTagRequest', productsTagCreateNewTagRequest)
            const localVarPath = `/workspaces/{workspace_id}/products/tags`
            ...
            requestBeforeHook({
                requestBody: productsTagCreateNewTagRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/products/tags',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(productsTagCreateNewTagRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteTagById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('deleteTagById', 'id', id)
            const localVarPath = `/products/tags/{id}`
         ...
         * @summary Update Tag
         * @param {string} id 
         * @param {ProductsTagUpdateTagByIdRequest} productsTagUpdateTagByIdRequest Information about updated fields in Tag
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateTagById: async (id: string, productsTagUpdateTagByIdRequest: ProductsTagUpdateTagByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateTagById', 'id', id)
            // verify required parameter 'productsTagUpdateTagByIdRequest' is not null or undefined
            assertParamExists('updateTagById', 'productsTagUpdateTagByIdRequest', productsTagUpdateTagByIdRequest)
            const localVarPath = `/products/tags/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: productsTagUpdateTagByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(productsTagUpdateTagByIdRequest, localVarRequestOptions, configuration)
...
/**
 * ProductsTagApi - functional programming interface
 * @export
 */
export const ProductsTagApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProductsTagApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new tag to a product
         * @summary Create Tag
         * @param {ProductsTagApiCreateNewTagRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewTag(requestParameters: ProductsTagApiCreateNewTagRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductsTagAttributes>> {
            const productsTagCreateNewTagRequest: ProductsTagCreateNewTagRequest = {
                products_tag: requestParameters.products_tag
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewTag(requestParameters.workspaceId, productsTagCreateNewTagRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a tag for a product
         * @summary Remove Tag
         * @param {ProductsTagApiDeleteTagByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteTagById(requestParameters: ProductsTagApiDeleteTagByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteTagById(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a tag for a product
         * @summary Fetch Tag
         * @param {ProductsTagApiGetTagByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getTagById(requestParameters: ProductsTagApiGetTagByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductsTagAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTagById(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List tags for a product
         * @summary List Tags
         * @param {ProductsTagApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: ProductsTagApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProductsTagAttributes>>> {
         ...
         * Update a tag for a product
         * @summary Update Tag
         * @param {ProductsTagApiUpdateTagByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateTagById(requestParameters: ProductsTagApiUpdateTagByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductsTagAttributes>> {
            const productsTagUpdateTagByIdRequest: ProductsTagUpdateTagByIdRequest = {
                products_tag: requestParameters.products_tag
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateTagById(requestParameters.id, productsTagUpdateTagByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ProductsTagApi - factory interface
 * @export
 */
export const ProductsTagApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProductsTagApiFp(configuration)
    return {
        /**
         * Add a new tag to a product
         * @summary Create Tag
         ...
         * @throws {RequiredError}
         */
        createNewTag(requestParameters: ProductsTagApiCreateNewTagRequest, options?: AxiosRequestConfig): AxiosPromise<ProductsTagAttributes> {
         ...
         * @throws {RequiredError}
         */
        deleteTagById(requestParameters: ProductsTagApiDeleteTagByIdRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteTagById(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a tag for a product
         * @summary Fetch Tag
         ...
         * @throws {RequiredError}
         */
        getTagById(requestParameters: ProductsTagApiGetTagByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ProductsTagAttributes> {
            return localVarFp.getTagById(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List tags for a product
         * @summary List Tags
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: ProductsTagApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ProductsTagAttributes>> {
         ...
         * @throws {RequiredError}
         */
        updateTagById(requestParameters: ProductsTagApiUpdateTagByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ProductsTagAttributes> {
            return localVarFp.updateTagById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewTag operation in ProductsTagApi.
 * @export
 * @interface ProductsTagApiCreateNewTagRequest
 */
export type ProductsTagApiCreateNewTagRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ProductsTagApiCreateNewTag
    */
...
/**
 * Request parameters for deleteTagById operation in ProductsTagApi.
 * @export
 * @interface ProductsTagApiDeleteTagByIdRequest
 */
export type ProductsTagApiDeleteTagByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ProductsTagApiDeleteTagById
    */
    readonly id: string
...
/**
 * Request parameters for getTagById operation in ProductsTagApi.
 * @export
 * @interface ProductsTagApiGetTagByIdRequest
 */
export type ProductsTagApiGetTagByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ProductsTagApiGetTagById
    */
    readonly id: string
...
/**
 * Request parameters for list operation in ProductsTagApi.
 * @export
 * @interface ProductsTagApiListRequest
 */
export type ProductsTagApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ProductsTagApiList
    */
    readonly workspaceId: number
...
/**
 * Request parameters for updateTagById operation in ProductsTagApi.
 * @export
 * @interface ProductsTagApiUpdateTagByIdRequest
 */
export type ProductsTagApiUpdateTagByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ProductsTagApiUpdateTagById
    */
    readonly id: string
...
/**
 * ProductsTagApiGenerated - object-oriented interface
 * @export
 * @class ProductsTagApiGenerated
 * @extends {BaseAPI}
 */
export class ProductsTagApiGenerated extends BaseAPI {
    /**
     * Add a new tag to a product
     * @summary Create Tag
     * @param {ProductsTagApiCreateNewTagRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProductsTagApiGenerated
     */
    public createNewTag(requestParameters: ProductsTagApiCreateNewTagRequest, options?: AxiosRequestConfig) {
        return ProductsTagApiFp(this.configuration).createNewTag(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsTagApiGenerated
     */
    public deleteTagById(requestParameters: ProductsTagApiDeleteTagByIdRequest, options?: AxiosRequestConfig) {
        return ProductsTagApiFp(this.configuration).deleteTagById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsTagApiGenerated
     */
    public getTagById(requestParameters: ProductsTagApiGetTagByIdRequest, options?: AxiosRequestConfig) {
        return ProductsTagApiFp(this.configuration).getTagById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsTagApiGenerated
     */
    public list(requestParameters: ProductsTagApiListRequest, options?: AxiosRequestConfig) {
        return ProductsTagApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsTagApiGenerated
     */
    public updateTagById(requestParameters: ProductsTagApiUpdateTagByIdRequest, options?: AxiosRequestConfig) {
        return ProductsTagApiFp(this.configuration).updateTagById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
