...
// @ts-ignore
import { OrdersInvoicesRestockGetRestock401Response } from '../models';
// @ts-ignore
import { OrdersInvoicesRestockGetRestock404Response } from '../models';
// @ts-ignore
import { OrdersInvoicesRestockGetRestockResponse } from '../models';
// @ts-ignore
import { OrdersInvoicesRestockListRestocks401Response } from '../models';
// @ts-ignore
import { OrdersInvoicesRestockListRestocks404Response } from '../models';
// @ts-ignore
import { Restocks } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * OrdersInvoicesRestockApi - axios parameter creator
 * @export
 */
export const OrdersInvoicesRestockApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Fetch Restock
         ...
         */
        getRestock: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getRestock', 'id', id)
            const localVarPath = `/orders/invoices/restocks/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/orders/invoices/restocks/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listRestocks: async (workspaceId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('listRestocks', 'workspaceId', workspaceId)
            const localVarPath = `/workspaces/{workspace_id}/orders/invoices/restocks`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/orders/invoices/restocks',
                httpMethod: 'GET'
            });
...
/**
 * OrdersInvoicesRestockApi - functional programming interface
 * @export
 */
export const OrdersInvoicesRestockApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = OrdersInvoicesRestockApiAxiosParamCreator(configuration)
    return {
        /**
         * Fetch Restock
         * @summary Fetch Restock
         * @param {OrdersInvoicesRestockApiGetRestockRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getRestock(requestParameters: OrdersInvoicesRestockApiGetRestockRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrdersInvoicesRestockGetRestockResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRestock(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List Restocks
         * @summary List Restocks
         * @param {OrdersInvoicesRestockApiListRestocksRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listRestocks(requestParameters: OrdersInvoicesRestockApiListRestocksRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Restocks>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listRestocks(requestParameters.workspaceId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * OrdersInvoicesRestockApi - factory interface
 * @export
 */
export const OrdersInvoicesRestockApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = OrdersInvoicesRestockApiFp(configuration)
    return {
        /**
         * Fetch Restock
         * @summary Fetch Restock
         ...
         * @throws {RequiredError}
         */
        getRestock(requestParameters: OrdersInvoicesRestockApiGetRestockRequest, options?: AxiosRequestConfig): AxiosPromise<OrdersInvoicesRestockGetRestockResponse> {
            return localVarFp.getRestock(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List Restocks
         * @summary List Restocks
         ...
         * @throws {RequiredError}
         */
        listRestocks(requestParameters: OrdersInvoicesRestockApiListRestocksRequest, options?: AxiosRequestConfig): AxiosPromise<Array<Restocks>> {
            return localVarFp.listRestocks(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getRestock operation in OrdersInvoicesRestockApi.
 * @export
 * @interface OrdersInvoicesRestockApiGetRestockRequest
 */
export type OrdersInvoicesRestockApiGetRestockRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OrdersInvoicesRestockApiGetRestock
    */
    readonly id: string
...
/**
 * Request parameters for listRestocks operation in OrdersInvoicesRestockApi.
 * @export
 * @interface OrdersInvoicesRestockApiListRestocksRequest
 */
export type OrdersInvoicesRestockApiListRestocksRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof OrdersInvoicesRestockApiListRestocks
    */
...
/**
 * OrdersInvoicesRestockApiGenerated - object-oriented interface
 * @export
 * @class OrdersInvoicesRestockApiGenerated
 * @extends {BaseAPI}
 */
export class OrdersInvoicesRestockApiGenerated extends BaseAPI {
    /**
     * Fetch Restock
     * @summary Fetch Restock
     * @param {OrdersInvoicesRestockApiGetRestockRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof OrdersInvoicesRestockApiGenerated
     */
    public getRestock(requestParameters: OrdersInvoicesRestockApiGetRestockRequest, options?: AxiosRequestConfig) {
        return OrdersInvoicesRestockApiFp(this.configuration).getRestock(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrdersInvoicesRestockApiGenerated
     */
    public listRestocks(requestParameters: OrdersInvoicesRestockApiListRestocksRequest, options?: AxiosRequestConfig) {
        return OrdersInvoicesRestockApiFp(this.configuration).listRestocks(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
