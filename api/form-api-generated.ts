...
// @ts-ignore
import { FormAttributes } from '../models';
// @ts-ignore
import { FormCreateNewForm401Response } from '../models';
// @ts-ignore
import { FormCreateNewFormRequest } from '../models';
// @ts-ignore
import { FormCreateNewFormResponse } from '../models';
// @ts-ignore
import { FormGetForm404Response } from '../models';
// @ts-ignore
import { FormGetFormResponse } from '../models';
// @ts-ignore
import { FormListWorkspaceForms401Response } from '../models';
// @ts-ignore
import { FormListWorkspaceForms404Response } from '../models';
// @ts-ignore
import { FormRemove404Response } from '../models';
// @ts-ignore
import { FormRemoveResponse } from '../models';
// @ts-ignore
import { FormUpdateFormById401Response } from '../models';
// @ts-ignore
import { FormUpdateFormById404Response } from '../models';
// @ts-ignore
import { FormUpdateFormByIdRequest } from '../models';
// @ts-ignore
import { FormUpdateFormByIdResponse } from '../models';
...
export const FormApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {FormCreateNewFormRequest} formCreateNewFormRequest Information about a new Form
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewForm: async (workspaceId: number, formCreateNewFormRequest: FormCreateNewFormRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('createNewForm', 'workspaceId', workspaceId)
            // verify required parameter 'formCreateNewFormRequest' is not null or undefined
            assertParamExists('createNewForm', 'formCreateNewFormRequest', formCreateNewFormRequest)
            const localVarPath = `/workspaces/{workspace_id}/forms`
            ...
            requestBeforeHook({
                requestBody: formCreateNewFormRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/forms',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(formCreateNewFormRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        listWorkspaceForms: async (workspaceId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('listWorkspaceForms', 'workspaceId', workspaceId)
            const localVarPath = `/workspaces/{workspace_id}/forms`
                .replace(`{${"workspace_id"}}`, encodeURIComponent(String(workspaceId !== undefined ? workspaceId : `-workspace_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @summary Update Form
         * @param {string} id 
         * @param {FormUpdateFormByIdRequest} formUpdateFormByIdRequest Information about updated fields in Form
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateFormById: async (id: string, formUpdateFormByIdRequest: FormUpdateFormByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateFormById', 'id', id)
            // verify required parameter 'formUpdateFormByIdRequest' is not null or undefined
            assertParamExists('updateFormById', 'formUpdateFormByIdRequest', formUpdateFormByIdRequest)
            const localVarPath = `/forms/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: formUpdateFormByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(formUpdateFormByIdRequest, localVarRequestOptions, configuration)
...
export const FormApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Add a new form
         * @summary Create Form
         * @param {FormApiCreateNewFormRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewForm(requestParameters: FormApiCreateNewFormRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormAttributes>> {
            const formCreateNewFormRequest: FormCreateNewFormRequest = {
                form: requestParameters.form
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewForm(requestParameters.workspaceId, formCreateNewFormRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a form
         * @summary Fetch Form
         * @param {FormApiGetFormRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getForm(requestParameters: FormApiGetFormRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getForm(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List forms for a workspace
         * @summary List Forms
         * @param {FormApiListWorkspaceFormsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listWorkspaceForms(requestParameters: FormApiListWorkspaceFormsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FormAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listWorkspaceForms(requestParameters.workspaceId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a form
         * @summary Remove Form
         * @param {FormApiRemoveRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async remove(requestParameters: FormApiRemoveRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * Update a form
         * @summary Update Form
         * @param {FormApiUpdateFormByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateFormById(requestParameters: FormApiUpdateFormByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormAttributes>> {
            const formUpdateFormByIdRequest: FormUpdateFormByIdRequest = {
                form: requestParameters.form
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateFormById(requestParameters.id, formUpdateFormByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const FormApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createNewForm(requestParameters: FormApiCreateNewFormRequest, options?: AxiosRequestConfig): AxiosPromise<FormAttributes> {
            return localVarFp.createNewForm(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a form
         * @summary Fetch Form
         ...
         * @throws {RequiredError}
         */
        getForm(requestParameters: FormApiGetFormRequest, options?: AxiosRequestConfig): AxiosPromise<FormAttributes> {
            return localVarFp.getForm(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List forms for a workspace
         * @summary List Forms
         ...
         * @throws {RequiredError}
         */
        listWorkspaceForms(requestParameters: FormApiListWorkspaceFormsRequest, options?: AxiosRequestConfig): AxiosPromise<Array<FormAttributes>> {
            return localVarFp.listWorkspaceForms(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a form
         * @summary Remove Form
         ...
         * @throws {RequiredError}
         */
        remove(requestParameters: FormApiRemoveRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateFormById(requestParameters: FormApiUpdateFormByIdRequest, options?: AxiosRequestConfig): AxiosPromise<FormAttributes> {
            return localVarFp.updateFormById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewForm operation in FormApi.
 * @export
 * @interface FormApiCreateNewFormRequest
 */
export type FormApiCreateNewFormRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormApiCreateNewForm
    */
...
/**
 * Request parameters for getForm operation in FormApi.
 * @export
 * @interface FormApiGetFormRequest
 */
export type FormApiGetFormRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormApiGetForm
    */
    readonly id: string
...
/**
 * Request parameters for listWorkspaceForms operation in FormApi.
 * @export
 * @interface FormApiListWorkspaceFormsRequest
 */
export type FormApiListWorkspaceFormsRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormApiListWorkspaceForms
    */
    readonly workspaceId: number
...
/**
 * Request parameters for remove operation in FormApi.
 * @export
 * @interface FormApiRemoveRequest
 */
export type FormApiRemoveRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormApiRemove
    */
    readonly id: string
...
/**
 * Request parameters for updateFormById operation in FormApi.
 * @export
 * @interface FormApiUpdateFormByIdRequest
 */
export type FormApiUpdateFormByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormApiUpdateFormById
    */
    readonly id: string
...
/**
 * FormApiGenerated - object-oriented interface
 * @export
 * @class FormApiGenerated
 * @extends {BaseAPI}
 */
export class FormApiGenerated extends BaseAPI {
    /**
     * Add a new form
     * @summary Create Form
     * @param {FormApiCreateNewFormRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FormApiGenerated
     */
    public createNewForm(requestParameters: FormApiCreateNewFormRequest, options?: AxiosRequestConfig) {
        return FormApiFp(this.configuration).createNewForm(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormApiGenerated
     */
    public getForm(requestParameters: FormApiGetFormRequest, options?: AxiosRequestConfig) {
        return FormApiFp(this.configuration).getForm(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormApiGenerated
     */
    public listWorkspaceForms(requestParameters: FormApiListWorkspaceFormsRequest, options?: AxiosRequestConfig) {
        return FormApiFp(this.configuration).listWorkspaceForms(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormApiGenerated
     */
    public remove(requestParameters: FormApiRemoveRequest, options?: AxiosRequestConfig) {
        return FormApiFp(this.configuration).remove(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormApiGenerated
     */
    public updateFormById(requestParameters: FormApiUpdateFormByIdRequest, options?: AxiosRequestConfig) {
        return FormApiFp(this.configuration).updateFormById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
