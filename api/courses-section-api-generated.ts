...
// @ts-ignore
import { CoursesSectionAttributes } from '../models';
// @ts-ignore
import { CoursesSectionGetSection404Response } from '../models';
// @ts-ignore
import { CoursesSectionGetSectionResponse } from '../models';
// @ts-ignore
import { CoursesSectionListSections401Response } from '../models';
// @ts-ignore
import { CoursesSectionListSections404Response } from '../models';
// @ts-ignore
import { CoursesSectionUpdateSectionById401Response } from '../models';
// @ts-ignore
import { CoursesSectionUpdateSectionById404Response } from '../models';
// @ts-ignore
import { CoursesSectionUpdateSectionByIdRequest } from '../models';
// @ts-ignore
import { CoursesSectionUpdateSectionByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * CoursesSectionApi - axios parameter creator
 * @export
 */
export const CoursesSectionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Fetch Section
        ...
        getSection: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/courses/sections/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/courses/sections/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listSections: async (courseId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'courseId' is not null or undefined
            assertParamExists('listSections', 'courseId', courseId)
            const localVarPath = `/courses/{course_id}/sections`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/courses/{course_id}/sections',
                httpMethod: 'GET'
            });
         ...
         * @param {string} id 
         * @param {CoursesSectionUpdateSectionByIdRequest} coursesSectionUpdateSectionByIdRequest Information about updated fields in Section
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateSectionById: async (id: string, coursesSectionUpdateSectionByIdRequest: CoursesSectionUpdateSectionByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateSectionById', 'id', id)
            // verify required parameter 'coursesSectionUpdateSectionByIdRequest' is not null or undefined
            assertParamExists('updateSectionById', 'coursesSectionUpdateSectionByIdRequest', coursesSectionUpdateSectionByIdRequest)
            const localVarPath = `/courses/sections/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: coursesSectionUpdateSectionByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(coursesSectionUpdateSectionByIdRequest, localVarRequestOptions, configuration)
...
/**
 * CoursesSectionApi - functional programming interface
 * @export
 */
export const CoursesSectionApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CoursesSectionApiAxiosParamCreator(configuration)
    return {
        /**
         * Fetch Section
         * @summary Fetch Section
         * @param {CoursesSectionApiGetSectionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSection(requestParameters: CoursesSectionApiGetSectionRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursesSectionAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSection(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List Sections
         * @summary List Sections
         * @param {CoursesSectionApiListSectionsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listSections(requestParameters: CoursesSectionApiListSectionsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CoursesSectionAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listSections(requestParameters.courseId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update Section
         * @summary Update Section
         * @param {CoursesSectionApiUpdateSectionByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateSectionById(requestParameters: CoursesSectionApiUpdateSectionByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursesSectionAttributes>> {
            const coursesSectionUpdateSectionByIdRequest: CoursesSectionUpdateSectionByIdRequest = {
                courses_section: requestParameters.courses_section
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSectionById(requestParameters.id, coursesSectionUpdateSectionByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * CoursesSectionApi - factory interface
 * @export
 */
export const CoursesSectionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CoursesSectionApiFp(configuration)
    return {
        /**
         * Fetch Section
         * @summary Fetch Section
         ...
         * @throws {RequiredError}
         */
        getSection(requestParameters: CoursesSectionApiGetSectionRequest, options?: AxiosRequestConfig): AxiosPromise<CoursesSectionAttributes> {
            return localVarFp.getSection(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List Sections
         * @summary List Sections
         ...
         * @throws {RequiredError}
         */
        listSections(requestParameters: CoursesSectionApiListSectionsRequest, options?: AxiosRequestConfig): AxiosPromise<Array<CoursesSectionAttributes>> {
         ...
         * @throws {RequiredError}
         */
        updateSectionById(requestParameters: CoursesSectionApiUpdateSectionByIdRequest, options?: AxiosRequestConfig): AxiosPromise<CoursesSectionAttributes> {
            return localVarFp.updateSectionById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getSection operation in CoursesSectionApi.
 * @export
 * @interface CoursesSectionApiGetSectionRequest
 */
export type CoursesSectionApiGetSectionRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof CoursesSectionApiGetSection
    */
    readonly id: string
...
/**
 * Request parameters for listSections operation in CoursesSectionApi.
 * @export
 * @interface CoursesSectionApiListSectionsRequest
 */
export type CoursesSectionApiListSectionsRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof CoursesSectionApiListSections
    */
...
/**
 * Request parameters for updateSectionById operation in CoursesSectionApi.
 * @export
 * @interface CoursesSectionApiUpdateSectionByIdRequest
 */
export type CoursesSectionApiUpdateSectionByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof CoursesSectionApiUpdateSectionById
    */
    readonly id: string
...
/**
 * CoursesSectionApiGenerated - object-oriented interface
 * @export
 * @class CoursesSectionApiGenerated
 * @extends {BaseAPI}
 */
export class CoursesSectionApiGenerated extends BaseAPI {
    /**
     * Fetch Section
     * @summary Fetch Section
     * @param {CoursesSectionApiGetSectionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CoursesSectionApiGenerated
     */
    public getSection(requestParameters: CoursesSectionApiGetSectionRequest, options?: AxiosRequestConfig) {
        return CoursesSectionApiFp(this.configuration).getSection(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CoursesSectionApiGenerated
     */
    public listSections(requestParameters: CoursesSectionApiListSectionsRequest, options?: AxiosRequestConfig) {
        return CoursesSectionApiFp(this.configuration).listSections(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CoursesSectionApiGenerated
     */
    public updateSectionById(requestParameters: CoursesSectionApiUpdateSectionByIdRequest, options?: AxiosRequestConfig) {
        return CoursesSectionApiFp(this.configuration).updateSectionById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
