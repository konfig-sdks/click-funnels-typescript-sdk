...
// @ts-ignore
import { OrdersTransactionAttributes } from '../models';
// @ts-ignore
import { OrdersTransactionGetById404Response } from '../models';
// @ts-ignore
import { OrdersTransactionGetByIdResponse } from '../models';
// @ts-ignore
import { OrdersTransactionGetList401Response } from '../models';
// @ts-ignore
import { OrdersTransactionGetList404Response } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * OrdersTransactionApi - axios parameter creator
 * @export
 */
export const OrdersTransactionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        getById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/orders/transactions/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/orders/transactions/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        getList: async (orderId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orderId' is not null or undefined
            assertParamExists('getList', 'orderId', orderId)
            const localVarPath = `/orders/{order_id}/transactions`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/orders/{order_id}/transactions',
                httpMethod: 'GET'
            });
...
/**
 * OrdersTransactionApi - functional programming interface
 * @export
 */
export const OrdersTransactionApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = OrdersTransactionApiAxiosParamCreator(configuration)
    return {
        /**
         * Retrieve a transaction for an order
         * @summary Fetch Transaction
         * @param {OrdersTransactionApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: OrdersTransactionApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrdersTransactionAttributes>> {
         ...
         * List transactions for an order
         * @summary List Transactions
         * @param {OrdersTransactionApiGetListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getList(requestParameters: OrdersTransactionApiGetListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrdersTransactionAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getList(requestParameters.orderId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * OrdersTransactionApi - factory interface
 * @export
 */
export const OrdersTransactionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = OrdersTransactionApiFp(configuration)
    return {
        /**
         * Retrieve a transaction for an order
         * @summary Fetch Transaction
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: OrdersTransactionApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<OrdersTransactionAttributes> {
         ...
         * @throws {RequiredError}
         */
        getList(requestParameters: OrdersTransactionApiGetListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<OrdersTransactionAttributes>> {
...
/**
 * Request parameters for getById operation in OrdersTransactionApi.
 * @export
 * @interface OrdersTransactionApiGetByIdRequest
 */
export type OrdersTransactionApiGetByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OrdersTransactionApiGetById
    */
    readonly id: string
...
/**
 * Request parameters for getList operation in OrdersTransactionApi.
 * @export
 * @interface OrdersTransactionApiGetListRequest
 */
export type OrdersTransactionApiGetListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof OrdersTransactionApiGetList
    */
...
/**
 * OrdersTransactionApiGenerated - object-oriented interface
 * @export
 * @class OrdersTransactionApiGenerated
 * @extends {BaseAPI}
 */
export class OrdersTransactionApiGenerated extends BaseAPI {
    /**
     * Retrieve a transaction for an order
     * @summary Fetch Transaction
     * @param {OrdersTransactionApiGetByIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof OrdersTransactionApiGenerated
     */
    public getById(requestParameters: OrdersTransactionApiGetByIdRequest, options?: AxiosRequestConfig) {
        return OrdersTransactionApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrdersTransactionApiGenerated
     */
    public getList(requestParameters: OrdersTransactionApiGetListRequest, options?: AxiosRequestConfig) {
        return OrdersTransactionApiFp(this.configuration).getList(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
