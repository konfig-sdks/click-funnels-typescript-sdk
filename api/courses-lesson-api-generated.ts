...
// @ts-ignore
import { CoursesLessonAttributes } from '../models';
// @ts-ignore
import { CoursesLessonGetById404Response } from '../models';
// @ts-ignore
import { CoursesLessonGetByIdResponse } from '../models';
// @ts-ignore
import { CoursesLessonListLessons401Response } from '../models';
// @ts-ignore
import { CoursesLessonListLessons404Response } from '../models';
// @ts-ignore
import { CoursesLessonUpdateLessonById401Response } from '../models';
// @ts-ignore
import { CoursesLessonUpdateLessonById404Response } from '../models';
// @ts-ignore
import { CoursesLessonUpdateLessonByIdRequest } from '../models';
// @ts-ignore
import { CoursesLessonUpdateLessonByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * CoursesLessonApi - axios parameter creator
 * @export
 */
export const CoursesLessonApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Fetch Lesson
        ...
        getById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/courses/lessons/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/courses/lessons/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listLessons: async (sectionId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sectionId' is not null or undefined
            assertParamExists('listLessons', 'sectionId', sectionId)
            const localVarPath = `/courses/sections/{section_id}/lessons`
                .replace(`{${"section_id"}}`, encodeURIComponent(String(sectionId !== undefined ? sectionId : `-section_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/courses/sections/{section_id}/lessons',
                httpMethod: 'GET'
            });
         ...
         * @param {string} id 
         * @param {CoursesLessonUpdateLessonByIdRequest} coursesLessonUpdateLessonByIdRequest Information about updated fields in Lesson
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateLessonById: async (id: string, coursesLessonUpdateLessonByIdRequest: CoursesLessonUpdateLessonByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateLessonById', 'id', id)
            // verify required parameter 'coursesLessonUpdateLessonByIdRequest' is not null or undefined
            assertParamExists('updateLessonById', 'coursesLessonUpdateLessonByIdRequest', coursesLessonUpdateLessonByIdRequest)
            const localVarPath = `/courses/lessons/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: coursesLessonUpdateLessonByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(coursesLessonUpdateLessonByIdRequest, localVarRequestOptions, configuration)
...
/**
 * CoursesLessonApi - functional programming interface
 * @export
 */
export const CoursesLessonApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CoursesLessonApiAxiosParamCreator(configuration)
    return {
        /**
         * Fetch Lesson
         * @summary Fetch Lesson
         * @param {CoursesLessonApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: CoursesLessonApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursesLessonAttributes>> {
         ...
         * List Lessons
         * @summary List Lessons
         * @param {CoursesLessonApiListLessonsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listLessons(requestParameters: CoursesLessonApiListLessonsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CoursesLessonAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listLessons(requestParameters.sectionId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update Lesson
         * @summary Update Lesson
         * @param {CoursesLessonApiUpdateLessonByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateLessonById(requestParameters: CoursesLessonApiUpdateLessonByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursesLessonAttributes>> {
            const coursesLessonUpdateLessonByIdRequest: CoursesLessonUpdateLessonByIdRequest = {
                courses_lesson: requestParameters.courses_lesson
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateLessonById(requestParameters.id, coursesLessonUpdateLessonByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * CoursesLessonApi - factory interface
 * @export
 */
export const CoursesLessonApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CoursesLessonApiFp(configuration)
    return {
        /**
         * Fetch Lesson
         * @summary Fetch Lesson
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: CoursesLessonApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<CoursesLessonAttributes> {
         ...
         * @throws {RequiredError}
         */
        listLessons(requestParameters: CoursesLessonApiListLessonsRequest, options?: AxiosRequestConfig): AxiosPromise<Array<CoursesLessonAttributes>> {
            return localVarFp.listLessons(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update Lesson
         * @summary Update Lesson
         ...
         * @throws {RequiredError}
         */
        updateLessonById(requestParameters: CoursesLessonApiUpdateLessonByIdRequest, options?: AxiosRequestConfig): AxiosPromise<CoursesLessonAttributes> {
            return localVarFp.updateLessonById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getById operation in CoursesLessonApi.
 * @export
 * @interface CoursesLessonApiGetByIdRequest
 */
export type CoursesLessonApiGetByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof CoursesLessonApiGetById
    */
    readonly id: string
...
/**
 * Request parameters for listLessons operation in CoursesLessonApi.
 * @export
 * @interface CoursesLessonApiListLessonsRequest
 */
export type CoursesLessonApiListLessonsRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof CoursesLessonApiListLessons
    */
...
/**
 * Request parameters for updateLessonById operation in CoursesLessonApi.
 * @export
 * @interface CoursesLessonApiUpdateLessonByIdRequest
 */
export type CoursesLessonApiUpdateLessonByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof CoursesLessonApiUpdateLessonById
    */
    readonly id: string
...
/**
 * CoursesLessonApiGenerated - object-oriented interface
 * @export
 * @class CoursesLessonApiGenerated
 * @extends {BaseAPI}
 */
export class CoursesLessonApiGenerated extends BaseAPI {
    /**
     * Fetch Lesson
     * @summary Fetch Lesson
     * @param {CoursesLessonApiGetByIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CoursesLessonApiGenerated
     */
    public getById(requestParameters: CoursesLessonApiGetByIdRequest, options?: AxiosRequestConfig) {
        return CoursesLessonApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CoursesLessonApiGenerated
     */
    public listLessons(requestParameters: CoursesLessonApiListLessonsRequest, options?: AxiosRequestConfig) {
        return CoursesLessonApiFp(this.configuration).listLessons(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CoursesLessonApiGenerated
     */
    public updateLessonById(requestParameters: CoursesLessonApiUpdateLessonByIdRequest, options?: AxiosRequestConfig) {
        return CoursesLessonApiFp(this.configuration).updateLessonById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
