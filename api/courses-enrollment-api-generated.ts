...
// @ts-ignore
import { CoursesEnrollmentAttributes } from '../models';
// @ts-ignore
import { CoursesEnrollmentCreateNewEnrollment401Response } from '../models';
// @ts-ignore
import { CoursesEnrollmentCreateNewEnrollmentRequest } from '../models';
// @ts-ignore
import { CoursesEnrollmentCreateNewEnrollmentResponse } from '../models';
// @ts-ignore
import { CoursesEnrollmentGetById404Response } from '../models';
// @ts-ignore
import { CoursesEnrollmentGetByIdResponse } from '../models';
// @ts-ignore
import { CoursesEnrollmentList401Response } from '../models';
// @ts-ignore
import { CoursesEnrollmentList404Response } from '../models';
// @ts-ignore
import { CoursesEnrollmentUpdateSpecificEnrollment401Response } from '../models';
// @ts-ignore
import { CoursesEnrollmentUpdateSpecificEnrollment404Response } from '../models';
// @ts-ignore
import { CoursesEnrollmentUpdateSpecificEnrollmentRequest } from '../models';
// @ts-ignore
import { CoursesEnrollmentUpdateSpecificEnrollmentResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * CoursesEnrollmentApi - axios parameter creator
 * @export
 */
export const CoursesEnrollmentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new enrollment
         * @summary Create Enrollment
         * @param {number} courseId 
         * @param {CoursesEnrollmentCreateNewEnrollmentRequest} coursesEnrollmentCreateNewEnrollmentRequest Information about a new Enrollment
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewEnrollment: async (courseId: number, coursesEnrollmentCreateNewEnrollmentRequest: CoursesEnrollmentCreateNewEnrollmentRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'courseId' is not null or undefined
            assertParamExists('createNewEnrollment', 'courseId', courseId)
            // verify required parameter 'coursesEnrollmentCreateNewEnrollmentRequest' is not null or undefined
            assertParamExists('createNewEnrollment', 'coursesEnrollmentCreateNewEnrollmentRequest', coursesEnrollmentCreateNewEnrollmentRequest)
            const localVarPath = `/courses/{course_id}/enrollments`
                .replace(`{${"course_id"}}`, encodeURIComponent(String(courseId !== undefined ? courseId : `-course_id-`)));
            ...
            requestBeforeHook({
                requestBody: coursesEnrollmentCreateNewEnrollmentRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/courses/{course_id}/enrollments',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(coursesEnrollmentCreateNewEnrollmentRequest, localVarRequestOptions, configuration)
        ...
        getById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/courses/enrollments/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/courses/enrollments/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        list: async (courseId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'courseId' is not null or undefined
         ...
         * @param {string} id 
         * @param {CoursesEnrollmentUpdateSpecificEnrollmentRequest} coursesEnrollmentUpdateSpecificEnrollmentRequest Information about updated fields in Enrollment
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateSpecificEnrollment: async (id: string, coursesEnrollmentUpdateSpecificEnrollmentRequest: CoursesEnrollmentUpdateSpecificEnrollmentRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateSpecificEnrollment', 'id', id)
            // verify required parameter 'coursesEnrollmentUpdateSpecificEnrollmentRequest' is not null or undefined
            assertParamExists('updateSpecificEnrollment', 'coursesEnrollmentUpdateSpecificEnrollmentRequest', coursesEnrollmentUpdateSpecificEnrollmentRequest)
            const localVarPath = `/courses/enrollments/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: coursesEnrollmentUpdateSpecificEnrollmentRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(coursesEnrollmentUpdateSpecificEnrollmentRequest, localVarRequestOptions, configuration)
...
/**
 * CoursesEnrollmentApi - functional programming interface
 * @export
 */
export const CoursesEnrollmentApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CoursesEnrollmentApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new enrollment
         * @summary Create Enrollment
         * @param {CoursesEnrollmentApiCreateNewEnrollmentRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewEnrollment(requestParameters: CoursesEnrollmentApiCreateNewEnrollmentRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursesEnrollmentAttributes>> {
            const coursesEnrollmentCreateNewEnrollmentRequest: CoursesEnrollmentCreateNewEnrollmentRequest = {
                courses_enrollment: requestParameters.courses_enrollment
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewEnrollment(requestParameters.courseId, coursesEnrollmentCreateNewEnrollmentRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve an enrollment
         * @summary Fetch Enrollment
         * @param {CoursesEnrollmentApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: CoursesEnrollmentApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursesEnrollmentAttributes>> {
         ...
         * List enrollments for a course
         * @summary List Enrollments
         * @param {CoursesEnrollmentApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: CoursesEnrollmentApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CoursesEnrollmentAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.courseId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update an enrollment
         * @summary Update Enrollment
         * @param {CoursesEnrollmentApiUpdateSpecificEnrollmentRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateSpecificEnrollment(requestParameters: CoursesEnrollmentApiUpdateSpecificEnrollmentRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoursesEnrollmentAttributes>> {
            const coursesEnrollmentUpdateSpecificEnrollmentRequest: CoursesEnrollmentUpdateSpecificEnrollmentRequest = {
                courses_enrollment: requestParameters.courses_enrollment
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSpecificEnrollment(requestParameters.id, coursesEnrollmentUpdateSpecificEnrollmentRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * CoursesEnrollmentApi - factory interface
 * @export
 */
export const CoursesEnrollmentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CoursesEnrollmentApiFp(configuration)
    return {
        /**
         * Add a new enrollment
         * @summary Create Enrollment
         ...
         * @throws {RequiredError}
         */
        createNewEnrollment(requestParameters: CoursesEnrollmentApiCreateNewEnrollmentRequest, options?: AxiosRequestConfig): AxiosPromise<CoursesEnrollmentAttributes> {
            return localVarFp.createNewEnrollment(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve an enrollment
         * @summary Fetch Enrollment
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: CoursesEnrollmentApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<CoursesEnrollmentAttributes> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: CoursesEnrollmentApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<CoursesEnrollmentAttributes>> {
         ...
         * @throws {RequiredError}
         */
        updateSpecificEnrollment(requestParameters: CoursesEnrollmentApiUpdateSpecificEnrollmentRequest, options?: AxiosRequestConfig): AxiosPromise<CoursesEnrollmentAttributes> {
            return localVarFp.updateSpecificEnrollment(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewEnrollment operation in CoursesEnrollmentApi.
 * @export
 * @interface CoursesEnrollmentApiCreateNewEnrollmentRequest
 */
export type CoursesEnrollmentApiCreateNewEnrollmentRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof CoursesEnrollmentApiCreateNewEnrollment
    */
...
/**
 * Request parameters for getById operation in CoursesEnrollmentApi.
 * @export
 * @interface CoursesEnrollmentApiGetByIdRequest
 */
export type CoursesEnrollmentApiGetByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof CoursesEnrollmentApiGetById
    */
    readonly id: string
...
/**
 * Request parameters for list operation in CoursesEnrollmentApi.
 * @export
 * @interface CoursesEnrollmentApiListRequest
 */
export type CoursesEnrollmentApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof CoursesEnrollmentApiList
    */
    readonly courseId: number
...
/**
 * Request parameters for updateSpecificEnrollment operation in CoursesEnrollmentApi.
 * @export
 * @interface CoursesEnrollmentApiUpdateSpecificEnrollmentRequest
 */
export type CoursesEnrollmentApiUpdateSpecificEnrollmentRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof CoursesEnrollmentApiUpdateSpecificEnrollment
    */
    readonly id: string
...
/**
 * CoursesEnrollmentApiGenerated - object-oriented interface
 * @export
 * @class CoursesEnrollmentApiGenerated
 * @extends {BaseAPI}
 */
export class CoursesEnrollmentApiGenerated extends BaseAPI {
    /**
     * Add a new enrollment
     * @summary Create Enrollment
     * @param {CoursesEnrollmentApiCreateNewEnrollmentRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CoursesEnrollmentApiGenerated
     */
    public createNewEnrollment(requestParameters: CoursesEnrollmentApiCreateNewEnrollmentRequest, options?: AxiosRequestConfig) {
        return CoursesEnrollmentApiFp(this.configuration).createNewEnrollment(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CoursesEnrollmentApiGenerated
     */
    public getById(requestParameters: CoursesEnrollmentApiGetByIdRequest, options?: AxiosRequestConfig) {
        return CoursesEnrollmentApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CoursesEnrollmentApiGenerated
     */
    public list(requestParameters: CoursesEnrollmentApiListRequest, options?: AxiosRequestConfig) {
        return CoursesEnrollmentApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CoursesEnrollmentApiGenerated
     */
    public updateSpecificEnrollment(requestParameters: CoursesEnrollmentApiUpdateSpecificEnrollmentRequest, options?: AxiosRequestConfig) {
        return CoursesEnrollmentApiFp(this.configuration).updateSpecificEnrollment(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
