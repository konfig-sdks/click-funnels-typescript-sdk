...
// @ts-ignore
import { ShippingZoneAddNewZone401Response } from '../models';
// @ts-ignore
import { ShippingZoneAddNewZoneRequest } from '../models';
// @ts-ignore
import { ShippingZoneAddNewZoneResponse } from '../models';
// @ts-ignore
import { ShippingZoneAttributes } from '../models';
// @ts-ignore
import { ShippingZoneGetZoneById404Response } from '../models';
// @ts-ignore
import { ShippingZoneGetZoneByIdResponse } from '../models';
// @ts-ignore
import { ShippingZoneListZones401Response } from '../models';
// @ts-ignore
import { ShippingZoneListZones404Response } from '../models';
// @ts-ignore
import { ShippingZoneRemoveById404Response } from '../models';
// @ts-ignore
import { ShippingZoneRemoveByIdResponse } from '../models';
// @ts-ignore
import { ShippingZoneUpdateZoneById401Response } from '../models';
// @ts-ignore
import { ShippingZoneUpdateZoneById404Response } from '../models';
// @ts-ignore
import { ShippingZoneUpdateZoneByIdRequest } from '../models';
// @ts-ignore
import { ShippingZoneUpdateZoneByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ShippingZoneApi - axios parameter creator
 * @export
 */
export const ShippingZoneApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new zone to a location group
         * @summary Create Zone
         * @param {number} locationGroupId 
         * @param {ShippingZoneAddNewZoneRequest} shippingZoneAddNewZoneRequest Information about a new Zone
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addNewZone: async (locationGroupId: number, shippingZoneAddNewZoneRequest: ShippingZoneAddNewZoneRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'locationGroupId' is not null or undefined
            assertParamExists('addNewZone', 'locationGroupId', locationGroupId)
            // verify required parameter 'shippingZoneAddNewZoneRequest' is not null or undefined
            assertParamExists('addNewZone', 'shippingZoneAddNewZoneRequest', shippingZoneAddNewZoneRequest)
            const localVarPath = `/shipping/location_groups/{location_group_id}/zones`
                .replace(`{${"location_group_id"}}`, encodeURIComponent(String(locationGroupId !== undefined ? locationGroupId : `-location_group_id-`)));
            ...
            requestBeforeHook({
                requestBody: shippingZoneAddNewZoneRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/shipping/location_groups/{location_group_id}/zones',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(shippingZoneAddNewZoneRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getZoneById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getZoneById', 'id', id)
            const localVarPath = `/shipping/zones/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/shipping/zones/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listZones: async (locationGroupId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'locationGroupId' is not null or undefined
            assertParamExists('listZones', 'locationGroupId', locationGroupId)
            const localVarPath = `/shipping/location_groups/{location_group_id}/zones`
                .replace(`{${"location_group_id"}}`, encodeURIComponent(String(locationGroupId !== undefined ? locationGroupId : `-location_group_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @summary Update Zone
         * @param {string} id 
         * @param {ShippingZoneUpdateZoneByIdRequest} shippingZoneUpdateZoneByIdRequest Information about updated fields in Zone
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateZoneById: async (id: string, shippingZoneUpdateZoneByIdRequest: ShippingZoneUpdateZoneByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateZoneById', 'id', id)
            // verify required parameter 'shippingZoneUpdateZoneByIdRequest' is not null or undefined
            assertParamExists('updateZoneById', 'shippingZoneUpdateZoneByIdRequest', shippingZoneUpdateZoneByIdRequest)
            const localVarPath = `/shipping/zones/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: shippingZoneUpdateZoneByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(shippingZoneUpdateZoneByIdRequest, localVarRequestOptions, configuration)
...
/**
 * ShippingZoneApi - functional programming interface
 * @export
 */
export const ShippingZoneApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ShippingZoneApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new zone to a location group
         * @summary Create Zone
         * @param {ShippingZoneApiAddNewZoneRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async addNewZone(requestParameters: ShippingZoneApiAddNewZoneRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingZoneAttributes>> {
            const shippingZoneAddNewZoneRequest: ShippingZoneAddNewZoneRequest = {
                shipping_zone: requestParameters.shipping_zone
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.addNewZone(requestParameters.locationGroupId, shippingZoneAddNewZoneRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a zone for a location group
         * @summary Fetch Zone
         * @param {ShippingZoneApiGetZoneByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getZoneById(requestParameters: ShippingZoneApiGetZoneByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingZoneAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getZoneById(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List zones for a location group
         * @summary List Zones
         * @param {ShippingZoneApiListZonesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listZones(requestParameters: ShippingZoneApiListZonesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ShippingZoneAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listZones(requestParameters.locationGroupId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a zone for a location group
         * @summary Remove Zone
         * @param {ShippingZoneApiRemoveByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async removeById(requestParameters: ShippingZoneApiRemoveByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * Update a zone for a location group
         * @summary Update Zone
         * @param {ShippingZoneApiUpdateZoneByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateZoneById(requestParameters: ShippingZoneApiUpdateZoneByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingZoneAttributes>> {
            const shippingZoneUpdateZoneByIdRequest: ShippingZoneUpdateZoneByIdRequest = {
                shipping_zone: requestParameters.shipping_zone
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateZoneById(requestParameters.id, shippingZoneUpdateZoneByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ShippingZoneApi - factory interface
 * @export
 */
export const ShippingZoneApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ShippingZoneApiFp(configuration)
    return {
        /**
         * Add a new zone to a location group
         * @summary Create Zone
         ...
         * @throws {RequiredError}
         */
        addNewZone(requestParameters: ShippingZoneApiAddNewZoneRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingZoneAttributes> {
            return localVarFp.addNewZone(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a zone for a location group
         * @summary Fetch Zone
         ...
         * @throws {RequiredError}
         */
        getZoneById(requestParameters: ShippingZoneApiGetZoneByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingZoneAttributes> {
            return localVarFp.getZoneById(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List zones for a location group
         * @summary List Zones
         ...
         * @throws {RequiredError}
         */
        listZones(requestParameters: ShippingZoneApiListZonesRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ShippingZoneAttributes>> {
            return localVarFp.listZones(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a zone for a location group
         * @summary Remove Zone
         ...
         * @throws {RequiredError}
         */
        removeById(requestParameters: ShippingZoneApiRemoveByIdRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateZoneById(requestParameters: ShippingZoneApiUpdateZoneByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingZoneAttributes> {
            return localVarFp.updateZoneById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for addNewZone operation in ShippingZoneApi.
 * @export
 * @interface ShippingZoneApiAddNewZoneRequest
 */
export type ShippingZoneApiAddNewZoneRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ShippingZoneApiAddNewZone
    */
    readonly locationGroupId: number
    
} & ShippingZoneAddNewZoneRequest

/**
 * Request parameters for getZoneById operation in ShippingZoneApi.
 * @export
 * @interface ShippingZoneApiGetZoneByIdRequest
 */
export type ShippingZoneApiGetZoneByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingZoneApiGetZoneById
    */
    readonly id: string
...
/**
 * Request parameters for listZones operation in ShippingZoneApi.
 * @export
 * @interface ShippingZoneApiListZonesRequest
 */
export type ShippingZoneApiListZonesRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ShippingZoneApiListZones
    */
    readonly locationGroupId: number
...
/**
 * Request parameters for removeById operation in ShippingZoneApi.
 * @export
 * @interface ShippingZoneApiRemoveByIdRequest
 */
export type ShippingZoneApiRemoveByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingZoneApiRemoveById
    */
    readonly id: string
...
/**
 * Request parameters for updateZoneById operation in ShippingZoneApi.
 * @export
 * @interface ShippingZoneApiUpdateZoneByIdRequest
 */
export type ShippingZoneApiUpdateZoneByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingZoneApiUpdateZoneById
    */
    readonly id: string
...
/**
 * ShippingZoneApiGenerated - object-oriented interface
 * @export
 * @class ShippingZoneApiGenerated
 * @extends {BaseAPI}
 */
export class ShippingZoneApiGenerated extends BaseAPI {
    /**
     * Add a new zone to a location group
     * @summary Create Zone
     * @param {ShippingZoneApiAddNewZoneRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ShippingZoneApiGenerated
     */
    public addNewZone(requestParameters: ShippingZoneApiAddNewZoneRequest, options?: AxiosRequestConfig) {
        return ShippingZoneApiFp(this.configuration).addNewZone(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingZoneApiGenerated
     */
    public getZoneById(requestParameters: ShippingZoneApiGetZoneByIdRequest, options?: AxiosRequestConfig) {
        return ShippingZoneApiFp(this.configuration).getZoneById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingZoneApiGenerated
     */
    public listZones(requestParameters: ShippingZoneApiListZonesRequest, options?: AxiosRequestConfig) {
        return ShippingZoneApiFp(this.configuration).listZones(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingZoneApiGenerated
     */
    public removeById(requestParameters: ShippingZoneApiRemoveByIdRequest, options?: AxiosRequestConfig) {
        return ShippingZoneApiFp(this.configuration).removeById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingZoneApiGenerated
     */
    public updateZoneById(requestParameters: ShippingZoneApiUpdateZoneByIdRequest, options?: AxiosRequestConfig) {
        return ShippingZoneApiFp(this.configuration).updateZoneById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
