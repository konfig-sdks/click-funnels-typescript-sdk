...
// @ts-ignore
import { ShippingProfileAttributes } from '../models';
// @ts-ignore
import { ShippingProfileCreateNew401Response } from '../models';
// @ts-ignore
import { ShippingProfileCreateNewRequest } from '../models';
// @ts-ignore
import { ShippingProfileCreateNewResponse } from '../models';
// @ts-ignore
import { ShippingProfileGetWorkspaceProfile404Response } from '../models';
// @ts-ignore
import { ShippingProfileGetWorkspaceProfileResponse } from '../models';
// @ts-ignore
import { ShippingProfileList401Response } from '../models';
// @ts-ignore
import { ShippingProfileList404Response } from '../models';
// @ts-ignore
import { ShippingProfileRemove404Response } from '../models';
// @ts-ignore
import { ShippingProfileRemoveResponse } from '../models';
// @ts-ignore
import { ShippingProfileUpdateForWorkspace401Response } from '../models';
// @ts-ignore
import { ShippingProfileUpdateForWorkspace404Response } from '../models';
// @ts-ignore
import { ShippingProfileUpdateForWorkspaceRequest } from '../models';
// @ts-ignore
import { ShippingProfileUpdateForWorkspaceResponse } from '../models';
...
export const ShippingProfileApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ShippingProfileCreateNewRequest} shippingProfileCreateNewRequest Information about a new Profile
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNew: async (workspaceId: number, shippingProfileCreateNewRequest: ShippingProfileCreateNewRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('createNew', 'workspaceId', workspaceId)
            // verify required parameter 'shippingProfileCreateNewRequest' is not null or undefined
            assertParamExists('createNew', 'shippingProfileCreateNewRequest', shippingProfileCreateNewRequest)
            const localVarPath = `/workspaces/{workspace_id}/shipping/profiles`
            ...
            requestBeforeHook({
                requestBody: shippingProfileCreateNewRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/shipping/profiles',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(shippingProfileCreateNewRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getWorkspaceProfile: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getWorkspaceProfile', 'id', id)
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/shipping/profiles/{id}',
                httpMethod: 'GET'
            });
         ...
         * @param {string} id 
         * @param {ShippingProfileUpdateForWorkspaceRequest} shippingProfileUpdateForWorkspaceRequest Information about updated fields in Profile
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateForWorkspace: async (id: string, shippingProfileUpdateForWorkspaceRequest: ShippingProfileUpdateForWorkspaceRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateForWorkspace', 'id', id)
            // verify required parameter 'shippingProfileUpdateForWorkspaceRequest' is not null or undefined
            assertParamExists('updateForWorkspace', 'shippingProfileUpdateForWorkspaceRequest', shippingProfileUpdateForWorkspaceRequest)
            const localVarPath = `/shipping/profiles/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: shippingProfileUpdateForWorkspaceRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(shippingProfileUpdateForWorkspaceRequest, localVarRequestOptions, configuration)
...
export const ShippingProfileApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Add a new shipping profile to a workspace
         * @summary Create Profile
         * @param {ShippingProfileApiCreateNewRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNew(requestParameters: ShippingProfileApiCreateNewRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingProfileAttributes>> {
            const shippingProfileCreateNewRequest: ShippingProfileCreateNewRequest = {
                shipping_profile: requestParameters.shipping_profile
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNew(requestParameters.workspaceId, shippingProfileCreateNewRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a shipping profile for a workspace
         * @summary Fetch Profile
         * @param {ShippingProfileApiGetWorkspaceProfileRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getWorkspaceProfile(requestParameters: ShippingProfileApiGetWorkspaceProfileRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingProfileAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getWorkspaceProfile(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List shipping profiles for a workspace
         * @summary List Profiles
         * @param {ShippingProfileApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: ShippingProfileApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ShippingProfileAttributes>>> {
         ...
         * Delete a shipping profile for a workspace
         * @summary Remove Profile
         * @param {ShippingProfileApiRemoveRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async remove(requestParameters: ShippingProfileApiRemoveRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * Update a shipping profile for a workspace
         * @summary Update Profile
         * @param {ShippingProfileApiUpdateForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateForWorkspace(requestParameters: ShippingProfileApiUpdateForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingProfileAttributes>> {
            const shippingProfileUpdateForWorkspaceRequest: ShippingProfileUpdateForWorkspaceRequest = {
                shipping_profile: requestParameters.shipping_profile
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateForWorkspace(requestParameters.id, shippingProfileUpdateForWorkspaceRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ShippingProfileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createNew(requestParameters: ShippingProfileApiCreateNewRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingProfileAttributes> {
         ...
         * @throws {RequiredError}
         */
        getWorkspaceProfile(requestParameters: ShippingProfileApiGetWorkspaceProfileRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingProfileAttributes> {
            return localVarFp.getWorkspaceProfile(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List shipping profiles for a workspace
         * @summary List Profiles
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: ShippingProfileApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ShippingProfileAttributes>> {
         ...
         * @throws {RequiredError}
         */
        remove(requestParameters: ShippingProfileApiRemoveRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateForWorkspace(requestParameters: ShippingProfileApiUpdateForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingProfileAttributes> {
...
/**
 * Request parameters for createNew operation in ShippingProfileApi.
 * @export
 * @interface ShippingProfileApiCreateNewRequest
 */
export type ShippingProfileApiCreateNewRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ShippingProfileApiCreateNew
    */
...
/**
 * Request parameters for getWorkspaceProfile operation in ShippingProfileApi.
 * @export
 * @interface ShippingProfileApiGetWorkspaceProfileRequest
 */
export type ShippingProfileApiGetWorkspaceProfileRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingProfileApiGetWorkspaceProfile
    */
    readonly id: string
...
/**
 * Request parameters for list operation in ShippingProfileApi.
 * @export
 * @interface ShippingProfileApiListRequest
 */
export type ShippingProfileApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ShippingProfileApiList
    */
    readonly workspaceId: number
...
/**
 * Request parameters for remove operation in ShippingProfileApi.
 * @export
 * @interface ShippingProfileApiRemoveRequest
 */
export type ShippingProfileApiRemoveRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingProfileApiRemove
    */
    readonly id: string
...
/**
 * Request parameters for updateForWorkspace operation in ShippingProfileApi.
 * @export
 * @interface ShippingProfileApiUpdateForWorkspaceRequest
 */
export type ShippingProfileApiUpdateForWorkspaceRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingProfileApiUpdateForWorkspace
    */
    readonly id: string
...
/**
 * ShippingProfileApiGenerated - object-oriented interface
 * @export
 * @class ShippingProfileApiGenerated
 * @extends {BaseAPI}
 */
export class ShippingProfileApiGenerated extends BaseAPI {
    /**
     * Add a new shipping profile to a workspace
     * @summary Create Profile
     * @param {ShippingProfileApiCreateNewRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ShippingProfileApiGenerated
     */
    public createNew(requestParameters: ShippingProfileApiCreateNewRequest, options?: AxiosRequestConfig) {
        return ShippingProfileApiFp(this.configuration).createNew(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingProfileApiGenerated
     */
    public getWorkspaceProfile(requestParameters: ShippingProfileApiGetWorkspaceProfileRequest, options?: AxiosRequestConfig) {
        return ShippingProfileApiFp(this.configuration).getWorkspaceProfile(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingProfileApiGenerated
     */
    public list(requestParameters: ShippingProfileApiListRequest, options?: AxiosRequestConfig) {
        return ShippingProfileApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingProfileApiGenerated
     */
    public remove(requestParameters: ShippingProfileApiRemoveRequest, options?: AxiosRequestConfig) {
        return ShippingProfileApiFp(this.configuration).remove(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingProfileApiGenerated
     */
    public updateForWorkspace(requestParameters: ShippingProfileApiUpdateForWorkspaceRequest, options?: AxiosRequestConfig) {
        return ShippingProfileApiFp(this.configuration).updateForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
