...
// @ts-ignore
import { FormsFieldAddNewField401Response } from '../models';
// @ts-ignore
import { FormsFieldAddNewFieldRequest } from '../models';
// @ts-ignore
import { FormsFieldAddNewFieldResponse } from '../models';
// @ts-ignore
import { FormsFieldAttributes } from '../models';
// @ts-ignore
import { FormsFieldGetField404Response } from '../models';
// @ts-ignore
import { FormsFieldGetFieldResponse } from '../models';
// @ts-ignore
import { FormsFieldListFieldsForFieldSet401Response } from '../models';
// @ts-ignore
import { FormsFieldListFieldsForFieldSet404Response } from '../models';
// @ts-ignore
import { FormsFieldRemoveField404Response } from '../models';
// @ts-ignore
import { FormsFieldRemoveFieldResponse } from '../models';
// @ts-ignore
import { FormsFieldUpdateFieldById401Response } from '../models';
// @ts-ignore
import { FormsFieldUpdateFieldById404Response } from '../models';
// @ts-ignore
import { FormsFieldUpdateFieldByIdRequest } from '../models';
// @ts-ignore
import { FormsFieldUpdateFieldByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * FormsFieldApi - axios parameter creator
 * @export
 */
export const FormsFieldApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new field
         * @summary Create Field
         * @param {number} fieldSetId 
         * @param {FormsFieldAddNewFieldRequest} formsFieldAddNewFieldRequest Information about a new Field
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addNewField: async (fieldSetId: number, formsFieldAddNewFieldRequest: FormsFieldAddNewFieldRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fieldSetId' is not null or undefined
            assertParamExists('addNewField', 'fieldSetId', fieldSetId)
            // verify required parameter 'formsFieldAddNewFieldRequest' is not null or undefined
            assertParamExists('addNewField', 'formsFieldAddNewFieldRequest', formsFieldAddNewFieldRequest)
            const localVarPath = `/forms/field_sets/{field_set_id}/fields`
                .replace(`{${"field_set_id"}}`, encodeURIComponent(String(fieldSetId !== undefined ? fieldSetId : `-field_set_id-`)));
            ...
            requestBeforeHook({
                requestBody: formsFieldAddNewFieldRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/forms/field_sets/{field_set_id}/fields',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(formsFieldAddNewFieldRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getField: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getField', 'id', id)
            const localVarPath = `/forms/fields/{id}`
         ...
         * @throws {RequiredError}
         */
        listFieldsForFieldSet: async (fieldSetId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fieldSetId' is not null or undefined
            assertParamExists('listFieldsForFieldSet', 'fieldSetId', fieldSetId)
            const localVarPath = `/forms/field_sets/{field_set_id}/fields`
                .replace(`{${"field_set_id"}}`, encodeURIComponent(String(fieldSetId !== undefined ? fieldSetId : `-field_set_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        removeField: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('removeField', 'id', id)
            const localVarPath = `/forms/fields/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {string} id 
         * @param {FormsFieldUpdateFieldByIdRequest} formsFieldUpdateFieldByIdRequest Information about updated fields in Field
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateFieldById: async (id: string, formsFieldUpdateFieldByIdRequest: FormsFieldUpdateFieldByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateFieldById', 'id', id)
            // verify required parameter 'formsFieldUpdateFieldByIdRequest' is not null or undefined
            assertParamExists('updateFieldById', 'formsFieldUpdateFieldByIdRequest', formsFieldUpdateFieldByIdRequest)
            const localVarPath = `/forms/fields/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: formsFieldUpdateFieldByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(formsFieldUpdateFieldByIdRequest, localVarRequestOptions, configuration)
...
/**
 * FormsFieldApi - functional programming interface
 * @export
 */
export const FormsFieldApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = FormsFieldApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new field
         * @summary Create Field
         * @param {FormsFieldApiAddNewFieldRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async addNewField(requestParameters: FormsFieldApiAddNewFieldRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldAttributes>> {
            const formsFieldAddNewFieldRequest: FormsFieldAddNewFieldRequest = {
                forms_field: requestParameters.forms_field
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.addNewField(requestParameters.fieldSetId, formsFieldAddNewFieldRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a field
         * @summary Fetch Field
         * @param {FormsFieldApiGetFieldRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getField(requestParameters: FormsFieldApiGetFieldRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getField(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List fields for a field set
         * @summary List Fields
         * @param {FormsFieldApiListFieldsForFieldSetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listFieldsForFieldSet(requestParameters: FormsFieldApiListFieldsForFieldSetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FormsFieldAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listFieldsForFieldSet(requestParameters.fieldSetId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a field
         * @summary Remove Field
         * @param {FormsFieldApiRemoveFieldRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async removeField(requestParameters: FormsFieldApiRemoveFieldRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.removeField(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a field
         * @summary Update Field
         * @param {FormsFieldApiUpdateFieldByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateFieldById(requestParameters: FormsFieldApiUpdateFieldByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldAttributes>> {
            const formsFieldUpdateFieldByIdRequest: FormsFieldUpdateFieldByIdRequest = {
                forms_field: requestParameters.forms_field
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateFieldById(requestParameters.id, formsFieldUpdateFieldByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * FormsFieldApi - factory interface
 * @export
 */
export const FormsFieldApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = FormsFieldApiFp(configuration)
    return {
        /**
         * Add a new field
         * @summary Create Field
         ...
         * @throws {RequiredError}
         */
        addNewField(requestParameters: FormsFieldApiAddNewFieldRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldAttributes> {
         ...
         * @throws {RequiredError}
         */
        getField(requestParameters: FormsFieldApiGetFieldRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldAttributes> {
            return localVarFp.getField(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List fields for a field set
         * @summary List Fields
         ...
         * @throws {RequiredError}
         */
        listFieldsForFieldSet(requestParameters: FormsFieldApiListFieldsForFieldSetRequest, options?: AxiosRequestConfig): AxiosPromise<Array<FormsFieldAttributes>> {
            return localVarFp.listFieldsForFieldSet(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a field
         * @summary Remove Field
         ...
         * @throws {RequiredError}
         */
        removeField(requestParameters: FormsFieldApiRemoveFieldRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.removeField(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a field
         * @summary Update Field
         ...
         * @throws {RequiredError}
         */
        updateFieldById(requestParameters: FormsFieldApiUpdateFieldByIdRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldAttributes> {
...
/**
 * Request parameters for addNewField operation in FormsFieldApi.
 * @export
 * @interface FormsFieldApiAddNewFieldRequest
 */
export type FormsFieldApiAddNewFieldRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormsFieldApiAddNewField
    */
...
/**
 * Request parameters for getField operation in FormsFieldApi.
 * @export
 * @interface FormsFieldApiGetFieldRequest
 */
export type FormsFieldApiGetFieldRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldApiGetField
    */
    readonly id: string
...
/**
 * Request parameters for listFieldsForFieldSet operation in FormsFieldApi.
 * @export
 * @interface FormsFieldApiListFieldsForFieldSetRequest
 */
export type FormsFieldApiListFieldsForFieldSetRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormsFieldApiListFieldsForFieldSet
    */
    readonly fieldSetId: number
...
/**
 * Request parameters for removeField operation in FormsFieldApi.
 * @export
 * @interface FormsFieldApiRemoveFieldRequest
 */
export type FormsFieldApiRemoveFieldRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldApiRemoveField
    */
    readonly id: string
...
/**
 * Request parameters for updateFieldById operation in FormsFieldApi.
 * @export
 * @interface FormsFieldApiUpdateFieldByIdRequest
 */
export type FormsFieldApiUpdateFieldByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldApiUpdateFieldById
    */
    readonly id: string
...
/**
 * FormsFieldApiGenerated - object-oriented interface
 * @export
 * @class FormsFieldApiGenerated
 * @extends {BaseAPI}
 */
export class FormsFieldApiGenerated extends BaseAPI {
    /**
     * Add a new field
     * @summary Create Field
     * @param {FormsFieldApiAddNewFieldRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FormsFieldApiGenerated
     */
    public addNewField(requestParameters: FormsFieldApiAddNewFieldRequest, options?: AxiosRequestConfig) {
        return FormsFieldApiFp(this.configuration).addNewField(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldApiGenerated
     */
    public getField(requestParameters: FormsFieldApiGetFieldRequest, options?: AxiosRequestConfig) {
        return FormsFieldApiFp(this.configuration).getField(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldApiGenerated
     */
    public listFieldsForFieldSet(requestParameters: FormsFieldApiListFieldsForFieldSetRequest, options?: AxiosRequestConfig) {
        return FormsFieldApiFp(this.configuration).listFieldsForFieldSet(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldApiGenerated
     */
    public removeField(requestParameters: FormsFieldApiRemoveFieldRequest, options?: AxiosRequestConfig) {
        return FormsFieldApiFp(this.configuration).removeField(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldApiGenerated
     */
    public updateFieldById(requestParameters: FormsFieldApiUpdateFieldByIdRequest, options?: AxiosRequestConfig) {
        return FormsFieldApiFp(this.configuration).updateFieldById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
