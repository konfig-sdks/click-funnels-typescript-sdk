...
// @ts-ignore
import { OrdersInvoiceAttributes } from '../models';
// @ts-ignore
import { OrdersInvoiceGetForOrder404Response } from '../models';
// @ts-ignore
import { OrdersInvoiceGetForOrderResponse } from '../models';
// @ts-ignore
import { OrdersInvoiceListForOrder401Response } from '../models';
// @ts-ignore
import { OrdersInvoiceListForOrder404Response } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * OrdersInvoiceApi - axios parameter creator
 * @export
 */
export const OrdersInvoiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getForOrder: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getForOrder', 'id', id)
            const localVarPath = `/orders/invoices/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/orders/invoices/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listForOrder: async (orderId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orderId' is not null or undefined
            assertParamExists('listForOrder', 'orderId', orderId)
            const localVarPath = `/orders/{order_id}/invoices`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/orders/{order_id}/invoices',
                httpMethod: 'GET'
            });
...
/**
 * OrdersInvoiceApi - functional programming interface
 * @export
 */
export const OrdersInvoiceApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = OrdersInvoiceApiAxiosParamCreator(configuration)
    return {
        /**
         * Retrieve an invoice for an order
         * @summary Fetch Invoice
         * @param {OrdersInvoiceApiGetForOrderRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getForOrder(requestParameters: OrdersInvoiceApiGetForOrderRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrdersInvoiceAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getForOrder(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List invoices for an order
         * @summary List Invoices
         * @param {OrdersInvoiceApiListForOrderRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listForOrder(requestParameters: OrdersInvoiceApiListForOrderRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrdersInvoiceAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listForOrder(requestParameters.orderId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * OrdersInvoiceApi - factory interface
 * @export
 */
export const OrdersInvoiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = OrdersInvoiceApiFp(configuration)
    return {
        /**
         * Retrieve an invoice for an order
         * @summary Fetch Invoice
         ...
         * @throws {RequiredError}
         */
        getForOrder(requestParameters: OrdersInvoiceApiGetForOrderRequest, options?: AxiosRequestConfig): AxiosPromise<OrdersInvoiceAttributes> {
            return localVarFp.getForOrder(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List invoices for an order
         * @summary List Invoices
         ...
         * @throws {RequiredError}
         */
        listForOrder(requestParameters: OrdersInvoiceApiListForOrderRequest, options?: AxiosRequestConfig): AxiosPromise<Array<OrdersInvoiceAttributes>> {
            return localVarFp.listForOrder(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getForOrder operation in OrdersInvoiceApi.
 * @export
 * @interface OrdersInvoiceApiGetForOrderRequest
 */
export type OrdersInvoiceApiGetForOrderRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof OrdersInvoiceApiGetForOrder
    */
    readonly id: string
...
/**
 * Request parameters for listForOrder operation in OrdersInvoiceApi.
 * @export
 * @interface OrdersInvoiceApiListForOrderRequest
 */
export type OrdersInvoiceApiListForOrderRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof OrdersInvoiceApiListForOrder
    */
...
/**
 * OrdersInvoiceApiGenerated - object-oriented interface
 * @export
 * @class OrdersInvoiceApiGenerated
 * @extends {BaseAPI}
 */
export class OrdersInvoiceApiGenerated extends BaseAPI {
    /**
     * Retrieve an invoice for an order
     * @summary Fetch Invoice
     * @param {OrdersInvoiceApiGetForOrderRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof OrdersInvoiceApiGenerated
     */
    public getForOrder(requestParameters: OrdersInvoiceApiGetForOrderRequest, options?: AxiosRequestConfig) {
        return OrdersInvoiceApiFp(this.configuration).getForOrder(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrdersInvoiceApiGenerated
     */
    public listForOrder(requestParameters: OrdersInvoiceApiListForOrderRequest, options?: AxiosRequestConfig) {
        return OrdersInvoiceApiFp(this.configuration).listForOrder(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
