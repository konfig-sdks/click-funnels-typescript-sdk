...
// @ts-ignore
import { ContactCreateNewContact401Response } from '../models';
// @ts-ignore
import { ContactCreateNewContactRequest } from '../models';
// @ts-ignore
import { ContactCreateNewContactResponse } from '../models';
// @ts-ignore
import { ContactGetContactById404Response } from '../models';
// @ts-ignore
import { ContactGetContactByIdResponse } from '../models';
// @ts-ignore
import { ContactListForWorkspace401Response } from '../models';
// @ts-ignore
import { ContactListForWorkspace404Response } from '../models';
// @ts-ignore
import { ContactListForWorkspaceFilterParameter } from '../models';
// @ts-ignore
import { ContactRemoveById404Response } from '../models';
// @ts-ignore
import { ContactRemoveByIdResponse } from '../models';
// @ts-ignore
import { ContactUpdateContactById401Response } from '../models';
// @ts-ignore
import { ContactUpdateContactById404Response } from '../models';
// @ts-ignore
import { ContactUpdateContactByIdRequest } from '../models';
// @ts-ignore
import { ContactUpdateContactByIdResponse } from '../models';
// @ts-ignore
import { ContactUpsertRequest } from '../models';
// @ts-ignore
import { ContactsProperty } from '../models';
...
export const ContactApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ContactCreateNewContactRequest} contactCreateNewContactRequest Information about a new Contact
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewContact: async (workspaceId: number, contactCreateNewContactRequest: ContactCreateNewContactRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('createNewContact', 'workspaceId', workspaceId)
            // verify required parameter 'contactCreateNewContactRequest' is not null or undefined
            assertParamExists('createNewContact', 'contactCreateNewContactRequest', contactCreateNewContactRequest)
            const localVarPath = `/workspaces/{workspace_id}/contacts`
            ...
            requestBeforeHook({
                requestBody: contactCreateNewContactRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/contacts',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(contactCreateNewContactRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getContactById: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {ContactListForWorkspaceFilterParameter} [filter] Filtering  - Keep in mind that depending on the tools that you use, you might run into different situations where additional encoding is needed. For example:     - You might need to encode &#x60;filter[id]&#x3D;1&#x60; as &#x60;filter%5Bid%5D&#x3D;1&#x60; or use special options in your tools of choice to do it for you (like &#x60;g&#x60; in CURL).     -  Special URL characters like &#x60;%&#x60;, &#x60;+&#x60;, or unicode characters in emails (like Chinese characters) will need additional encoding.  
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listForWorkspace: async (workspaceId: number, after?: string, sortOrder?: 'asc' | 'desc', filter?: ContactListForWorkspaceFilterParameter, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
         ...
         * @summary Redact personally identifiable information of a Contact
         * @param {string} id 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        redactPersonallyIdentifiable: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('redactPersonallyIdentifiable', 'id', id)
            const localVarPath = `/contacts/{id}/gdpr_destroy`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/contacts/{id}/gdpr_destroy',
                httpMethod: 'DELETE'
            });
         ...
         * @param {string} id 
         * @param {ContactUpdateContactByIdRequest} contactUpdateContactByIdRequest Information about updated fields in Contact
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateContactById: async (id: string, contactUpdateContactByIdRequest: ContactUpdateContactByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateContactById', 'id', id)
            // verify required parameter 'contactUpdateContactByIdRequest' is not null or undefined
            assertParamExists('updateContactById', 'contactUpdateContactByIdRequest', contactUpdateContactByIdRequest)
            const localVarPath = `/contacts/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: contactUpdateContactByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(contactUpdateContactByIdRequest, localVarRequestOptions, configuration)
         ...
         * @param {ContactUpsertRequest} contactUpsertRequest Contact to create or update, matching on the email address. Note that properties of a Contact are not reset when passed empty values, e.g. passing &#x60;null&#x60; for &#x60;first_name&#x60; or an empty array for &#x60;tag_ids&#x60; won\&#39;t update previous values. To do that you would instead use the &#x60;Update Contact&#x60; endpoint.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        upsert: async (workspaceId: string, contactUpsertRequest: ContactUpsertRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('upsert', 'workspaceId', workspaceId)
            // verify required parameter 'contactUpsertRequest' is not null or undefined
            assertParamExists('upsert', 'contactUpsertRequest', contactUpsertRequest)
            const localVarPath = `/workspaces/{workspace_id}/contacts/upsert`
                .replace(`{${"workspace_id"}}`, encodeURIComponent(String(workspaceId !== undefined ? workspaceId : `-workspace_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: contactUpsertRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/contacts/upsert',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(contactUpsertRequest, localVarRequestOptions, configuration)
...
export const ContactApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createNewContact(requestParameters: ContactApiCreateNewContactRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactAttributes>> {
            const contactCreateNewContactRequest: ContactCreateNewContactRequest = {
                contact: requestParameters.contact
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewContact(requestParameters.workspaceId, contactCreateNewContactRequest, options);
         ...
         * @throws {RequiredError}
         */
        async getContactById(requestParameters: ContactApiGetContactByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getContactById(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List contacts for the given workspace. By default, only identified contacts are shown so you won&#39;t see anonymous or GDPR-redacted contacts.
         * @summary List Contacts
         * @param {ContactApiListForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listForWorkspace(requestParameters: ContactApiListForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContactAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listForWorkspace(requestParameters.workspaceId, requestParameters.after, requestParameters.sortOrder, requestParameters.filter, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This will destroy all personally identifiable information for a contact, including their name and phone number. This cannot be undone.
         * @summary Redact personally identifiable information of a Contact
         * @param {ContactApiRedactPersonallyIdentifiableRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async redactPersonallyIdentifiable(requestParameters: ContactApiRedactPersonallyIdentifiableRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.redactPersonallyIdentifiable(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a contact
         * @summary Remove Contact
         * @param {ContactApiRemoveByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async removeById(requestParameters: ContactApiRemoveByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * Update a contact
         * @summary Update Contact
         * @param {ContactApiUpdateContactByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateContactById(requestParameters: ContactApiUpdateContactByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactAttributes>> {
            const contactUpdateContactByIdRequest: ContactUpdateContactByIdRequest = {
                contact: requestParameters.contact
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateContactById(requestParameters.id, contactUpdateContactByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Creates or updates a Contact, matching on the email address. If the Contact does not exist, it will be created. If the Contact does exist, it will be updated. It is not possible to delete a Contact via this endpoint. It is not possible to reset properties of a Contact by passing empty values. E.g. passing `null` for `first_name` or an empty array for `tag_ids` won\'t update previous values. To do that you would instead need to use the `Update Contact` endpoint.
         * @summary Upsert a Contact
         * @param {ContactApiUpsertRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async upsert(requestParameters: ContactApiUpsertRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContactAttributes>>> {
            const contactUpsertRequest: ContactUpsertRequest = {
                contact: requestParameters.contact
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.upsert(requestParameters.workspaceId, contactUpsertRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ContactApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createNewContact(requestParameters: ContactApiCreateNewContactRequest, options?: AxiosRequestConfig): AxiosPromise<ContactAttributes> {
         ...
         * @throws {RequiredError}
         */
        getContactById(requestParameters: ContactApiGetContactByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ContactAttributes> {
         ...
         * @throws {RequiredError}
         */
        listForWorkspace(requestParameters: ContactApiListForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ContactAttributes>> {
         ...
         * @throws {RequiredError}
         */
        redactPersonallyIdentifiable(requestParameters: ContactApiRedactPersonallyIdentifiableRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.redactPersonallyIdentifiable(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a contact
         * @summary Remove Contact
         ...
         * @throws {RequiredError}
         */
        removeById(requestParameters: ContactApiRemoveByIdRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateContactById(requestParameters: ContactApiUpdateContactByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ContactAttributes> {
            return localVarFp.updateContactById(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates or updates a Contact, matching on the email address. If the Contact does not exist, it will be created. If the Contact does exist, it will be updated. It is not possible to delete a Contact via this endpoint. It is not possible to reset properties of a Contact by passing empty values. E.g. passing `null` for `first_name` or an empty array for `tag_ids` won\'t update previous values. To do that you would instead need to use the `Update Contact` endpoint.
         * @summary Upsert a Contact
         ...
         * @throws {RequiredError}
         */
        upsert(requestParameters: ContactApiUpsertRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ContactAttributes>> {
            return localVarFp.upsert(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};
...
export type ContactApiCreateNewContactRequest = {
    ...
    * 
    * @type {number}
    * @memberof ContactApiCreateNewContact
    */
...
/**
 * Request parameters for listForWorkspace operation in ContactApi.
 * @export
 * @interface ContactApiListForWorkspaceRequest
 */
export type ContactApiListForWorkspaceRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ContactApiListForWorkspace
    */
    readonly workspaceId: number
    ...
    * @type {ContactListForWorkspaceFilterParameter}
    * @memberof ContactApiListForWorkspace
    */
    readonly filter?: ContactListForWorkspaceFilterParameter
    
}

/**
 * Request parameters for redactPersonallyIdentifiable operation in ContactApi.
 * @export
 * @interface ContactApiRedactPersonallyIdentifiableRequest
 */
export type ContactApiRedactPersonallyIdentifiableRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactApiRedactPersonallyIdentifiable
    */
    readonly id: string
...
/**
 * Request parameters for removeById operation in ContactApi.
 * @export
 * @interface ContactApiRemoveByIdRequest
 */
export type ContactApiRemoveByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactApiRemoveById
    */
    readonly id: string
...
/**
 * Request parameters for updateContactById operation in ContactApi.
 * @export
 * @interface ContactApiUpdateContactByIdRequest
 */
export type ContactApiUpdateContactByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactApiUpdateContactById
    */
    readonly id: string
...
/**
 * Request parameters for upsert operation in ContactApi.
 * @export
 * @interface ContactApiUpsertRequest
 */
export type ContactApiUpsertRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactApiUpsert
    */
...
export class ContactApiGenerated extends BaseAPI {
     ...
     * @memberof ContactApiGenerated
     */
    public listForWorkspace(requestParameters: ContactApiListForWorkspaceRequest, options?: AxiosRequestConfig) {
        return ContactApiFp(this.configuration).listForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactApiGenerated
     */
    public redactPersonallyIdentifiable(requestParameters: ContactApiRedactPersonallyIdentifiableRequest, options?: AxiosRequestConfig) {
        return ContactApiFp(this.configuration).redactPersonallyIdentifiable(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactApiGenerated
     */
    public removeById(requestParameters: ContactApiRemoveByIdRequest, options?: AxiosRequestConfig) {
        return ContactApiFp(this.configuration).removeById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactApiGenerated
     */
    public updateContactById(requestParameters: ContactApiUpdateContactByIdRequest, options?: AxiosRequestConfig) {
        return ContactApiFp(this.configuration).updateContactById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactApiGenerated
     */
    public upsert(requestParameters: ContactApiUpsertRequest, options?: AxiosRequestConfig) {
        return ContactApiFp(this.configuration).upsert(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
