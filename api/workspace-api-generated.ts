...
// @ts-ignore
import { WorkspaceAddNew401Response } from '../models';
// @ts-ignore
import { WorkspaceAddNewRequest } from '../models';
// @ts-ignore
import { WorkspaceAddNewResponse } from '../models';
// @ts-ignore
import { WorkspaceAttributes } from '../models';
// @ts-ignore
import { WorkspaceGetById404Response } from '../models';
// @ts-ignore
import { WorkspaceGetByIdResponse } from '../models';
// @ts-ignore
import { WorkspaceListWorkspaces401Response } from '../models';
// @ts-ignore
import { WorkspaceListWorkspaces404Response } from '../models';
// @ts-ignore
import { WorkspaceUpdate401Response } from '../models';
// @ts-ignore
import { WorkspaceUpdate404Response } from '../models';
// @ts-ignore
import { WorkspaceUpdateRequest } from '../models';
// @ts-ignore
import { WorkspaceUpdateResponse } from '../models';
...
export const WorkspaceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} teamId 
         * @param {WorkspaceAddNewRequest} workspaceAddNewRequest Information about a new Workspace
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addNew: async (teamId: number, workspaceAddNewRequest: WorkspaceAddNewRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'teamId' is not null or undefined
            assertParamExists('addNew', 'teamId', teamId)
            // verify required parameter 'workspaceAddNewRequest' is not null or undefined
            assertParamExists('addNew', 'workspaceAddNewRequest', workspaceAddNewRequest)
            const localVarPath = `/teams/{team_id}/workspaces`
            ...
            requestBeforeHook({
                requestBody: workspaceAddNewRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/teams/{team_id}/workspaces',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(workspaceAddNewRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        listWorkspaces: async (teamId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'teamId' is not null or undefined
            assertParamExists('listWorkspaces', 'teamId', teamId)
            const localVarPath = `/teams/{team_id}/workspaces`
                .replace(`{${"team_id"}}`, encodeURIComponent(String(teamId !== undefined ? teamId : `-team_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {string} id 
         * @param {WorkspaceUpdateRequest} workspaceUpdateRequest Information about updated fields in Workspace
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        update: async (id: string, workspaceUpdateRequest: WorkspaceUpdateRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('update', 'id', id)
            // verify required parameter 'workspaceUpdateRequest' is not null or undefined
            assertParamExists('update', 'workspaceUpdateRequest', workspaceUpdateRequest)
            const localVarPath = `/workspaces/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const WorkspaceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Add a new workspace
         * @summary Create Workspace
         * @param {WorkspaceApiAddNewRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async addNew(requestParameters: WorkspaceApiAddNewRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkspaceAttributes>> {
            const workspaceAddNewRequest: WorkspaceAddNewRequest = {
                workspace: requestParameters.workspace
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.addNew(requestParameters.teamId, workspaceAddNewRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a workspace
         * @summary Fetch Workspace
         * @param {WorkspaceApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: WorkspaceApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkspaceAttributes>> {
         ...
         * @throws {RequiredError}
         */
        async listWorkspaces(requestParameters: WorkspaceApiListWorkspacesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WorkspaceAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listWorkspaces(requestParameters.teamId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a workspace
         ...
         * @throws {RequiredError}
         */
        async update(requestParameters: WorkspaceApiUpdateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkspaceAttributes>> {
            const workspaceUpdateRequest: WorkspaceUpdateRequest = {
                workspace: requestParameters.workspace
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.update(requestParameters.id, workspaceUpdateRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const WorkspaceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addNew(requestParameters: WorkspaceApiAddNewRequest, options?: AxiosRequestConfig): AxiosPromise<WorkspaceAttributes> {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: WorkspaceApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<WorkspaceAttributes> {
         ...
         * @throws {RequiredError}
         */
        listWorkspaces(requestParameters: WorkspaceApiListWorkspacesRequest, options?: AxiosRequestConfig): AxiosPromise<Array<WorkspaceAttributes>> {
            return localVarFp.listWorkspaces(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a workspace
         * @summary Update Workspace
         ...
         * @throws {RequiredError}
         */
        update(requestParameters: WorkspaceApiUpdateRequest, options?: AxiosRequestConfig): AxiosPromise<WorkspaceAttributes> {
...
/**
 * Request parameters for addNew operation in WorkspaceApi.
 * @export
 * @interface WorkspaceApiAddNewRequest
 */
export type WorkspaceApiAddNewRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof WorkspaceApiAddNew
    */
...
/**
 * Request parameters for getById operation in WorkspaceApi.
 * @export
 * @interface WorkspaceApiGetByIdRequest
 */
export type WorkspaceApiGetByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof WorkspaceApiGetById
    */
    readonly id: string
 ...
 */
export type WorkspaceApiListWorkspacesRequest = {
 ...
 */
export type WorkspaceApiUpdateRequest = {
...
export class WorkspaceApiGenerated extends BaseAPI {
     ...
     */
    public addNew(requestParameters: WorkspaceApiAddNewRequest, options?: AxiosRequestConfig) {
        return WorkspaceApiFp(this.configuration).addNew(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WorkspaceApiGenerated
     */
    public getById(requestParameters: WorkspaceApiGetByIdRequest, options?: AxiosRequestConfig) {
        return WorkspaceApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WorkspaceApiGenerated
     */
    public listWorkspaces(requestParameters: WorkspaceApiListWorkspacesRequest, options?: AxiosRequestConfig) {
        return WorkspaceApiFp(this.configuration).listWorkspaces(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public update(requestParameters: WorkspaceApiUpdateRequest, options?: AxiosRequestConfig) {
        return WorkspaceApiFp(this.configuration).update(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
