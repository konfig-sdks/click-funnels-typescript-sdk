...
// @ts-ignore
import { TeamAttributes } from '../models';
// @ts-ignore
import { TeamGetAll401Response } from '../models';
// @ts-ignore
import { TeamGetSingle401Response } from '../models';
// @ts-ignore
import { TeamGetSingle404Response } from '../models';
// @ts-ignore
import { TeamGetSingleResponse } from '../models';
// @ts-ignore
import { TeamUpdateTeamById401Response } from '../models';
// @ts-ignore
import { TeamUpdateTeamById404Response } from '../models';
// @ts-ignore
import { TeamUpdateTeamByIdRequest } from '../models';
// @ts-ignore
import { TeamUpdateTeamByIdResponse } from '../models';
...
export const TeamApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAll: async (after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @summary Update Team
         * @param {string} id 
         * @param {TeamUpdateTeamByIdRequest} teamUpdateTeamByIdRequest Information about updated fields in Team
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateTeamById: async (id: string, teamUpdateTeamByIdRequest: TeamUpdateTeamByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateTeamById', 'id', id)
            // verify required parameter 'teamUpdateTeamByIdRequest' is not null or undefined
            assertParamExists('updateTeamById', 'teamUpdateTeamByIdRequest', teamUpdateTeamByIdRequest)
            const localVarPath = `/teams/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: teamUpdateTeamByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(teamUpdateTeamByIdRequest, localVarRequestOptions, configuration)
...
export const TeamApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * List all teams for the current account
         * @summary List Teams
         * @param {TeamApiGetAllRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAll(requestParameters: TeamApiGetAllRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TeamAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAll(requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a single team
         * @summary Fetch Team
         * @param {TeamApiGetSingleRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSingle(requestParameters: TeamApiGetSingleRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TeamAttributes>> {
         ...
         * List all teams for the current account
         * @summary Update Team
         * @param {TeamApiUpdateTeamByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateTeamById(requestParameters: TeamApiUpdateTeamByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TeamAttributes>> {
            const teamUpdateTeamByIdRequest: TeamUpdateTeamByIdRequest = {
                team: requestParameters.team
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateTeamById(requestParameters.id, teamUpdateTeamByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const TeamApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAll(requestParameters: TeamApiGetAllRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<TeamAttributes>> {
         ...
         * @throws {RequiredError}
         */
        getSingle(requestParameters: TeamApiGetSingleRequest, options?: AxiosRequestConfig): AxiosPromise<TeamAttributes> {
         ...
         * @throws {RequiredError}
         */
        updateTeamById(requestParameters: TeamApiUpdateTeamByIdRequest, options?: AxiosRequestConfig): AxiosPromise<TeamAttributes> {
            return localVarFp.updateTeamById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAll operation in TeamApi.
 * @export
 * @interface TeamApiGetAllRequest
 */
export type TeamApiGetAllRequest = {
    
    /**
    * ID of item after which the collection should be returned
    * @type {string}
    * @memberof TeamApiGetAll
    */
...
/**
 * Request parameters for getSingle operation in TeamApi.
 * @export
 * @interface TeamApiGetSingleRequest
 */
export type TeamApiGetSingleRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof TeamApiGetSingle
    */
    readonly id: string
...
/**
 * Request parameters for updateTeamById operation in TeamApi.
 * @export
 * @interface TeamApiUpdateTeamByIdRequest
 */
export type TeamApiUpdateTeamByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof TeamApiUpdateTeamById
    */
    readonly id: string
...
export class TeamApiGenerated extends BaseAPI {
     ...
     */
    public getAll(requestParameters: TeamApiGetAllRequest = {}, options?: AxiosRequestConfig) {
        return TeamApiFp(this.configuration).getAll(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TeamApiGenerated
     */
    public getSingle(requestParameters: TeamApiGetSingleRequest, options?: AxiosRequestConfig) {
        return TeamApiFp(this.configuration).getSingle(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TeamApiGenerated
     */
    public updateTeamById(requestParameters: TeamApiUpdateTeamByIdRequest, options?: AxiosRequestConfig) {
        return TeamApiFp(this.configuration).updateTeamById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
