...
// @ts-ignore
import { WebhooksOutgoingEventAttributes } from '../models';
// @ts-ignore
import { WebhooksOutgoingEventGetForWorkspace404Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEventGetForWorkspaceResponse } from '../models';
// @ts-ignore
import { WebhooksOutgoingEventListForWorkspace401Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEventListForWorkspace404Response } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * WebhooksOutgoingEventApi - axios parameter creator
 * @export
 */
export const WebhooksOutgoingEventApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        getForWorkspace: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/webhooks/outgoing/events/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/webhooks/outgoing/events/{id}',
                httpMethod: 'GET'
            });
        ...
        listForWorkspace: async (workspaceId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/workspaces/{workspace_id}/webhooks/outgoing/events`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/webhooks/outgoing/events',
                httpMethod: 'GET'
            });
...
/**
 * WebhooksOutgoingEventApi - functional programming interface
 * @export
 */
export const WebhooksOutgoingEventApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = WebhooksOutgoingEventApiAxiosParamCreator(configuration)
    return {
        /**
         * Retrieve an webhook event for a workspace
         * @summary Fetch Event
         * @param {WebhooksOutgoingEventApiGetForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getForWorkspace(requestParameters: WebhooksOutgoingEventApiGetForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhooksOutgoingEventAttributes>> {
         ...
         * List webhook events for a workspace
         * @summary List Events
         * @param {WebhooksOutgoingEventApiListForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listForWorkspace(requestParameters: WebhooksOutgoingEventApiListForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WebhooksOutgoingEventAttributes>>> {
...
/**
 * WebhooksOutgoingEventApi - factory interface
 * @export
 */
export const WebhooksOutgoingEventApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = WebhooksOutgoingEventApiFp(configuration)
    return {
        /**
         * Retrieve an webhook event for a workspace
         * @summary Fetch Event
         ...
         * @throws {RequiredError}
         */
        getForWorkspace(requestParameters: WebhooksOutgoingEventApiGetForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<WebhooksOutgoingEventAttributes> {
         ...
         * @throws {RequiredError}
         */
        listForWorkspace(requestParameters: WebhooksOutgoingEventApiListForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<Array<WebhooksOutgoingEventAttributes>> {
...
/**
 * Request parameters for getForWorkspace operation in WebhooksOutgoingEventApi.
 * @export
 * @interface WebhooksOutgoingEventApiGetForWorkspaceRequest
 */
export type WebhooksOutgoingEventApiGetForWorkspaceRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof WebhooksOutgoingEventApiGetForWorkspace
    */
    readonly id: string
...
/**
 * Request parameters for listForWorkspace operation in WebhooksOutgoingEventApi.
 * @export
 * @interface WebhooksOutgoingEventApiListForWorkspaceRequest
 */
export type WebhooksOutgoingEventApiListForWorkspaceRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof WebhooksOutgoingEventApiListForWorkspace
    */
...
/**
 * WebhooksOutgoingEventApiGenerated - object-oriented interface
 * @export
 * @class WebhooksOutgoingEventApiGenerated
 * @extends {BaseAPI}
 */
export class WebhooksOutgoingEventApiGenerated extends BaseAPI {
    /**
     * Retrieve an webhook event for a workspace
     * @summary Fetch Event
     * @param {WebhooksOutgoingEventApiGetForWorkspaceRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof WebhooksOutgoingEventApiGenerated
     */
    public getForWorkspace(requestParameters: WebhooksOutgoingEventApiGetForWorkspaceRequest, options?: AxiosRequestConfig) {
        return WebhooksOutgoingEventApiFp(this.configuration).getForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhooksOutgoingEventApiGenerated
     */
    public listForWorkspace(requestParameters: WebhooksOutgoingEventApiListForWorkspaceRequest, options?: AxiosRequestConfig) {
        return WebhooksOutgoingEventApiFp(this.configuration).listForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
