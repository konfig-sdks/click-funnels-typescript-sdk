...
// @ts-ignore
import { CourseAttributes } from '../models';
// @ts-ignore
import { CourseGetById404Response } from '../models';
// @ts-ignore
import { CourseGetByIdResponse } from '../models';
// @ts-ignore
import { CourseListForWorkspace401Response } from '../models';
// @ts-ignore
import { CourseListForWorkspace404Response } from '../models';
...
export const CourseApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        listForWorkspace: async (workspaceId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/workspaces/{workspace_id}/courses`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/courses',
                httpMethod: 'GET'
            });
...
export const CourseApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Retrieve a course
         * @summary Fetch Course
         * @param {CourseApiGetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getById(requestParameters: CourseApiGetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CourseAttributes>> {
         ...
         * List courses for a team
         * @summary List Courses
         * @param {CourseApiListForWorkspaceRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listForWorkspace(requestParameters: CourseApiListForWorkspaceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CourseAttributes>>> {
...
export const CourseApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getById(requestParameters: CourseApiGetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<CourseAttributes> {
         ...
         * @throws {RequiredError}
         */
        listForWorkspace(requestParameters: CourseApiListForWorkspaceRequest, options?: AxiosRequestConfig): AxiosPromise<Array<CourseAttributes>> {
...
/**
 * Request parameters for getById operation in CourseApi.
 * @export
 * @interface CourseApiGetByIdRequest
 */
export type CourseApiGetByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof CourseApiGetById
    */
    readonly id: string
...
/**
 * Request parameters for listForWorkspace operation in CourseApi.
 * @export
 * @interface CourseApiListForWorkspaceRequest
 */
export type CourseApiListForWorkspaceRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof CourseApiListForWorkspace
    */
...
/**
 * CourseApiGenerated - object-oriented interface
 * @export
 * @class CourseApiGenerated
 * @extends {BaseAPI}
 */
export class CourseApiGenerated extends BaseAPI {
    /**
     * Retrieve a course
     * @summary Fetch Course
     * @param {CourseApiGetByIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CourseApiGenerated
     */
    public getById(requestParameters: CourseApiGetByIdRequest, options?: AxiosRequestConfig) {
        return CourseApiFp(this.configuration).getById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CourseApiGenerated
     */
    public listForWorkspace(requestParameters: CourseApiListForWorkspaceRequest, options?: AxiosRequestConfig) {
        return CourseApiFp(this.configuration).listForWorkspace(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
