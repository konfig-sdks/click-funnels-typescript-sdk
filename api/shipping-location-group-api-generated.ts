...
// @ts-ignore
import { ShippingLocationGroupAttributes } from '../models';
// @ts-ignore
import { ShippingLocationGroupGetProfileLocationGroup404Response } from '../models';
// @ts-ignore
import { ShippingLocationGroupGetProfileLocationGroupResponse } from '../models';
// @ts-ignore
import { ShippingLocationGroupList401Response } from '../models';
// @ts-ignore
import { ShippingLocationGroupList404Response } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ShippingLocationGroupApi - axios parameter creator
 * @export
 */
export const ShippingLocationGroupApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getProfileLocationGroup: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getProfileLocationGroup', 'id', id)
            const localVarPath = `/shipping/location_groups/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/shipping/location_groups/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        list: async (profileId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'profileId' is not null or undefined
            assertParamExists('list', 'profileId', profileId)
            const localVarPath = `/shipping/profiles/{profile_id}/location_groups`
                .replace(`{${"profile_id"}}`, encodeURIComponent(String(profileId !== undefined ? profileId : `-profile_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/shipping/profiles/{profile_id}/location_groups',
                httpMethod: 'GET'
            });
...
/**
 * ShippingLocationGroupApi - functional programming interface
 * @export
 */
export const ShippingLocationGroupApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ShippingLocationGroupApiAxiosParamCreator(configuration)
    return {
        /**
         * Retrieve a location group for a profile
         * @summary Fetch Location Group
         * @param {ShippingLocationGroupApiGetProfileLocationGroupRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getProfileLocationGroup(requestParameters: ShippingLocationGroupApiGetProfileLocationGroupRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ShippingLocationGroupAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProfileLocationGroup(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List location groups for a profile
         * @summary List Location Groups
         * @param {ShippingLocationGroupApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: ShippingLocationGroupApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ShippingLocationGroupAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.profileId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ShippingLocationGroupApi - factory interface
 * @export
 */
export const ShippingLocationGroupApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ShippingLocationGroupApiFp(configuration)
    return {
        /**
         * Retrieve a location group for a profile
         * @summary Fetch Location Group
         ...
         * @throws {RequiredError}
         */
        getProfileLocationGroup(requestParameters: ShippingLocationGroupApiGetProfileLocationGroupRequest, options?: AxiosRequestConfig): AxiosPromise<ShippingLocationGroupAttributes> {
            return localVarFp.getProfileLocationGroup(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List location groups for a profile
         * @summary List Location Groups
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: ShippingLocationGroupApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ShippingLocationGroupAttributes>> {
...
/**
 * Request parameters for getProfileLocationGroup operation in ShippingLocationGroupApi.
 * @export
 * @interface ShippingLocationGroupApiGetProfileLocationGroupRequest
 */
export type ShippingLocationGroupApiGetProfileLocationGroupRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ShippingLocationGroupApiGetProfileLocationGroup
    */
    readonly id: string
...
/**
 * Request parameters for list operation in ShippingLocationGroupApi.
 * @export
 * @interface ShippingLocationGroupApiListRequest
 */
export type ShippingLocationGroupApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ShippingLocationGroupApiList
    */
...
/**
 * ShippingLocationGroupApiGenerated - object-oriented interface
 * @export
 * @class ShippingLocationGroupApiGenerated
 * @extends {BaseAPI}
 */
export class ShippingLocationGroupApiGenerated extends BaseAPI {
    /**
     * Retrieve a location group for a profile
     * @summary Fetch Location Group
     * @param {ShippingLocationGroupApiGetProfileLocationGroupRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ShippingLocationGroupApiGenerated
     */
    public getProfileLocationGroup(requestParameters: ShippingLocationGroupApiGetProfileLocationGroupRequest, options?: AxiosRequestConfig) {
        return ShippingLocationGroupApiFp(this.configuration).getProfileLocationGroup(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ShippingLocationGroupApiGenerated
     */
    public list(requestParameters: ShippingLocationGroupApiListRequest, options?: AxiosRequestConfig) {
        return ShippingLocationGroupApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
