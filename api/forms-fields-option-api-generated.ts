...
// @ts-ignore
import { FormsFieldsOptionAttributes } from '../models';
// @ts-ignore
import { FormsFieldsOptionCreateNewFieldOption401Response } from '../models';
// @ts-ignore
import { FormsFieldsOptionCreateNewFieldOptionRequest } from '../models';
// @ts-ignore
import { FormsFieldsOptionCreateNewFieldOptionResponse } from '../models';
// @ts-ignore
import { FormsFieldsOptionDeleteOptionForField404Response } from '../models';
// @ts-ignore
import { FormsFieldsOptionDeleteOptionForFieldResponse } from '../models';
// @ts-ignore
import { FormsFieldsOptionGetFieldOption404Response } from '../models';
// @ts-ignore
import { FormsFieldsOptionGetFieldOptionResponse } from '../models';
// @ts-ignore
import { FormsFieldsOptionList401Response } from '../models';
// @ts-ignore
import { FormsFieldsOptionList404Response } from '../models';
// @ts-ignore
import { FormsFieldsOptionUpdateFieldOption401Response } from '../models';
// @ts-ignore
import { FormsFieldsOptionUpdateFieldOption404Response } from '../models';
// @ts-ignore
import { FormsFieldsOptionUpdateFieldOptionRequest } from '../models';
// @ts-ignore
import { FormsFieldsOptionUpdateFieldOptionResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * FormsFieldsOptionApi - axios parameter creator
 * @export
 */
export const FormsFieldsOptionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new option to a field
         * @summary Create Option
         * @param {number} fieldId 
         * @param {FormsFieldsOptionCreateNewFieldOptionRequest} formsFieldsOptionCreateNewFieldOptionRequest Information about a new Option
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewFieldOption: async (fieldId: number, formsFieldsOptionCreateNewFieldOptionRequest: FormsFieldsOptionCreateNewFieldOptionRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fieldId' is not null or undefined
            assertParamExists('createNewFieldOption', 'fieldId', fieldId)
            // verify required parameter 'formsFieldsOptionCreateNewFieldOptionRequest' is not null or undefined
            assertParamExists('createNewFieldOption', 'formsFieldsOptionCreateNewFieldOptionRequest', formsFieldsOptionCreateNewFieldOptionRequest)
            const localVarPath = `/forms/fields/{field_id}/options`
                .replace(`{${"field_id"}}`, encodeURIComponent(String(fieldId !== undefined ? fieldId : `-field_id-`)));
            ...
            requestBeforeHook({
                requestBody: formsFieldsOptionCreateNewFieldOptionRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/forms/fields/{field_id}/options',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(formsFieldsOptionCreateNewFieldOptionRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        deleteOptionForField: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('deleteOptionForField', 'id', id)
            const localVarPath = `/forms/fields/options/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/forms/fields/options/{id}',
                httpMethod: 'DELETE'
            });
         ...
         * @throws {RequiredError}
         */
        getFieldOption: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getFieldOption', 'id', id)
            const localVarPath = `/forms/fields/options/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        list: async (fieldId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fieldId' is not null or undefined
            assertParamExists('list', 'fieldId', fieldId)
            const localVarPath = `/forms/fields/{field_id}/options`
                .replace(`{${"field_id"}}`, encodeURIComponent(String(fieldId !== undefined ? fieldId : `-field_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {string} id 
         * @param {FormsFieldsOptionUpdateFieldOptionRequest} formsFieldsOptionUpdateFieldOptionRequest Information about updated fields in Option
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateFieldOption: async (id: string, formsFieldsOptionUpdateFieldOptionRequest: FormsFieldsOptionUpdateFieldOptionRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateFieldOption', 'id', id)
            // verify required parameter 'formsFieldsOptionUpdateFieldOptionRequest' is not null or undefined
            assertParamExists('updateFieldOption', 'formsFieldsOptionUpdateFieldOptionRequest', formsFieldsOptionUpdateFieldOptionRequest)
            const localVarPath = `/forms/fields/options/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: formsFieldsOptionUpdateFieldOptionRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(formsFieldsOptionUpdateFieldOptionRequest, localVarRequestOptions, configuration)
...
/**
 * FormsFieldsOptionApi - functional programming interface
 * @export
 */
export const FormsFieldsOptionApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = FormsFieldsOptionApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new option to a field
         * @summary Create Option
         * @param {FormsFieldsOptionApiCreateNewFieldOptionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewFieldOption(requestParameters: FormsFieldsOptionApiCreateNewFieldOptionRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldsOptionAttributes>> {
            const formsFieldsOptionCreateNewFieldOptionRequest: FormsFieldsOptionCreateNewFieldOptionRequest = {
                forms_fields_option: requestParameters.forms_fields_option
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewFieldOption(requestParameters.fieldId, formsFieldsOptionCreateNewFieldOptionRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a option for a field
         * @summary Remove Option
         * @param {FormsFieldsOptionApiDeleteOptionForFieldRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteOptionForField(requestParameters: FormsFieldsOptionApiDeleteOptionForFieldRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteOptionForField(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a option for a field
         * @summary Fetch Option
         * @param {FormsFieldsOptionApiGetFieldOptionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getFieldOption(requestParameters: FormsFieldsOptionApiGetFieldOptionRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldsOptionAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getFieldOption(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List options for a field
         * @summary List Options
         * @param {FormsFieldsOptionApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: FormsFieldsOptionApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FormsFieldsOptionAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.fieldId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a option for a field
         * @summary Update Option
         * @param {FormsFieldsOptionApiUpdateFieldOptionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateFieldOption(requestParameters: FormsFieldsOptionApiUpdateFieldOptionRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldsOptionAttributes>> {
            const formsFieldsOptionUpdateFieldOptionRequest: FormsFieldsOptionUpdateFieldOptionRequest = {
                forms_fields_option: requestParameters.forms_fields_option
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateFieldOption(requestParameters.id, formsFieldsOptionUpdateFieldOptionRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * FormsFieldsOptionApi - factory interface
 * @export
 */
export const FormsFieldsOptionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = FormsFieldsOptionApiFp(configuration)
    return {
        /**
         * Add a new option to a field
         * @summary Create Option
         ...
         * @throws {RequiredError}
         */
        createNewFieldOption(requestParameters: FormsFieldsOptionApiCreateNewFieldOptionRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldsOptionAttributes> {
            return localVarFp.createNewFieldOption(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a option for a field
         * @summary Remove Option
         ...
         * @throws {RequiredError}
         */
        deleteOptionForField(requestParameters: FormsFieldsOptionApiDeleteOptionForFieldRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteOptionForField(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a option for a field
         * @summary Fetch Option
         ...
         * @throws {RequiredError}
         */
        getFieldOption(requestParameters: FormsFieldsOptionApiGetFieldOptionRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldsOptionAttributes> {
            return localVarFp.getFieldOption(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List options for a field
         * @summary List Options
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: FormsFieldsOptionApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<FormsFieldsOptionAttributes>> {
         ...
         * @throws {RequiredError}
         */
        updateFieldOption(requestParameters: FormsFieldsOptionApiUpdateFieldOptionRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldsOptionAttributes> {
            return localVarFp.updateFieldOption(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewFieldOption operation in FormsFieldsOptionApi.
 * @export
 * @interface FormsFieldsOptionApiCreateNewFieldOptionRequest
 */
export type FormsFieldsOptionApiCreateNewFieldOptionRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormsFieldsOptionApiCreateNewFieldOption
    */
...
/**
 * Request parameters for deleteOptionForField operation in FormsFieldsOptionApi.
 * @export
 * @interface FormsFieldsOptionApiDeleteOptionForFieldRequest
 */
export type FormsFieldsOptionApiDeleteOptionForFieldRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldsOptionApiDeleteOptionForField
    */
    readonly id: string
...
/**
 * Request parameters for getFieldOption operation in FormsFieldsOptionApi.
 * @export
 * @interface FormsFieldsOptionApiGetFieldOptionRequest
 */
export type FormsFieldsOptionApiGetFieldOptionRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldsOptionApiGetFieldOption
    */
    readonly id: string
...
/**
 * Request parameters for list operation in FormsFieldsOptionApi.
 * @export
 * @interface FormsFieldsOptionApiListRequest
 */
export type FormsFieldsOptionApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormsFieldsOptionApiList
    */
    readonly fieldId: number
...
/**
 * Request parameters for updateFieldOption operation in FormsFieldsOptionApi.
 * @export
 * @interface FormsFieldsOptionApiUpdateFieldOptionRequest
 */
export type FormsFieldsOptionApiUpdateFieldOptionRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldsOptionApiUpdateFieldOption
    */
    readonly id: string
...
/**
 * FormsFieldsOptionApiGenerated - object-oriented interface
 * @export
 * @class FormsFieldsOptionApiGenerated
 * @extends {BaseAPI}
 */
export class FormsFieldsOptionApiGenerated extends BaseAPI {
    /**
     * Add a new option to a field
     * @summary Create Option
     * @param {FormsFieldsOptionApiCreateNewFieldOptionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FormsFieldsOptionApiGenerated
     */
    public createNewFieldOption(requestParameters: FormsFieldsOptionApiCreateNewFieldOptionRequest, options?: AxiosRequestConfig) {
        return FormsFieldsOptionApiFp(this.configuration).createNewFieldOption(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldsOptionApiGenerated
     */
    public deleteOptionForField(requestParameters: FormsFieldsOptionApiDeleteOptionForFieldRequest, options?: AxiosRequestConfig) {
        return FormsFieldsOptionApiFp(this.configuration).deleteOptionForField(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldsOptionApiGenerated
     */
    public getFieldOption(requestParameters: FormsFieldsOptionApiGetFieldOptionRequest, options?: AxiosRequestConfig) {
        return FormsFieldsOptionApiFp(this.configuration).getFieldOption(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldsOptionApiGenerated
     */
    public list(requestParameters: FormsFieldsOptionApiListRequest, options?: AxiosRequestConfig) {
        return FormsFieldsOptionApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldsOptionApiGenerated
     */
    public updateFieldOption(requestParameters: FormsFieldsOptionApiUpdateFieldOptionRequest, options?: AxiosRequestConfig) {
        return FormsFieldsOptionApiFp(this.configuration).updateFieldOption(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
