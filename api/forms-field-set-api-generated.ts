...
// @ts-ignore
import { FormsFieldSetAttributes } from '../models';
// @ts-ignore
import { FormsFieldSetCreateNewFieldSet401Response } from '../models';
// @ts-ignore
import { FormsFieldSetCreateNewFieldSetRequest } from '../models';
// @ts-ignore
import { FormsFieldSetCreateNewFieldSetResponse } from '../models';
// @ts-ignore
import { FormsFieldSetGetFieldSet404Response } from '../models';
// @ts-ignore
import { FormsFieldSetGetFieldSetResponse } from '../models';
// @ts-ignore
import { FormsFieldSetList401Response } from '../models';
// @ts-ignore
import { FormsFieldSetList404Response } from '../models';
// @ts-ignore
import { FormsFieldSetRemove404Response } from '../models';
// @ts-ignore
import { FormsFieldSetRemoveResponse } from '../models';
// @ts-ignore
import { FormsFieldSetUpdateFieldSetById401Response } from '../models';
// @ts-ignore
import { FormsFieldSetUpdateFieldSetById404Response } from '../models';
// @ts-ignore
import { FormsFieldSetUpdateFieldSetByIdRequest } from '../models';
// @ts-ignore
import { FormsFieldSetUpdateFieldSetByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * FormsFieldSetApi - axios parameter creator
 * @export
 */
export const FormsFieldSetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new field set
         * @summary Create Field Set
         * @param {number} formId 
         * @param {FormsFieldSetCreateNewFieldSetRequest} formsFieldSetCreateNewFieldSetRequest Information about a new Field Set
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewFieldSet: async (formId: number, formsFieldSetCreateNewFieldSetRequest: FormsFieldSetCreateNewFieldSetRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'formId' is not null or undefined
            assertParamExists('createNewFieldSet', 'formId', formId)
            // verify required parameter 'formsFieldSetCreateNewFieldSetRequest' is not null or undefined
            assertParamExists('createNewFieldSet', 'formsFieldSetCreateNewFieldSetRequest', formsFieldSetCreateNewFieldSetRequest)
            const localVarPath = `/forms/{form_id}/field_sets`
            ...
            requestBeforeHook({
                requestBody: formsFieldSetCreateNewFieldSetRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/forms/{form_id}/field_sets',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(formsFieldSetCreateNewFieldSetRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getFieldSet: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getFieldSet', 'id', id)
            const localVarPath = `/forms/field_sets/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/forms/field_sets/{id}',
                httpMethod: 'GET'
            });
         ...
         * @param {string} id 
         * @param {FormsFieldSetUpdateFieldSetByIdRequest} formsFieldSetUpdateFieldSetByIdRequest Information about updated fields in Field Set
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateFieldSetById: async (id: string, formsFieldSetUpdateFieldSetByIdRequest: FormsFieldSetUpdateFieldSetByIdRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateFieldSetById', 'id', id)
            // verify required parameter 'formsFieldSetUpdateFieldSetByIdRequest' is not null or undefined
            assertParamExists('updateFieldSetById', 'formsFieldSetUpdateFieldSetByIdRequest', formsFieldSetUpdateFieldSetByIdRequest)
            const localVarPath = `/forms/field_sets/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: formsFieldSetUpdateFieldSetByIdRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(formsFieldSetUpdateFieldSetByIdRequest, localVarRequestOptions, configuration)
...
/**
 * FormsFieldSetApi - functional programming interface
 * @export
 */
export const FormsFieldSetApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = FormsFieldSetApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new field set
         * @summary Create Field Set
         * @param {FormsFieldSetApiCreateNewFieldSetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewFieldSet(requestParameters: FormsFieldSetApiCreateNewFieldSetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldSetAttributes>> {
            const formsFieldSetCreateNewFieldSetRequest: FormsFieldSetCreateNewFieldSetRequest = {
                forms_field_set: requestParameters.forms_field_set
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewFieldSet(requestParameters.formId, formsFieldSetCreateNewFieldSetRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a field set
         * @summary Fetch Field Set
         * @param {FormsFieldSetApiGetFieldSetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getFieldSet(requestParameters: FormsFieldSetApiGetFieldSetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldSetAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getFieldSet(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List field sets for a form
         * @summary List Field Sets
         * @param {FormsFieldSetApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: FormsFieldSetApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FormsFieldSetAttributes>>> {
         ...
         * Delete a field set
         * @summary Remove Field Set
         * @param {FormsFieldSetApiRemoveRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async remove(requestParameters: FormsFieldSetApiRemoveRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * Update a field set
         * @summary Update Field Set
         * @param {FormsFieldSetApiUpdateFieldSetByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateFieldSetById(requestParameters: FormsFieldSetApiUpdateFieldSetByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormsFieldSetAttributes>> {
            const formsFieldSetUpdateFieldSetByIdRequest: FormsFieldSetUpdateFieldSetByIdRequest = {
                forms_field_set: requestParameters.forms_field_set
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateFieldSetById(requestParameters.id, formsFieldSetUpdateFieldSetByIdRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * FormsFieldSetApi - factory interface
 * @export
 */
export const FormsFieldSetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = FormsFieldSetApiFp(configuration)
    return {
        /**
         * Add a new field set
         * @summary Create Field Set
         ...
         * @throws {RequiredError}
         */
        createNewFieldSet(requestParameters: FormsFieldSetApiCreateNewFieldSetRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldSetAttributes> {
            return localVarFp.createNewFieldSet(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a field set
         * @summary Fetch Field Set
         ...
         * @throws {RequiredError}
         */
        getFieldSet(requestParameters: FormsFieldSetApiGetFieldSetRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldSetAttributes> {
            return localVarFp.getFieldSet(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List field sets for a form
         * @summary List Field Sets
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: FormsFieldSetApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<FormsFieldSetAttributes>> {
         ...
         * @throws {RequiredError}
         */
        remove(requestParameters: FormsFieldSetApiRemoveRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateFieldSetById(requestParameters: FormsFieldSetApiUpdateFieldSetByIdRequest, options?: AxiosRequestConfig): AxiosPromise<FormsFieldSetAttributes> {
            return localVarFp.updateFieldSetById(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewFieldSet operation in FormsFieldSetApi.
 * @export
 * @interface FormsFieldSetApiCreateNewFieldSetRequest
 */
export type FormsFieldSetApiCreateNewFieldSetRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormsFieldSetApiCreateNewFieldSet
    */
...
/**
 * Request parameters for getFieldSet operation in FormsFieldSetApi.
 * @export
 * @interface FormsFieldSetApiGetFieldSetRequest
 */
export type FormsFieldSetApiGetFieldSetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldSetApiGetFieldSet
    */
    readonly id: string
...
/**
 * Request parameters for list operation in FormsFieldSetApi.
 * @export
 * @interface FormsFieldSetApiListRequest
 */
export type FormsFieldSetApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof FormsFieldSetApiList
    */
    readonly formId: number
...
/**
 * Request parameters for remove operation in FormsFieldSetApi.
 * @export
 * @interface FormsFieldSetApiRemoveRequest
 */
export type FormsFieldSetApiRemoveRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldSetApiRemove
    */
    readonly id: string
...
/**
 * Request parameters for updateFieldSetById operation in FormsFieldSetApi.
 * @export
 * @interface FormsFieldSetApiUpdateFieldSetByIdRequest
 */
export type FormsFieldSetApiUpdateFieldSetByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof FormsFieldSetApiUpdateFieldSetById
    */
    readonly id: string
...
/**
 * FormsFieldSetApiGenerated - object-oriented interface
 * @export
 * @class FormsFieldSetApiGenerated
 * @extends {BaseAPI}
 */
export class FormsFieldSetApiGenerated extends BaseAPI {
    /**
     * Add a new field set
     * @summary Create Field Set
     * @param {FormsFieldSetApiCreateNewFieldSetRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FormsFieldSetApiGenerated
     */
    public createNewFieldSet(requestParameters: FormsFieldSetApiCreateNewFieldSetRequest, options?: AxiosRequestConfig) {
        return FormsFieldSetApiFp(this.configuration).createNewFieldSet(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldSetApiGenerated
     */
    public getFieldSet(requestParameters: FormsFieldSetApiGetFieldSetRequest, options?: AxiosRequestConfig) {
        return FormsFieldSetApiFp(this.configuration).getFieldSet(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldSetApiGenerated
     */
    public list(requestParameters: FormsFieldSetApiListRequest, options?: AxiosRequestConfig) {
        return FormsFieldSetApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldSetApiGenerated
     */
    public remove(requestParameters: FormsFieldSetApiRemoveRequest, options?: AxiosRequestConfig) {
        return FormsFieldSetApiFp(this.configuration).remove(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FormsFieldSetApiGenerated
     */
    public updateFieldSetById(requestParameters: FormsFieldSetApiUpdateFieldSetByIdRequest, options?: AxiosRequestConfig) {
        return FormsFieldSetApiFp(this.configuration).updateFieldSetById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
