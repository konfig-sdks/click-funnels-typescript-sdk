...
// @ts-ignore
import { WebhooksOutgoingEndpointAttributes } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointCreateNew401Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointCreateNewRequest } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointCreateNewResponse } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointGet404Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointGetResponse } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointListEndpoints401Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointListEndpoints404Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointUpdateEndpoint401Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointUpdateEndpoint404Response } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointUpdateEndpointRequest } from '../models';
// @ts-ignore
import { WebhooksOutgoingEndpointUpdateEndpointResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * WebhooksOutgoingEndpointApi - axios parameter creator
 * @export
 */
export const WebhooksOutgoingEndpointApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Add a new webhook endpoint to a workspace
         * @summary Create Endpoint
         * @param {number} workspaceId 
         * @param {WebhooksOutgoingEndpointCreateNewRequest} webhooksOutgoingEndpointCreateNewRequest Information about a new Endpoint
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNew: async (workspaceId: number, webhooksOutgoingEndpointCreateNewRequest: WebhooksOutgoingEndpointCreateNewRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('createNew', 'workspaceId', workspaceId)
            // verify required parameter 'webhooksOutgoingEndpointCreateNewRequest' is not null or undefined
            assertParamExists('createNew', 'webhooksOutgoingEndpointCreateNewRequest', webhooksOutgoingEndpointCreateNewRequest)
            const localVarPath = `/workspaces/{workspace_id}/webhooks/outgoing/endpoints`
            ...
            requestBeforeHook({
                requestBody: webhooksOutgoingEndpointCreateNewRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/workspaces/{workspace_id}/webhooks/outgoing/endpoints',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(webhooksOutgoingEndpointCreateNewRequest, localVarRequestOptions, configuration)
        ...
        get: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/webhooks/outgoing/endpoints/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/webhooks/outgoing/endpoints/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        listEndpoints: async (workspaceId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workspaceId' is not null or undefined
            assertParamExists('listEndpoints', 'workspaceId', workspaceId)
            const localVarPath = `/workspaces/{workspace_id}/webhooks/outgoing/endpoints`
                .replace(`{${"workspace_id"}}`, encodeURIComponent(String(workspaceId !== undefined ? workspaceId : `-workspace_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {string} id 
         * @param {WebhooksOutgoingEndpointUpdateEndpointRequest} webhooksOutgoingEndpointUpdateEndpointRequest Information about updated fields in Endpoint
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateEndpoint: async (id: string, webhooksOutgoingEndpointUpdateEndpointRequest: WebhooksOutgoingEndpointUpdateEndpointRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateEndpoint', 'id', id)
            // verify required parameter 'webhooksOutgoingEndpointUpdateEndpointRequest' is not null or undefined
            assertParamExists('updateEndpoint', 'webhooksOutgoingEndpointUpdateEndpointRequest', webhooksOutgoingEndpointUpdateEndpointRequest)
            const localVarPath = `/webhooks/outgoing/endpoints/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: webhooksOutgoingEndpointUpdateEndpointRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(webhooksOutgoingEndpointUpdateEndpointRequest, localVarRequestOptions, configuration)
...
/**
 * WebhooksOutgoingEndpointApi - functional programming interface
 * @export
 */
export const WebhooksOutgoingEndpointApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = WebhooksOutgoingEndpointApiAxiosParamCreator(configuration)
    return {
        /**
         * Add a new webhook endpoint to a workspace
         * @summary Create Endpoint
         * @param {WebhooksOutgoingEndpointApiCreateNewRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNew(requestParameters: WebhooksOutgoingEndpointApiCreateNewRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhooksOutgoingEndpointAttributes>> {
            const webhooksOutgoingEndpointCreateNewRequest: WebhooksOutgoingEndpointCreateNewRequest = {
                webhooks_outgoing_endpoint: requestParameters.webhooks_outgoing_endpoint
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNew(requestParameters.workspaceId, webhooksOutgoingEndpointCreateNewRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a webhook endpoint for a workspace
         * @summary Fetch Endpoint
         * @param {WebhooksOutgoingEndpointApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: WebhooksOutgoingEndpointApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhooksOutgoingEndpointAttributes>> {
         ...
         * List webhook endpoints for a workspace
         * @summary List Endpoints
         * @param {WebhooksOutgoingEndpointApiListEndpointsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listEndpoints(requestParameters: WebhooksOutgoingEndpointApiListEndpointsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WebhooksOutgoingEndpointAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listEndpoints(requestParameters.workspaceId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a webhook endpoint for a workspace
         * @summary Update Endpoint
         * @param {WebhooksOutgoingEndpointApiUpdateEndpointRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateEndpoint(requestParameters: WebhooksOutgoingEndpointApiUpdateEndpointRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhooksOutgoingEndpointAttributes>> {
            const webhooksOutgoingEndpointUpdateEndpointRequest: WebhooksOutgoingEndpointUpdateEndpointRequest = {
                webhooks_outgoing_endpoint: requestParameters.webhooks_outgoing_endpoint
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateEndpoint(requestParameters.id, webhooksOutgoingEndpointUpdateEndpointRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * WebhooksOutgoingEndpointApi - factory interface
 * @export
 */
export const WebhooksOutgoingEndpointApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = WebhooksOutgoingEndpointApiFp(configuration)
    return {
        /**
         * Add a new webhook endpoint to a workspace
         * @summary Create Endpoint
         ...
         * @throws {RequiredError}
         */
        createNew(requestParameters: WebhooksOutgoingEndpointApiCreateNewRequest, options?: AxiosRequestConfig): AxiosPromise<WebhooksOutgoingEndpointAttributes> {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: WebhooksOutgoingEndpointApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<WebhooksOutgoingEndpointAttributes> {
         ...
         * @throws {RequiredError}
         */
        listEndpoints(requestParameters: WebhooksOutgoingEndpointApiListEndpointsRequest, options?: AxiosRequestConfig): AxiosPromise<Array<WebhooksOutgoingEndpointAttributes>> {
         ...
         * @throws {RequiredError}
         */
        updateEndpoint(requestParameters: WebhooksOutgoingEndpointApiUpdateEndpointRequest, options?: AxiosRequestConfig): AxiosPromise<WebhooksOutgoingEndpointAttributes> {
...
/**
 * Request parameters for createNew operation in WebhooksOutgoingEndpointApi.
 * @export
 * @interface WebhooksOutgoingEndpointApiCreateNewRequest
 */
export type WebhooksOutgoingEndpointApiCreateNewRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof WebhooksOutgoingEndpointApiCreateNew
    */
...
/**
 * Request parameters for get operation in WebhooksOutgoingEndpointApi.
 * @export
 * @interface WebhooksOutgoingEndpointApiGetRequest
 */
export type WebhooksOutgoingEndpointApiGetRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof WebhooksOutgoingEndpointApiGet
    */
    readonly id: string
...
/**
 * Request parameters for listEndpoints operation in WebhooksOutgoingEndpointApi.
 * @export
 * @interface WebhooksOutgoingEndpointApiListEndpointsRequest
 */
export type WebhooksOutgoingEndpointApiListEndpointsRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof WebhooksOutgoingEndpointApiListEndpoints
    */
    readonly workspaceId: number
...
/**
 * Request parameters for updateEndpoint operation in WebhooksOutgoingEndpointApi.
 * @export
 * @interface WebhooksOutgoingEndpointApiUpdateEndpointRequest
 */
export type WebhooksOutgoingEndpointApiUpdateEndpointRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof WebhooksOutgoingEndpointApiUpdateEndpoint
    */
    readonly id: string
...
/**
 * WebhooksOutgoingEndpointApiGenerated - object-oriented interface
 * @export
 * @class WebhooksOutgoingEndpointApiGenerated
 * @extends {BaseAPI}
 */
export class WebhooksOutgoingEndpointApiGenerated extends BaseAPI {
    /**
     * Add a new webhook endpoint to a workspace
     * @summary Create Endpoint
     * @param {WebhooksOutgoingEndpointApiCreateNewRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof WebhooksOutgoingEndpointApiGenerated
     */
    public createNew(requestParameters: WebhooksOutgoingEndpointApiCreateNewRequest, options?: AxiosRequestConfig) {
        return WebhooksOutgoingEndpointApiFp(this.configuration).createNew(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhooksOutgoingEndpointApiGenerated
     */
    public get(requestParameters: WebhooksOutgoingEndpointApiGetRequest, options?: AxiosRequestConfig) {
        return WebhooksOutgoingEndpointApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhooksOutgoingEndpointApiGenerated
     */
    public listEndpoints(requestParameters: WebhooksOutgoingEndpointApiListEndpointsRequest, options?: AxiosRequestConfig) {
        return WebhooksOutgoingEndpointApiFp(this.configuration).listEndpoints(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhooksOutgoingEndpointApiGenerated
     */
    public updateEndpoint(requestParameters: WebhooksOutgoingEndpointApiUpdateEndpointRequest, options?: AxiosRequestConfig) {
        return WebhooksOutgoingEndpointApiFp(this.configuration).updateEndpoint(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
