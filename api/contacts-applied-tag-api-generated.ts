...
// @ts-ignore
import { ContactsAppliedTagAttributes } from '../models';
// @ts-ignore
import { ContactsAppliedTagCreateAppliedTag401Response } from '../models';
// @ts-ignore
import { ContactsAppliedTagCreateAppliedTagRequest } from '../models';
// @ts-ignore
import { ContactsAppliedTagCreateAppliedTagResponse } from '../models';
// @ts-ignore
import { ContactsAppliedTagGetForContact404Response } from '../models';
// @ts-ignore
import { ContactsAppliedTagGetForContactResponse } from '../models';
// @ts-ignore
import { ContactsAppliedTagList401Response } from '../models';
// @ts-ignore
import { ContactsAppliedTagList404Response } from '../models';
// @ts-ignore
import { ContactsAppliedTagRemoveById404Response } from '../models';
// @ts-ignore
import { ContactsAppliedTagRemoveByIdResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ContactsAppliedTagApi - axios parameter creator
 * @export
 */
export const ContactsAppliedTagApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Assign a tag to a contact by creating an applied tag
         * @summary Create Applied Tag
         * @param {number} contactId 
         * @param {ContactsAppliedTagCreateAppliedTagRequest} contactsAppliedTagCreateAppliedTagRequest Information about a new Applied Tag
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createAppliedTag: async (contactId: number, contactsAppliedTagCreateAppliedTagRequest: ContactsAppliedTagCreateAppliedTagRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'contactId' is not null or undefined
            assertParamExists('createAppliedTag', 'contactId', contactId)
            // verify required parameter 'contactsAppliedTagCreateAppliedTagRequest' is not null or undefined
            assertParamExists('createAppliedTag', 'contactsAppliedTagCreateAppliedTagRequest', contactsAppliedTagCreateAppliedTagRequest)
            const localVarPath = `/contacts/{contact_id}/applied_tags`
            ...
            requestBeforeHook({
                requestBody: contactsAppliedTagCreateAppliedTagRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/contacts/{contact_id}/applied_tags',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(contactsAppliedTagCreateAppliedTagRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getForContact: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getForContact', 'id', id)
            const localVarPath = `/contacts/applied_tags/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/contacts/applied_tags/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        list: async (contactId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'contactId' is not null or undefined
...
/**
 * ContactsAppliedTagApi - functional programming interface
 * @export
 */
export const ContactsAppliedTagApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ContactsAppliedTagApiAxiosParamCreator(configuration)
    return {
        /**
         * Assign a tag to a contact by creating an applied tag
         * @summary Create Applied Tag
         * @param {ContactsAppliedTagApiCreateAppliedTagRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createAppliedTag(requestParameters: ContactsAppliedTagApiCreateAppliedTagRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsAppliedTagAttributes>> {
            const contactsAppliedTagCreateAppliedTagRequest: ContactsAppliedTagCreateAppliedTagRequest = {
                contacts_applied_tag: requestParameters.contacts_applied_tag
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createAppliedTag(requestParameters.contactId, contactsAppliedTagCreateAppliedTagRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve an applied tag for a contact
         * @summary Fetch Applied Tag
         * @param {ContactsAppliedTagApiGetForContactRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getForContact(requestParameters: ContactsAppliedTagApiGetForContactRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsAppliedTagAttributes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getForContact(requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List the applied tags for a contact
         * @summary List Applied Tags
         * @param {ContactsAppliedTagApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: ContactsAppliedTagApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContactsAppliedTagAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.contactId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Remove a tag from a contact by deleting an applied tag
         * @summary Remove Applied Tag
         * @param {ContactsAppliedTagApiRemoveByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async removeById(requestParameters: ContactsAppliedTagApiRemoveByIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
/**
 * ContactsAppliedTagApi - factory interface
 * @export
 */
export const ContactsAppliedTagApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ContactsAppliedTagApiFp(configuration)
    return {
        /**
         * Assign a tag to a contact by creating an applied tag
         * @summary Create Applied Tag
         ...
         * @throws {RequiredError}
         */
        createAppliedTag(requestParameters: ContactsAppliedTagApiCreateAppliedTagRequest, options?: AxiosRequestConfig): AxiosPromise<ContactsAppliedTagAttributes> {
         ...
         * @throws {RequiredError}
         */
        getForContact(requestParameters: ContactsAppliedTagApiGetForContactRequest, options?: AxiosRequestConfig): AxiosPromise<ContactsAppliedTagAttributes> {
            return localVarFp.getForContact(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * List the applied tags for a contact
         * @summary List Applied Tags
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: ContactsAppliedTagApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ContactsAppliedTagAttributes>> {
         ...
         * @throws {RequiredError}
         */
        removeById(requestParameters: ContactsAppliedTagApiRemoveByIdRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
...
/**
 * Request parameters for createAppliedTag operation in ContactsAppliedTagApi.
 * @export
 * @interface ContactsAppliedTagApiCreateAppliedTagRequest
 */
export type ContactsAppliedTagApiCreateAppliedTagRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ContactsAppliedTagApiCreateAppliedTag
    */
...
/**
 * Request parameters for getForContact operation in ContactsAppliedTagApi.
 * @export
 * @interface ContactsAppliedTagApiGetForContactRequest
 */
export type ContactsAppliedTagApiGetForContactRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactsAppliedTagApiGetForContact
    */
    readonly id: string
...
/**
 * Request parameters for list operation in ContactsAppliedTagApi.
 * @export
 * @interface ContactsAppliedTagApiListRequest
 */
export type ContactsAppliedTagApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ContactsAppliedTagApiList
    */
    readonly contactId: number
...
/**
 * Request parameters for removeById operation in ContactsAppliedTagApi.
 * @export
 * @interface ContactsAppliedTagApiRemoveByIdRequest
 */
export type ContactsAppliedTagApiRemoveByIdRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ContactsAppliedTagApiRemoveById
    */
    readonly id: string
...
/**
 * ContactsAppliedTagApiGenerated - object-oriented interface
 * @export
 * @class ContactsAppliedTagApiGenerated
 * @extends {BaseAPI}
 */
export class ContactsAppliedTagApiGenerated extends BaseAPI {
    /**
     * Assign a tag to a contact by creating an applied tag
     * @summary Create Applied Tag
     * @param {ContactsAppliedTagApiCreateAppliedTagRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ContactsAppliedTagApiGenerated
     */
    public createAppliedTag(requestParameters: ContactsAppliedTagApiCreateAppliedTagRequest, options?: AxiosRequestConfig) {
        return ContactsAppliedTagApiFp(this.configuration).createAppliedTag(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactsAppliedTagApiGenerated
     */
    public getForContact(requestParameters: ContactsAppliedTagApiGetForContactRequest, options?: AxiosRequestConfig) {
        return ContactsAppliedTagApiFp(this.configuration).getForContact(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactsAppliedTagApiGenerated
     */
    public list(requestParameters: ContactsAppliedTagApiListRequest, options?: AxiosRequestConfig) {
        return ContactsAppliedTagApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContactsAppliedTagApiGenerated
     */
    public removeById(requestParameters: ContactsAppliedTagApiRemoveByIdRequest, options?: AxiosRequestConfig) {
        return ContactsAppliedTagApiFp(this.configuration).removeById(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
