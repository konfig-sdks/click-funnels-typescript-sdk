...
// @ts-ignore
import { ProductsVariantAttributes } from '../models';
// @ts-ignore
import { ProductsVariantCreateNewVariant401Response } from '../models';
// @ts-ignore
import { ProductsVariantCreateNewVariantRequest } from '../models';
// @ts-ignore
import { ProductsVariantCreateNewVariantResponse } from '../models';
// @ts-ignore
import { ProductsVariantGetSingle404Response } from '../models';
// @ts-ignore
import { ProductsVariantGetSingleResponse } from '../models';
// @ts-ignore
import { ProductsVariantList401Response } from '../models';
// @ts-ignore
import { ProductsVariantList404Response } from '../models';
// @ts-ignore
import { ProductsVariantUpdateSingle401Response } from '../models';
// @ts-ignore
import { ProductsVariantUpdateSingle404Response } from '../models';
// @ts-ignore
import { ProductsVariantUpdateSingleRequest } from '../models';
// @ts-ignore
import { ProductsVariantUpdateSingleResponse } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * ProductsVariantApi - axios parameter creator
 * @export
 */
export const ProductsVariantApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Create a new variant for a product
         * @summary Create Variant
         * @param {number} productId 
         * @param {ProductsVariantCreateNewVariantRequest} productsVariantCreateNewVariantRequest Information about a new Variant
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createNewVariant: async (productId: number, productsVariantCreateNewVariantRequest: ProductsVariantCreateNewVariantRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'productId' is not null or undefined
            assertParamExists('createNewVariant', 'productId', productId)
            // verify required parameter 'productsVariantCreateNewVariantRequest' is not null or undefined
            assertParamExists('createNewVariant', 'productsVariantCreateNewVariantRequest', productsVariantCreateNewVariantRequest)
            const localVarPath = `/products/{product_id}/variants`
            ...
            requestBeforeHook({
                requestBody: productsVariantCreateNewVariantRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
                pathTemplate: '/products/{product_id}/variants',
                httpMethod: 'POST'
            });
            localVarRequestOptions.data = serializeDataIfNeeded(productsVariantCreateNewVariantRequest, localVarRequestOptions, configuration)
        ...
        getSingle: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/products/variants/{id}`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/products/variants/{id}',
                httpMethod: 'GET'
            });
         ...
         * @throws {RequiredError}
         */
        list: async (productId: number, after?: string, sortOrder?: 'asc' | 'desc', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'productId' is not null or undefined
            assertParamExists('list', 'productId', productId)
            const localVarPath = `/products/{product_id}/variants`
                .replace(`{${"product_id"}}`, encodeURIComponent(String(productId !== undefined ? productId : `-product_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {string} id 
         * @param {ProductsVariantUpdateSingleRequest} productsVariantUpdateSingleRequest Information about updated fields in Variant
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateSingle: async (id: string, productsVariantUpdateSingleRequest: ProductsVariantUpdateSingleRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateSingle', 'id', id)
            // verify required parameter 'productsVariantUpdateSingleRequest' is not null or undefined
            assertParamExists('updateSingle', 'productsVariantUpdateSingleRequest', productsVariantUpdateSingleRequest)
            const localVarPath = `/products/variants/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id !== undefined ? id : `-id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: productsVariantUpdateSingleRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(productsVariantUpdateSingleRequest, localVarRequestOptions, configuration)
...
/**
 * ProductsVariantApi - functional programming interface
 * @export
 */
export const ProductsVariantApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ProductsVariantApiAxiosParamCreator(configuration)
    return {
        /**
         * Create a new variant for a product
         * @summary Create Variant
         * @param {ProductsVariantApiCreateNewVariantRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createNewVariant(requestParameters: ProductsVariantApiCreateNewVariantRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductsVariantAttributes>> {
            const productsVariantCreateNewVariantRequest: ProductsVariantCreateNewVariantRequest = {
                products_variant: requestParameters.products_variant
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.createNewVariant(requestParameters.productId, productsVariantCreateNewVariantRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Retrieve a single variant
         * @summary Fetch Variant
         * @param {ProductsVariantApiGetSingleRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSingle(requestParameters: ProductsVariantApiGetSingleRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductsVariantAttributes>> {
         ...
         * List variants for a product
         * @summary List Variants
         * @param {ProductsVariantApiListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async list(requestParameters: ProductsVariantApiListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProductsVariantAttributes>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(requestParameters.productId, requestParameters.after, requestParameters.sortOrder, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a single variant
         * @summary Update Variant
         * @param {ProductsVariantApiUpdateSingleRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateSingle(requestParameters: ProductsVariantApiUpdateSingleRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductsVariantAttributes>> {
            const productsVariantUpdateSingleRequest: ProductsVariantUpdateSingleRequest = {
                products_variant: requestParameters.products_variant
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSingle(requestParameters.id, productsVariantUpdateSingleRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ProductsVariantApi - factory interface
 * @export
 */
export const ProductsVariantApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ProductsVariantApiFp(configuration)
    return {
        /**
         * Create a new variant for a product
         * @summary Create Variant
         ...
         * @throws {RequiredError}
         */
        createNewVariant(requestParameters: ProductsVariantApiCreateNewVariantRequest, options?: AxiosRequestConfig): AxiosPromise<ProductsVariantAttributes> {
            return localVarFp.createNewVariant(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a single variant
         * @summary Fetch Variant
         ...
         * @throws {RequiredError}
         */
        getSingle(requestParameters: ProductsVariantApiGetSingleRequest, options?: AxiosRequestConfig): AxiosPromise<ProductsVariantAttributes> {
         ...
         * @throws {RequiredError}
         */
        list(requestParameters: ProductsVariantApiListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<ProductsVariantAttributes>> {
         ...
         * @throws {RequiredError}
         */
        updateSingle(requestParameters: ProductsVariantApiUpdateSingleRequest, options?: AxiosRequestConfig): AxiosPromise<ProductsVariantAttributes> {
            return localVarFp.updateSingle(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createNewVariant operation in ProductsVariantApi.
 * @export
 * @interface ProductsVariantApiCreateNewVariantRequest
 */
export type ProductsVariantApiCreateNewVariantRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ProductsVariantApiCreateNewVariant
    */
...
/**
 * Request parameters for getSingle operation in ProductsVariantApi.
 * @export
 * @interface ProductsVariantApiGetSingleRequest
 */
export type ProductsVariantApiGetSingleRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ProductsVariantApiGetSingle
    */
    readonly id: string
...
/**
 * Request parameters for list operation in ProductsVariantApi.
 * @export
 * @interface ProductsVariantApiListRequest
 */
export type ProductsVariantApiListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof ProductsVariantApiList
    */
    readonly productId: number
...
/**
 * Request parameters for updateSingle operation in ProductsVariantApi.
 * @export
 * @interface ProductsVariantApiUpdateSingleRequest
 */
export type ProductsVariantApiUpdateSingleRequest = {
    
    /**
    * 
    * @type {string}
    * @memberof ProductsVariantApiUpdateSingle
    */
    readonly id: string
...
/**
 * ProductsVariantApiGenerated - object-oriented interface
 * @export
 * @class ProductsVariantApiGenerated
 * @extends {BaseAPI}
 */
export class ProductsVariantApiGenerated extends BaseAPI {
    /**
     * Create a new variant for a product
     * @summary Create Variant
     * @param {ProductsVariantApiCreateNewVariantRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ProductsVariantApiGenerated
     */
    public createNewVariant(requestParameters: ProductsVariantApiCreateNewVariantRequest, options?: AxiosRequestConfig) {
        return ProductsVariantApiFp(this.configuration).createNewVariant(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsVariantApiGenerated
     */
    public getSingle(requestParameters: ProductsVariantApiGetSingleRequest, options?: AxiosRequestConfig) {
        return ProductsVariantApiFp(this.configuration).getSingle(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsVariantApiGenerated
     */
    public list(requestParameters: ProductsVariantApiListRequest, options?: AxiosRequestConfig) {
        return ProductsVariantApiFp(this.configuration).list(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsVariantApiGenerated
     */
    public updateSingle(requestParameters: ProductsVariantApiUpdateSingleRequest, options?: AxiosRequestConfig) {
        return ProductsVariantApiFp(this.configuration).updateSingle(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
