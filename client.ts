...
import {
  ...
  FormsFieldApi,
  FormsFieldSetApi,
  FormsFieldsOptionApi,
  FormsSubmissionApi,
  FormsSubmissionsAnswerApi,
  FulfillmentApi,
  FulfillmentsLocationApi,
  ImageApi,
  OrderApi,
  OrdersAppliedTagApi,
  OrdersInvoiceApi,
  OrdersInvoicesRestockApi,
  OrdersTagApi,
  OrdersTransactionApi,
  ProductApi,
  ProductsPriceApi,
  ProductsTagApi,
  ProductsVariantApi,
  ShippingLocationGroupApi,
  ShippingPackageApi,
  ShippingProfileApi,
  ShippingRateApi,
  ShippingRatesNameApi,
  ShippingZoneApi,
  TeamApi,
  UserApi,
  WebhooksOutgoingEndpointApi,
  WebhooksOutgoingEventApi,
  WorkspaceApi,
} from "./api";
import { Configuration, ConfigurationParameters } from "./configuration";
import { ClickFunnelsCustom } from "./client-custom";

export class ClickFunnels extends ClickFunnelsCustom {
  readonly contact: ContactApi;
  readonly contactsAppliedTag: ContactsAppliedTagApi;
  readonly contactsTag: ContactsTagApi;
  readonly course: CourseApi;
  readonly coursesEnrollment: CoursesEnrollmentApi;
  readonly coursesLesson: CoursesLessonApi;
  readonly coursesSection: CoursesSectionApi;
  readonly form: FormApi;
  readonly formsField: FormsFieldApi;
  readonly formsFieldSet: FormsFieldSetApi;
  readonly formsFieldsOption: FormsFieldsOptionApi;
  readonly formsSubmission: FormsSubmissionApi;
  readonly formsSubmissionsAnswer: FormsSubmissionsAnswerApi;
  readonly fulfillment: FulfillmentApi;
  readonly fulfillmentsLocation: FulfillmentsLocationApi;
  readonly image: ImageApi;
  readonly order: OrderApi;
  readonly ordersAppliedTag: OrdersAppliedTagApi;
  readonly ordersInvoice: OrdersInvoiceApi;
  readonly ordersInvoicesRestock: OrdersInvoicesRestockApi;
  readonly ordersTag: OrdersTagApi;
  readonly ordersTransaction: OrdersTransactionApi;
  readonly product: ProductApi;
  readonly productsPrice: ProductsPriceApi;
  readonly productsTag: ProductsTagApi;
  readonly productsVariant: ProductsVariantApi;
  readonly shippingLocationGroup: ShippingLocationGroupApi;
  readonly shippingPackage: ShippingPackageApi;
  readonly shippingProfile: ShippingProfileApi;
  readonly shippingRate: ShippingRateApi;
  readonly shippingRatesName: ShippingRatesNameApi;
  readonly shippingZone: ShippingZoneApi;
  readonly team: TeamApi;
  readonly user: UserApi;
  readonly webhooksOutgoingEndpoint: WebhooksOutgoingEndpointApi;
  readonly webhooksOutgoingEvent: WebhooksOutgoingEventApi;
  ...
  constructor(configurationParameters: ConfigurationParameters) {
    ...
    this.contactsAppliedTag = new ContactsAppliedTagApi(configuration);
    this.contactsTag = new ContactsTagApi(configuration);
    this.course = new CourseApi(configuration);
    this.coursesEnrollment = new CoursesEnrollmentApi(configuration);
    this.coursesLesson = new CoursesLessonApi(configuration);
    this.coursesSection = new CoursesSectionApi(configuration);
    this.form = new FormApi(configuration);
    this.formsField = new FormsFieldApi(configuration);
    this.formsFieldSet = new FormsFieldSetApi(configuration);
    this.formsFieldsOption = new FormsFieldsOptionApi(configuration);
    this.formsSubmission = new FormsSubmissionApi(configuration);
    this.formsSubmissionsAnswer = new FormsSubmissionsAnswerApi(configuration);
    this.fulfillment = new FulfillmentApi(configuration);
    this.fulfillmentsLocation = new FulfillmentsLocationApi(configuration);
    this.image = new ImageApi(configuration);
    this.order = new OrderApi(configuration);
    this.ordersAppliedTag = new OrdersAppliedTagApi(configuration);
    this.ordersInvoice = new OrdersInvoiceApi(configuration);
    this.ordersInvoicesRestock = new OrdersInvoicesRestockApi(configuration);
    this.ordersTag = new OrdersTagApi(configuration);
    this.ordersTransaction = new OrdersTransactionApi(configuration);
    this.product = new ProductApi(configuration);
    this.productsPrice = new ProductsPriceApi(configuration);
    this.productsTag = new ProductsTagApi(configuration);
    this.productsVariant = new ProductsVariantApi(configuration);
    this.shippingLocationGroup = new ShippingLocationGroupApi(configuration);
    this.shippingPackage = new ShippingPackageApi(configuration);
    this.shippingProfile = new ShippingProfileApi(configuration);
    this.shippingRate = new ShippingRateApi(configuration);
    this.shippingRatesName = new ShippingRatesNameApi(configuration);
    this.shippingZone = new ShippingZoneApi(configuration);
    this.team = new TeamApi(configuration);
    this.user = new UserApi(configuration);
    this.webhooksOutgoingEndpoint = new WebhooksOutgoingEndpointApi(configuration);
    this.webhooksOutgoingEvent = new WebhooksOutgoingEventApi(configuration);
